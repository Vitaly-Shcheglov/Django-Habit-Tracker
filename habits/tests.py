...
class HabitAPITests(APITestCase):
    ...
    def test_user_habit_list(self):
        ...
        Habit.objects.create(user=self.user, location='Gym', time='08:00:00', action='Workout', pleasant_habit=False, frequency=1, time_to_complete=60, is_public=True)
    ...
    def test_public_habit_list(self):
        ...
        Habit.objects.create(user=self.user, location='Park', time='10:00:00', action='Jogging', pleasant_habit=False, frequency=1, time_to_complete=60, is_public=True)
        Habit.objects.create(user=self.user, location='Home', time='10:00:00', action='Reading', pleasant_habit=False, frequency=1, time_to_complete=60, is_public=False)
    ...
    def test_update_habit(self):
        ...
        habit = Habit.objects.create(user=self.user, location='Park', time='10:00:00', action='Jogging', pleasant_habit=False, frequency=1, time_to_complete=60, is_public=True)
...
#     def test_create_habit(self):
#         """
#         Проверяет, что пользователь может создать новую привычку.
#         """
...
#         """
#         Проверяет, что пользователь может получить свой список привычек.
#         """
#         self.client.post('/api/habits/create/', {
#             'location': 'Park',
#             'time': '10:00:00',
#             'action': 'Jogging',
#             'pleasant_habit': False,
