...
class InvoicePayment(ListableAPIResource["InvoicePayment"]):
    ...
    @classmethod
    def list(cls, **params: Unpack["InvoicePayment.ListParams"]) -> ListObject["InvoicePayment"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["InvoicePayment.ListParams"]) -> ListObject["InvoicePayment"]:
        """
        When retrieving an invoice, there is an includable payments property containing the first handful of those items. There is also a URL where you can retrieve the full (paginated) list of payments.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["InvoicePayment.RetrieveParams"]) -> "InvoicePayment":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["InvoicePayment.RetrieveParams"]) -> "InvoicePayment":
        """
        Retrieves the invoice payment with the given ID.
        """
        instance = cls(id, **params)
