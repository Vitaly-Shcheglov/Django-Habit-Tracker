...
class Token(ListableAPIResource["Token"], UpdateableAPIResource["Token"]):
    ...
    class NetworkData(StripeObject):
        ...
        class WalletProvider(StripeObject):
            ...
            """
            card_number_source: Optional[Literal["app", "manual", "on_file", "other"]]
            """
            ...
            """
            suggested_decision: Optional[Literal["approve", "decline", "require_auth"]]
            """
    ...
    """
    wallet_provider: Optional[Literal["apple_pay", "google_pay", "samsung_pay"]]
    """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Token.ListParams"]) -> ListObject["Token"]:
        """
        Lists all Issuing Token objects for a given card.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Token.ModifyParams"]) -> "Token":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Token.ModifyParams"]) -> "Token":
        """
        Attempts to update the specified Issuing Token object to the status specified.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
