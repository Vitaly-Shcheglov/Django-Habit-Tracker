...
class Cardholder(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        spending_controls: NotRequired["Cardholder.CreateParamsSpendingControls"]
        """
    ...
    class CreateParamsIndividual(TypedDict):
        card_issuing: NotRequired["Cardholder.CreateParamsIndividualCardIssuing"]
        """
        Information related to the card_issuing program for this cardholder.
        """
        ...
        The last name of this cardholder. Required before activating Cards. This field cannot contain any numbers, special characters (except periods, commas, hyphens, spaces and apostrophes) or non-latin letters.
        """
        verification: NotRequired["Cardholder.CreateParamsIndividualVerification"]
        """
        Government-issued ID document for this cardholder.
        """

    class CreateParamsIndividualCardIssuing(TypedDict):
        user_terms_acceptance: NotRequired["Cardholder.CreateParamsIndividualCardIssuingUserTermsAcceptance"]
        """
        Information about cardholder acceptance of Celtic [Authorized User Terms](https://stripe.com/docs/issuing/cards#accept-authorized-user-terms). Required for cards backed by a Celtic program.
        """
    ...
    class CreateParamsIndividualVerification(TypedDict):
        document: NotRequired["Cardholder.CreateParamsIndividualVerificationDocument"]
        """
        An identifying document, either a passport or local ID card.
        """
    ...
    class CreateParamsSpendingControls(TypedDict):
        ...
        Array of strings containing representing countries from which authorizations will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `allowed_merchant_countries`. Provide an empty value to unset this control.
        """
        spending_limits: NotRequired[List["Cardholder.CreateParamsSpendingControlsSpendingLimit"]]
        """
        Limit spending with amount-based rules that apply across this cardholder's cards.
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        The cardholder's preferred locales (languages), ordered by preference. Locales can be `de`, `en`, `es`, `fr`, or `it`.
         This changes the language of the [3D Secure flow](https://stripe.com/docs/issuing/3d-secure) and one-time password messages sent to the cardholder.
        """
        spending_controls: NotRequired["Cardholder.ModifyParamsSpendingControls"]
        """
        Rules that control spending across this cardholder's cards. Refer to our [documentation](https://stripe.com/docs/issuing/controls/spending-controls) for more details.
        """
        status: NotRequired[Literal["active", "inactive"]]
    ...
    class ModifyParamsIndividual(TypedDict):
        card_issuing: NotRequired["Cardholder.ModifyParamsIndividualCardIssuing"]
        """
        Information related to the card_issuing program for this cardholder.
        """
        ...
        The last name of this cardholder. Required before activating Cards. This field cannot contain any numbers, special characters (except periods, commas, hyphens, spaces and apostrophes) or non-latin letters.
        """
        verification: NotRequired["Cardholder.ModifyParamsIndividualVerification"]
        """
        Government-issued ID document for this cardholder.
        """

    class ModifyParamsIndividualCardIssuing(TypedDict):
        user_terms_acceptance: NotRequired["Cardholder.ModifyParamsIndividualCardIssuingUserTermsAcceptance"]
        """
        Information about cardholder acceptance of Celtic [Authorized User Terms](https://stripe.com/docs/issuing/cards#accept-authorized-user-terms). Required for cards backed by a Celtic program.
        """
    ...
    class ModifyParamsIndividualVerification(TypedDict):
        document: NotRequired["Cardholder.ModifyParamsIndividualVerificationDocument"]
        """
        An identifying document, either a passport or local ID card.
        """
    ...
    class ModifyParamsSpendingControls(TypedDict):
        ...
        Array of strings containing representing countries from which authorizations will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `allowed_merchant_countries`. Provide an empty value to unset this control.
        """
        spending_limits: NotRequired[List["Cardholder.ModifyParamsSpendingControlsSpendingLimit"]]
        """
        Limit spending with amount-based rules that apply across this cardholder's cards.
        """
        spending_limits_currency: NotRequired[str]
    ...
    @classmethod
    def create(cls, **params: Unpack["Cardholder.CreateParams"]) -> "Cardholder":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Cardholder.CreateParams"]) -> "Cardholder":
        """
        Creates a new Issuing Cardholder object that can be issued cards.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["Cardholder.ListParams"]) -> ListObject["Cardholder"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Cardholder.ListParams"]) -> ListObject["Cardholder"]:
        """
        Returns a list of Issuing Cardholder objects. The objects are sorted in descending order by creation date, with the most recently created object appearing first.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Cardholder.ModifyParams"]) -> "Cardholder":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Cardholder.ModifyParams"]) -> "Cardholder":
        """
        Updates the specified Issuing Cardholder object by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Cardholder.RetrieveParams"]) -> "Cardholder":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Cardholder.RetrieveParams"]) -> "Cardholder":
        """
        Retrieves an Issuing Cardholder object.
        """
        instance = cls(id, **params)
