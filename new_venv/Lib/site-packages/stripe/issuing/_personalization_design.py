...
class PersonalizationDesign(
    ...
    OBJECT_NAME: ClassVar[Literal["issuing.personalization_design"]] = "issuing.personalization_design"
    ...
    class CreateParams(RequestOptions):
        ...
        """
        carrier_text: NotRequired["PersonalizationDesign.CreateParamsCarrierText"]
        """
        ...
        """
        preferences: NotRequired["PersonalizationDesign.CreateParamsPreferences"]
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        The file for the card logo, for use with physical bundles that support card logos. Must have a `purpose` value of `issuing_logo`.
        """
        carrier_text: NotRequired["Literal['']|PersonalizationDesign.ModifyParamsCarrierText"]
        """
        Hash containing carrier text, for use with physical bundles that support carrier text.
        """
        expand: NotRequired[List[str]]
        ...
        The physical bundle object belonging to this personalization design.
        """
        preferences: NotRequired["PersonalizationDesign.ModifyParamsPreferences"]
        """
        Information on whether this personalization design is used to create cards when one is not specified.
        """
        transfer_lookup_key: NotRequired[bool]
    ...
    @classmethod
    def create(cls, **params: Unpack["PersonalizationDesign.CreateParams"]) -> "PersonalizationDesign":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["PersonalizationDesign.CreateParams"]) -> "PersonalizationDesign":
        """
        Creates a personalization design object.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["PersonalizationDesign.ListParams"]) -> ListObject["PersonalizationDesign"]:
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["PersonalizationDesign.ModifyParams"]) -> "PersonalizationDesign":
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["PersonalizationDesign.RetrieveParams"]) -> "PersonalizationDesign":
        """
    ...
    class TestHelpers(APIResourceTestHelpers["PersonalizationDesign"]):
        ...
        @overload
        def activate(self, **params: Unpack["PersonalizationDesign.ActivateParams"]) -> "PersonalizationDesign":
            """
            Updates the status of the specified testmode personalization design object to active.
            """
            ...
        ...
        def activate(  # pyright: ignore[reportGeneralTypeIssues]
            ...
            return cast(
                ...
                self.resource._request(
                    "post",
                    "/v1/test_helpers/issuing/personalization_designs/{personalization_design}/activate".format(
                        personalization_design=sanitize_id(self.resource.get("id"))
                    ),
                    params=params,
                ),
            )
        ...
        @overload
        def reject(self, **params: Unpack["PersonalizationDesign.RejectParams"]) -> "PersonalizationDesign":
            """
            Updates the status of the specified testmode personalization design object to rejected.
            """
            ...
