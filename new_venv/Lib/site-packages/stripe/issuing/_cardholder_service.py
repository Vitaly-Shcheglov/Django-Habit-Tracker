...
class CardholderService(StripeService):
    class CreateParams(TypedDict):
        ...
        """
        spending_controls: NotRequired["CardholderService.CreateParamsSpendingControls"]
        """
    ...
    class CreateParamsIndividual(TypedDict):
        card_issuing: NotRequired["CardholderService.CreateParamsIndividualCardIssuing"]
        """
        ...
        """
        verification: NotRequired["CardholderService.CreateParamsIndividualVerification"]
        """
        Government-issued ID document for this cardholder.
        """

    class CreateParamsIndividualCardIssuing(TypedDict):
        user_terms_acceptance: NotRequired["CardholderService.CreateParamsIndividualCardIssuingUserTermsAcceptance"]
        """
    ...
    class CreateParamsIndividualVerification(TypedDict):
        document: NotRequired["CardholderService.CreateParamsIndividualVerificationDocument"]
        """
    ...
    class CreateParamsSpendingControls(TypedDict):
        ...
        """
        spending_limits: NotRequired[List["CardholderService.CreateParamsSpendingControlsSpendingLimit"]]
        """
    ...
    class UpdateParams(TypedDict):
        ...
        The cardholder's preferred locales (languages), ordered by preference. Locales can be `de`, `en`, `es`, `fr`, or `it`.
         This changes the language of the [3D Secure flow](https://stripe.com/docs/issuing/3d-secure) and one-time password messages sent to the cardholder.
        """
        spending_controls: NotRequired["CardholderService.UpdateParamsSpendingControls"]
        """
        Rules that control spending across this cardholder's cards. Refer to our [documentation](https://stripe.com/docs/issuing/controls/spending-controls) for more details.
        """
        status: NotRequired[Literal["active", "inactive"]]
    ...
    class UpdateParamsIndividual(TypedDict):
        card_issuing: NotRequired["CardholderService.UpdateParamsIndividualCardIssuing"]
        """
        Information related to the card_issuing program for this cardholder.
        """
        ...
        The last name of this cardholder. Required before activating Cards. This field cannot contain any numbers, special characters (except periods, commas, hyphens, spaces and apostrophes) or non-latin letters.
        """
        verification: NotRequired["CardholderService.UpdateParamsIndividualVerification"]
        """
        Government-issued ID document for this cardholder.
        """

    class UpdateParamsIndividualCardIssuing(TypedDict):
        user_terms_acceptance: NotRequired["CardholderService.UpdateParamsIndividualCardIssuingUserTermsAcceptance"]
        """
        Information about cardholder acceptance of Celtic [Authorized User Terms](https://stripe.com/docs/issuing/cards#accept-authorized-user-terms). Required for cards backed by a Celtic program.
        """
    ...
    class UpdateParamsIndividualVerification(TypedDict):
        document: NotRequired["CardholderService.UpdateParamsIndividualVerificationDocument"]
        """
        An identifying document, either a passport or local ID card.
        """
    ...
    class UpdateParamsSpendingControls(TypedDict):
        ...
        Array of strings containing representing countries from which authorizations will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `allowed_merchant_countries`. Provide an empty value to unset this control.
        """
        spending_limits: NotRequired[List["CardholderService.UpdateParamsSpendingControlsSpendingLimit"]]
        """
        Limit spending with amount-based rules that apply across this cardholder's cards.
        """
        spending_limits_currency: NotRequired[str]
