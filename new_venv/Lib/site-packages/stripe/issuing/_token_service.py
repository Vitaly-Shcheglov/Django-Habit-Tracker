...
class TokenService(StripeService):
    ...
    def list(self, params: "TokenService.ListParams", options: RequestOptions = {}) -> ListObject[Token]:
        """
    ...
    async def list_async(self, params: "TokenService.ListParams", options: RequestOptions = {}) -> ListObject[Token]:
        """
        Lists all Issuing Token objects for a given card.
        """
        return cast(
