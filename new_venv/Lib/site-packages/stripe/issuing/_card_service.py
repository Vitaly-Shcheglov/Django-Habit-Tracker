...
class CardService(StripeService):
    class CreateParams(TypedDict):
        ...
        """
        spending_controls: NotRequired["CardService.CreateParamsSpendingControls"]
        """
    ...
    class CreateParamsShipping(TypedDict):
        ...
        """
        address_validation: NotRequired["CardService.CreateParamsShippingAddressValidation"]
        """
    ...
    class CreateParamsSpendingControls(TypedDict):
        ...
        """
        spending_limits: NotRequired[List["CardService.CreateParamsSpendingControlsSpendingLimit"]]
        """
    ...
    class UpdateParams(TypedDict):
        ...
        """
        spending_controls: NotRequired["CardService.UpdateParamsSpendingControls"]
        """
        Rules that control spending for this card. Refer to our [documentation](https://stripe.com/docs/issuing/controls/spending-controls) for more details.
        """
        status: NotRequired[Literal["active", "canceled", "inactive"]]
    ...
    class UpdateParamsShipping(TypedDict):
        ...
        The address that the card is shipped to.
        """
        address_validation: NotRequired["CardService.UpdateParamsShippingAddressValidation"]
        """
        Address validation settings.
        """
    ...
    class UpdateParamsSpendingControls(TypedDict):
        ...
        Array of strings containing representing countries from which authorizations will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `allowed_merchant_countries`. Provide an empty value to unset this control.
        """
        spending_limits: NotRequired[List["CardService.UpdateParamsSpendingControlsSpendingLimit"]]
        """
        Limit spending with amount-based rules that apply across any cards this card replaced (i.e., its `replacement_for` card and _that_ card's `replacement_for` card, up the chain).
        """
    ...
    def create(self, params: "CardService.CreateParams", options: RequestOptions = {}) -> Card:
        """
    ...
    async def create_async(self, params: "CardService.CreateParams", options: RequestOptions = {}) -> Card:
        """
        Creates an Issuing Card object.
        """
        return cast(
