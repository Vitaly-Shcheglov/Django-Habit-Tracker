...
class PromotionCode(
    ...
    class CreateParamsRestrictions(TypedDict):
        currency_options: NotRequired[Dict[str, "PromotionCode.CreateParamsRestrictionsCurrencyOptions"]]
        """
    ...
    class ModifyParamsRestrictions(TypedDict):
        currency_options: NotRequired[Dict[str, "PromotionCode.ModifyParamsRestrictionsCurrencyOptions"]]
        """
        Promotion codes defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        """
    ...
    @classmethod
    def create(cls, **params: Unpack["PromotionCode.CreateParams"]) -> "PromotionCode":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["PromotionCode.CreateParams"]) -> "PromotionCode":
        """
        A promotion code points to a coupon. You can optionally restrict the code to a specific customer, redemption limit, and expiration date.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["PromotionCode.ListParams"]) -> ListObject["PromotionCode"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["PromotionCode.ListParams"]) -> ListObject["PromotionCode"]:
        """
        Returns a list of your promotion codes.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["PromotionCode.ModifyParams"]) -> "PromotionCode":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["PromotionCode.ModifyParams"]) -> "PromotionCode":
        """
        Updates the specified promotion code by setting the values of the parameters passed. Most fields are, by design, not editable.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["PromotionCode.RetrieveParams"]) -> "PromotionCode":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["PromotionCode.RetrieveParams"]) -> "PromotionCode":
        """
        Retrieves the promotion code with the given ID. In order to retrieve a promotion code by the customer-facing code use [list](https://docs.stripe.com/docs/api/promotion_codes/list) with the desired code.
        """
        instance = cls(id, **params)
