...
if not TYPE_CHECKING:
    from stripe.api_resources import (abstract, apps, billing, billing_portal,
                                      checkout, climate, entitlements,
                                      financial_connections, forwarding,
                                      identity, issuing, radar, reporting,
                                      sigma, tax, terminal, test_helpers,
                                      treasury)
...
if not TYPE_CHECKING:
    ...
    from stripe.api_resources.file import File as FileUpload
