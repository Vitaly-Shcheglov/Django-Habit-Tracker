...
class ApplicationFee(ListableAPIResource["ApplicationFee"]):
    ...
    @classmethod
    def list(cls, **params: Unpack["ApplicationFee.ListParams"]) -> ListObject["ApplicationFee"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["ApplicationFee.ListParams"]) -> ListObject["ApplicationFee"]:
        """
        Returns a list of application fees you've previously collected. The application fees are returned in sorted order, with the most recent fees appearing first.
        """
    ...
    @classmethod
    def _cls_refund(cls, id: str, **params: Unpack["ApplicationFee.RefundParams"]) -> "ApplicationFeeRefund":
        """
    ...
    @overload
    @staticmethod
    def refund(id: str, **params: Unpack["ApplicationFee.RefundParams"]) -> "ApplicationFeeRefund":
        """
        Refunds an application fee that has previously been collected but not yet refunded.
        Funds will be refunded to the Stripe account from which the fee was originally collected.
    ...
    @overload
    def refund(self, **params: Unpack["ApplicationFee.RefundParams"]) -> "ApplicationFeeRefund":
        """
        Refunds an application fee that has previously been collected but not yet refunded.
        Funds will be refunded to the Stripe account from which the fee was originally collected.
    ...
    def refund(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/application_fees/{id}/refunds".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def refund_async(id: str, **params: Unpack["ApplicationFee.RefundParams"]) -> "ApplicationFeeRefund":
        """
        Refunds an application fee that has previously been collected but not yet refunded.
        Funds will be refunded to the Stripe account from which the fee was originally collected.
    ...
    @overload
    async def refund_async(self, **params: Unpack["ApplicationFee.RefundParams"]) -> "ApplicationFeeRefund":
        """
        Refunds an application fee that has previously been collected but not yet refunded.
        Funds will be refunded to the Stripe account from which the fee was originally collected.
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["ApplicationFee.RetrieveParams"]) -> "ApplicationFee":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["ApplicationFee.RetrieveParams"]) -> "ApplicationFee":
        """
        Retrieves the details of an application fee that your account has collected. The same information is returned when refunding the application fee.
        """
        instance = cls(id, **params)
    ...
    def retrieve_refund(
        ...
        **params: Unpack["ApplicationFee.RetrieveRefundParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/application_fees/{fee}/refunds/{id}".format(fee=sanitize_id(fee), id=sanitize_id(id)),
                params=params,
            ),
        )
    ...
    @classmethod
    def create_refund(cls, id: str, **params: Unpack["ApplicationFee.CreateRefundParams"]) -> "ApplicationFeeRefund":
        """
        Refunds an application fee that has previously been collected but not yet refunded.
        Funds will be refunded to the Stripe account from which the fee was originally collected.
