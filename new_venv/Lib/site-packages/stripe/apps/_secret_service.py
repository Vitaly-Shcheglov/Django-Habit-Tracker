...
class SecretService(StripeService):
    ...
    def list(self, params: "SecretService.ListParams", options: RequestOptions = {}) -> ListObject[Secret]:
        """
    ...
    async def list_async(self, params: "SecretService.ListParams", options: RequestOptions = {}) -> ListObject[Secret]:
        """
        List all secrets stored on the given scope.
        """
        return cast(
    ...
    def find(self, params: "SecretService.FindParams", options: RequestOptions = {}) -> Secret:
        """
    ...
    async def find_async(self, params: "SecretService.FindParams", options: RequestOptions = {}) -> Secret:
        """
        Finds a secret in the secret store by name and scope.
        """
        return cast(
