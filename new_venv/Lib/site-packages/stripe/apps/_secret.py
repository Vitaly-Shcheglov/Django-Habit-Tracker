...
class Secret(CreateableAPIResource["Secret"], ListableAPIResource["Secret"]):
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Secret.CreateParams"]) -> "Secret":
        """
        Create or replace a secret in the secret store.
        """
        return cast(
    ...
    @classmethod
    def delete_where(cls, **params: Unpack["Secret.DeleteWhereParams"]) -> "Secret":
        """
    ...
    @classmethod
    async def delete_where_async(cls, **params: Unpack["Secret.DeleteWhereParams"]) -> "Secret":
        """
        Deletes a secret from the secret store by name and scope.
        """
        return cast(
    ...
    @classmethod
    async def find_async(cls, **params: Unpack["Secret.FindParams"]) -> "Secret":
        """
        Finds a secret in the secret store by name and scope.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["Secret.ListParams"]) -> ListObject["Secret"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Secret.ListParams"]) -> ListObject["Secret"]:
        """
        List all secrets stored on the given scope.
        """
