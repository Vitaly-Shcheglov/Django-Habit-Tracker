...
class CreditBalanceSummary(SingletonAPIResource["CreditBalanceSummary"]):
    ...
    OBJECT_NAME: ClassVar[Literal["billing.credit_balance_summary"]] = "billing.credit_balance_summary"
    ...
    class RetrieveParamsFilter(TypedDict):
        applicability_scope: NotRequired["CreditBalanceSummary.RetrieveParamsFilterApplicabilityScope"]
        """
    ...
    class RetrieveParamsFilterApplicabilityScope(TypedDict):
        ...
        """
        prices: NotRequired[List["CreditBalanceSummary.RetrieveParamsFilterApplicabilityScopePrice"]]
        """
    ...
    @classmethod
    def retrieve(cls, **params: Unpack["CreditBalanceSummary.RetrieveParams"]) -> "CreditBalanceSummary":
        """
    ...
    @classmethod
    async def retrieve_async(cls, **params: Unpack["CreditBalanceSummary.RetrieveParams"]) -> "CreditBalanceSummary":
        """
        Retrieves the credit balance summary for a customer.
        """
        instance = cls(None, **params)
