...
class CreditBalanceTransaction(ListableAPIResource["CreditBalanceTransaction"]):
    """
    A credit balance transaction is a resource representing a transaction (either a credit or a debit) against an existing credit grant.
    """

    OBJECT_NAME: ClassVar[Literal["billing.credit_balance_transaction"]] = "billing.credit_balance_transaction"
    ...
    class Credit(StripeObject):
        ...
        amount: Amount
        credits_application_invoice_voided: Optional[CreditsApplicationInvoiceVoided]
        """
    ...
    @classmethod
    def list(cls, **params: Unpack["CreditBalanceTransaction.ListParams"]) -> ListObject["CreditBalanceTransaction"]:
        """
