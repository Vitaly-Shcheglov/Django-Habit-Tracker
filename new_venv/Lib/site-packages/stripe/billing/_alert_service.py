...
class AlertService(StripeService):
    ...
    class CreateParamsUsageThreshold(TypedDict):
        filters: NotRequired[List["AlertService.CreateParamsUsageThresholdFilter"]]
        """
    ...
    def create(self, params: "AlertService.CreateParams", options: RequestOptions = {}) -> Alert:
        """
    ...
    async def create_async(self, params: "AlertService.CreateParams", options: RequestOptions = {}) -> Alert:
        """
        Creates a billing alert
        """
        return cast(
