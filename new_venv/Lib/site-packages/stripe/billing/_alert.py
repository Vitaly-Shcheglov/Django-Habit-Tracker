...
class Alert(CreateableAPIResource["Alert"], ListableAPIResource["Alert"]):
    ...
    @classmethod
    def _cls_activate(cls, id: str, **params: Unpack["Alert.ActivateParams"]) -> "Alert":
        """
    ...
    def activate(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/billing/alerts/{id}/activate".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_activate_async(cls, id: str, **params: Unpack["Alert.ActivateParams"]) -> "Alert":
        """
        Reactivates this alert, allowing it to trigger again.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def activate_async(id: str, **params: Unpack["Alert.ActivateParams"]) -> "Alert":
        """
        Reactivates this alert, allowing it to trigger again.
        """
        ...
    ...
    @overload
    async def activate_async(self, **params: Unpack["Alert.ActivateParams"]) -> "Alert":
        """
        Reactivates this alert, allowing it to trigger again.
        """
        ...
    ...
    @classmethod
    def _cls_archive(cls, id: str, **params: Unpack["Alert.ArchiveParams"]) -> "Alert":
        """
    ...
    def archive(self, **params: Unpack["Alert.ArchiveParams"]) -> "Alert":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Archives this alert, removing it from the list view and APIs. This is non-reversible.
        """
        return cast(
            ...
            self._request(
                "post",
                "/v1/billing/alerts/{id}/archive".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_archive_async(cls, id: str, **params: Unpack["Alert.ArchiveParams"]) -> "Alert":
        """
        Archives this alert, removing it from the list view and APIs. This is non-reversible.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def archive_async(id: str, **params: Unpack["Alert.ArchiveParams"]) -> "Alert":
        """
        Archives this alert, removing it from the list view and APIs. This is non-reversible.
        """
        ...
    ...
    @overload
    async def archive_async(self, **params: Unpack["Alert.ArchiveParams"]) -> "Alert":
        """
        Archives this alert, removing it from the list view and APIs. This is non-reversible.
        """
        ...
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Alert.CreateParams"]) -> "Alert":
        """
        Creates a billing alert
        """
        return cast(
    ...
    @classmethod
    def _cls_deactivate(cls, id: str, **params: Unpack["Alert.DeactivateParams"]) -> "Alert":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/billing/alerts/{id}/deactivate".format(id=sanitize_id(id)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def deactivate(id: str, **params: Unpack["Alert.DeactivateParams"]) -> "Alert":
        """
        Deactivates this alert, preventing it from triggering.
        """
        ...
    ...
    @overload
    def deactivate(self, **params: Unpack["Alert.DeactivateParams"]) -> "Alert":
        """
        Deactivates this alert, preventing it from triggering.
        """
        ...
    ...
    def deactivate(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/billing/alerts/{id}/deactivate".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_deactivate_async(cls, id: str, **params: Unpack["Alert.DeactivateParams"]) -> "Alert":
        """
        Deactivates this alert, preventing it from triggering.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def deactivate_async(id: str, **params: Unpack["Alert.DeactivateParams"]) -> "Alert":
        """
        Deactivates this alert, preventing it from triggering.
        """
        ...
    ...
    @overload
    async def deactivate_async(self, **params: Unpack["Alert.DeactivateParams"]) -> "Alert":
        """
        Deactivates this alert, preventing it from triggering.
        """
        ...
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Alert.ListParams"]) -> ListObject["Alert"]:
        """
        Lists billing active and inactive alerts
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Alert.RetrieveParams"]) -> "Alert":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Alert.RetrieveParams"]) -> "Alert":
        """
        Retrieves a billing alert given an ID
        """
        instance = cls(id, **params)
