...
class Meter(
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Meter.CreateParams"]) -> "Meter":
        """
        Creates a billing meter.
        """
        return cast(
    ...
    @classmethod
    def _cls_deactivate(cls, id: str, **params: Unpack["Meter.DeactivateParams"]) -> "Meter":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/billing/meters/{id}/deactivate".format(id=sanitize_id(id)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def deactivate(id: str, **params: Unpack["Meter.DeactivateParams"]) -> "Meter":
        """
        When a meter is deactivated, no more meter events will be accepted for this meter. You can't attach a deactivated meter to a price.
        """
        ...
    ...
    @overload
    def deactivate(self, **params: Unpack["Meter.DeactivateParams"]) -> "Meter":
        """
        When a meter is deactivated, no more meter events will be accepted for this meter. You can't attach a deactivated meter to a price.
        """
        ...
    ...
    def deactivate(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/billing/meters/{id}/deactivate".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_deactivate_async(cls, id: str, **params: Unpack["Meter.DeactivateParams"]) -> "Meter":
        """
        When a meter is deactivated, no more meter events will be accepted for this meter. You can't attach a deactivated meter to a price.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def deactivate_async(id: str, **params: Unpack["Meter.DeactivateParams"]) -> "Meter":
        """
        When a meter is deactivated, no more meter events will be accepted for this meter. You can't attach a deactivated meter to a price.
        """
        ...
    ...
    @overload
    async def deactivate_async(self, **params: Unpack["Meter.DeactivateParams"]) -> "Meter":
        """
        When a meter is deactivated, no more meter events will be accepted for this meter. You can't attach a deactivated meter to a price.
        """
        ...
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Meter.ListParams"]) -> ListObject["Meter"]:
        """
        Retrieve a list of billing meters.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Meter.ModifyParams"]) -> "Meter":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Meter.ModifyParams"]) -> "Meter":
        """
        Updates a billing meter.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def _cls_reactivate(cls, id: str, **params: Unpack["Meter.ReactivateParams"]) -> "Meter":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/billing/meters/{id}/reactivate".format(id=sanitize_id(id)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def reactivate(id: str, **params: Unpack["Meter.ReactivateParams"]) -> "Meter":
        """
        When a meter is reactivated, events for this meter can be accepted and you can attach the meter to a price.
        """
        ...
    ...
    @overload
    def reactivate(self, **params: Unpack["Meter.ReactivateParams"]) -> "Meter":
        """
        When a meter is reactivated, events for this meter can be accepted and you can attach the meter to a price.
        """
        ...
    ...
    def reactivate(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/billing/meters/{id}/reactivate".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_reactivate_async(cls, id: str, **params: Unpack["Meter.ReactivateParams"]) -> "Meter":
        """
        When a meter is reactivated, events for this meter can be accepted and you can attach the meter to a price.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def reactivate_async(id: str, **params: Unpack["Meter.ReactivateParams"]) -> "Meter":
        """
        When a meter is reactivated, events for this meter can be accepted and you can attach the meter to a price.
        """
        ...
    ...
    @overload
    async def reactivate_async(self, **params: Unpack["Meter.ReactivateParams"]) -> "Meter":
        """
        When a meter is reactivated, events for this meter can be accepted and you can attach the meter to a price.
        """
        ...
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Meter.RetrieveParams"]) -> "Meter":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Meter.RetrieveParams"]) -> "Meter":
        """
        Retrieves a billing meter given an ID.
        """
        instance = cls(id, **params)
    ...
    def list_event_summaries(
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/billing/meters/{id}/event_summaries".format(id=sanitize_id(id)),
                params=params,
            ),
        )
