...
class MeterEventAdjustment(CreateableAPIResource["MeterEventAdjustment"]):
    ...
    OBJECT_NAME: ClassVar[Literal["billing.meter_event_adjustment"]] = "billing.meter_event_adjustment"
    ...
    @classmethod
    def create(cls, **params: Unpack["MeterEventAdjustment.CreateParams"]) -> "MeterEventAdjustment":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["MeterEventAdjustment.CreateParams"]) -> "MeterEventAdjustment":
        """
        Creates a billing meter event adjustment.
        """
        return cast(
