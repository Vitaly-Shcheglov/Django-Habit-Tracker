...
class VerificationSessionService(StripeService):
    ...
    class CreateParams(TypedDict):
        ...
        """
        provided_details: NotRequired["VerificationSessionService.CreateParamsProvidedDetails"]
        """
        ...
        Customer ID
        """
        related_person: NotRequired["VerificationSessionService.CreateParamsRelatedPerson"]
        """
    ...
    class CreateParamsOptions(TypedDict):
        document: NotRequired["Literal['']|VerificationSessionService.CreateParamsOptionsDocument"]
        """
    ...
    class ListParams(TypedDict):
        ...
        A string to reference this user. This can be a customer ID, a session ID, or similar, and can be used to reconcile this verification with your internal systems.
        """
        created: NotRequired["VerificationSessionService.ListParamsCreated|int"]
        """
    ...
    class UpdateParams(TypedDict):
        ...
        A set of options for the session's verification checks.
        """
        provided_details: NotRequired["VerificationSessionService.UpdateParamsProvidedDetails"]
        """
        Details provided about the user being verified. These details may be shown to the user.
        """
        type: NotRequired[Literal["document", "id_number"]]
    ...
    class UpdateParamsOptions(TypedDict):
        document: NotRequired["Literal['']|VerificationSessionService.UpdateParamsOptionsDocument"]
        """
        Options that apply to the [document check](https://stripe.com/docs/identity/verification-checks?type=document).
        """
