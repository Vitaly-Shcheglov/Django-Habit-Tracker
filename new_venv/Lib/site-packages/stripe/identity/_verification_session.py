...
class VerificationSession(
    ...
    OBJECT_NAME: ClassVar[Literal["identity.verification_session"]] = "identity.verification_session"
    ...
    class Options(StripeObject):
        class Document(StripeObject):
            allowed_types: Optional[List[Literal["driving_license", "id_card", "passport"]]]
            """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        provided_details: NotRequired["VerificationSession.CreateParamsProvidedDetails"]
        """
        ...
        Customer ID
        """
        related_person: NotRequired["VerificationSession.CreateParamsRelatedPerson"]
        """
    ...
    class CreateParamsOptions(TypedDict):
        document: NotRequired["Literal['']|VerificationSession.CreateParamsOptionsDocument"]
        """
        Options that apply to the [document check](https://stripe.com/docs/identity/verification-checks?type=document).
        """

    class CreateParamsOptionsDocument(TypedDict):
        allowed_types: NotRequired[List[Literal["driving_license", "id_card", "passport"]]]
        """
        Array of strings of allowed identity document types. If the provided identity document isn't one of the allowed types, the verification check will fail with a document_type_not_allowed error code.
        """
    ...
    class ListParams(RequestOptions):
        ...
        """
        status: NotRequired[Literal["canceled", "processing", "requires_input", "verified"]]
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        A set of options for the session's verification checks.
        """
        provided_details: NotRequired["VerificationSession.ModifyParamsProvidedDetails"]
        """
        Details provided about the user being verified. These details may be shown to the user.
        """
        type: NotRequired[Literal["document", "id_number"]]
    ...
    class ModifyParamsOptions(TypedDict):
        document: NotRequired["Literal['']|VerificationSession.ModifyParamsOptionsDocument"]
        """
        Options that apply to the [document check](https://stripe.com/docs/identity/verification-checks?type=document).
        """
    ...
    @classmethod
    def _cls_cancel(cls, session: str, **params: Unpack["VerificationSession.CancelParams"]) -> "VerificationSession":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/identity/verification_sessions/{session}/cancel".format(session=sanitize_id(session)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def cancel(session: str, **params: Unpack["VerificationSession.CancelParams"]) -> "VerificationSession":
        """
        A VerificationSession object can be canceled when it is in requires_input [status](https://docs.stripe.com/docs/identity/how-sessions-work).
    ...
    @overload
    def cancel(self, **params: Unpack["VerificationSession.CancelParams"]) -> "VerificationSession":
        """
        A VerificationSession object can be canceled when it is in requires_input [status](https://docs.stripe.com/docs/identity/how-sessions-work).
    ...
    def cancel(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/identity/verification_sessions/{session}/cancel".format(session=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    async def cancel_async(self, **params: Unpack["VerificationSession.CancelParams"]) -> "VerificationSession":
        """
        A VerificationSession object can be canceled when it is in requires_input [status](https://docs.stripe.com/docs/identity/how-sessions-work).
    ...
    @classmethod
    def create(cls, **params: Unpack["VerificationSession.CreateParams"]) -> "VerificationSession":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["VerificationSession.CreateParams"]) -> "VerificationSession":
        """
        Creates a VerificationSession object.
    ...
    @classmethod
    def list(cls, **params: Unpack["VerificationSession.ListParams"]) -> ListObject["VerificationSession"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["VerificationSession.ListParams"]) -> ListObject["VerificationSession"]:
        """
        Returns a list of VerificationSessions
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["VerificationSession.ModifyParams"]) -> "VerificationSession":
        """
    ...
    @classmethod
    def _cls_redact(cls, session: str, **params: Unpack["VerificationSession.RedactParams"]) -> "VerificationSession":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/identity/verification_sessions/{session}/redact".format(session=sanitize_id(session)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def redact(session: str, **params: Unpack["VerificationSession.RedactParams"]) -> "VerificationSession":
        """
        Redact a VerificationSession to remove all collected information from Stripe. This will redact
        the VerificationSession and all objects related to it, including VerificationReports, Events,
        request logs, etc.
    ...
    @overload
    def redact(self, **params: Unpack["VerificationSession.RedactParams"]) -> "VerificationSession":
        """
        Redact a VerificationSession to remove all collected information from Stripe. This will redact
        the VerificationSession and all objects related to it, including VerificationReports, Events,
        request logs, etc.
    ...
    def redact(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/identity/verification_sessions/{session}/redact".format(session=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    async def redact_async(self, **params: Unpack["VerificationSession.RedactParams"]) -> "VerificationSession":
        """
        Redact a VerificationSession to remove all collected information from Stripe. This will redact
        the VerificationSession and all objects related to it, including VerificationReports, Events,
        request logs, etc.
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["VerificationSession.RetrieveParams"]) -> "VerificationSession":
        """
