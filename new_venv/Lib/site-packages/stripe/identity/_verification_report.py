...
class VerificationReport(ListableAPIResource["VerificationReport"]):
    ...
    OBJECT_NAME: ClassVar[Literal["identity.verification_report"]] = "identity.verification_report"
    ...
    class Email(StripeObject):
        class Error(StripeObject):
            code: Optional[Literal["email_unverified_other", "email_verification_declined"]]
            """
            A short machine-readable string giving the reason for the verification failure.
            """
            reason: Optional[str]
    ...
    class Phone(StripeObject):
        class Error(StripeObject):
            code: Optional[Literal["phone_unverified_other", "phone_verification_declined"]]
            """
            A short machine-readable string giving the reason for the verification failure.
            """
            reason: Optional[str]
    ...
    @classmethod
    def list(cls, **params: Unpack["VerificationReport.ListParams"]) -> ListObject["VerificationReport"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["VerificationReport.ListParams"]) -> ListObject["VerificationReport"]:
        """
        List all verification reports.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["VerificationReport.RetrieveParams"]) -> "VerificationReport":
        """
