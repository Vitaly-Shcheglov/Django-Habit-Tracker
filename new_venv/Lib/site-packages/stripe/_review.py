...
class Review(ListableAPIResource["Review"]):
    ...
    @classmethod
    def _cls_approve(cls, review: str, **params: Unpack["Review.ApproveParams"]) -> "Review":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/reviews/{review}/approve".format(review=sanitize_id(review)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def approve(review: str, **params: Unpack["Review.ApproveParams"]) -> "Review":
        """
        Approves a Review object, closing it and removing it from the list of reviews.
        """
        ...
    ...
    def approve(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/reviews/{review}/approve".format(review=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_approve_async(cls, review: str, **params: Unpack["Review.ApproveParams"]) -> "Review":
        """
        Approves a Review object, closing it and removing it from the list of reviews.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def approve_async(review: str, **params: Unpack["Review.ApproveParams"]) -> "Review":
        """
        Approves a Review object, closing it and removing it from the list of reviews.
        """
        ...
    ...
    @overload
    async def approve_async(self, **params: Unpack["Review.ApproveParams"]) -> "Review":
        """
        Approves a Review object, closing it and removing it from the list of reviews.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["Review.ListParams"]) -> ListObject["Review"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Review.ListParams"]) -> ListObject["Review"]:
        """
        Returns a list of Review objects that have open set to true. The objects are sorted in descending order by creation date, with the most recently created object appearing first.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Review.RetrieveParams"]) -> "Review":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Review.RetrieveParams"]) -> "Review":
        """
        Retrieves a Review object.
        """
        instance = cls(id, **params)
