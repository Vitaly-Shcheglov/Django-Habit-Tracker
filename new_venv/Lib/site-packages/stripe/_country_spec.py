...
class CountrySpec(ListableAPIResource["CountrySpec"]):
    ...
    @classmethod
    def list(cls, **params: Unpack["CountrySpec.ListParams"]) -> ListObject["CountrySpec"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["CountrySpec.ListParams"]) -> ListObject["CountrySpec"]:
        """
        Lists all Country Spec objects available in the API.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["CountrySpec.RetrieveParams"]) -> "CountrySpec":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["CountrySpec.RetrieveParams"]) -> "CountrySpec":
        """
        Returns a Country Spec for a given Country code.
        """
        instance = cls(id, **params)
