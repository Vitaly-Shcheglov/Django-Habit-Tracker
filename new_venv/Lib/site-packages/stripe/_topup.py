...
class Topup(
    ...
    @classmethod
    def _cls_cancel(cls, topup: str, **params: Unpack["Topup.CancelParams"]) -> "Topup":
        """
    ...
    def cancel(self, **params: Unpack["Topup.CancelParams"]) -> "Topup":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Cancels a top-up. Only pending top-ups can be canceled.
        """
        return cast(
            ...
            self._request(
                "post",
                "/v1/topups/{topup}/cancel".format(topup=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_cancel_async(cls, topup: str, **params: Unpack["Topup.CancelParams"]) -> "Topup":
        """
        Cancels a top-up. Only pending top-ups can be canceled.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def cancel_async(topup: str, **params: Unpack["Topup.CancelParams"]) -> "Topup":
        """
        Cancels a top-up. Only pending top-ups can be canceled.
        """
        ...
    ...
    @overload
    async def cancel_async(self, **params: Unpack["Topup.CancelParams"]) -> "Topup":
        """
        Cancels a top-up. Only pending top-ups can be canceled.
        """
        ...
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Topup.CreateParams"]) -> "Topup":
        """
        Top up the balance of an account
        """
        return cast(
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Topup.ListParams"]) -> ListObject["Topup"]:
        """
        Returns a list of top-ups.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Topup.ModifyParams"]) -> "Topup":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Topup.ModifyParams"]) -> "Topup":
        """
        Updates the metadata of a top-up. Other top-up details are not editable by design.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Topup.RetrieveParams"]) -> "Topup":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Topup.RetrieveParams"]) -> "Topup":
        """
        Retrieves the details of a top-up that has previously been created. Supply the unique top-up ID that was returned from your previous request, and Stripe will return the corresponding top-up information.
        """
        instance = cls(id, **params)
