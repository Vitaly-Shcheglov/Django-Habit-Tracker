...
class PaymentMethodService(StripeService):
    ...
    class CreateParams(TypedDict):
        ...
        """
        afterpay_clearpay: NotRequired["PaymentMethodService.CreateParamsAfterpayClearpay"]
        """
        ...
        """
        au_becs_debit: NotRequired["PaymentMethodService.CreateParamsAuBecsDebit"]
        """
        ...
        """
        billing_details: NotRequired["PaymentMethodService.CreateParamsBillingDetails"]
        """
        ...
        """
        customer_balance: NotRequired["PaymentMethodService.CreateParamsCustomerBalance"]
        """
        ...
        """
        interac_present: NotRequired["PaymentMethodService.CreateParamsInteracPresent"]
        """
        ...
        """
        nz_bank_account: NotRequired["PaymentMethodService.CreateParamsNzBankAccount"]
        """
        ...
        """
        radar_options: NotRequired["PaymentMethodService.CreateParamsRadarOptions"]
        """
        ...
        """
        us_bank_account: NotRequired["PaymentMethodService.CreateParamsUsBankAccount"]
        """
    ...
    class CreateParamsBillingDetails(TypedDict):
        address: NotRequired["Literal['']|PaymentMethodService.CreateParamsBillingDetailsAddress"]
        """
        Billing address.
        """
    ...
    class UpdateParams(TypedDict):
        ...
        This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to `unspecified`.
        """
        billing_details: NotRequired["PaymentMethodService.UpdateParamsBillingDetails"]
        """
        Billing information associated with the PaymentMethod that may be used or required by particular types of payment methods.
        """
    ...
    class UpdateParamsBillingDetails(TypedDict):
        address: NotRequired["Literal['']|PaymentMethodService.UpdateParamsBillingDetailsAddress"]
        """
        Billing address.
        """
        email: NotRequired["Literal['']|str"]
