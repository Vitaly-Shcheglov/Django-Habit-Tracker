...
class ShippingRate(
    ...
    class CreateParams(RequestOptions):
        delivery_estimate: NotRequired["ShippingRate.CreateParamsDeliveryEstimate"]
        """
    ...
    class CreateParamsDeliveryEstimate(TypedDict):
        maximum: NotRequired["ShippingRate.CreateParamsDeliveryEstimateMaximum"]
        """
        The upper bound of the estimated range. If empty, represents no upper bound i.e., infinite.
        """
        minimum: NotRequired["ShippingRate.CreateParamsDeliveryEstimateMinimum"]
        """
        The lower bound of the estimated range. If empty, represents no lower bound.
        """
    ...
    class CreateParamsFixedAmount(TypedDict):
        ...
        Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
        """
        currency_options: NotRequired[Dict[str, "ShippingRate.CreateParamsFixedAmountCurrencyOptions"]]
        """
        Shipping rates defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        """
    ...
    class ModifyParamsFixedAmount(TypedDict):
        currency_options: NotRequired[Dict[str, "ShippingRate.ModifyParamsFixedAmountCurrencyOptions"]]
        """
        Shipping rates defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        """
    ...
    @classmethod
    def create(cls, **params: Unpack["ShippingRate.CreateParams"]) -> "ShippingRate":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["ShippingRate.CreateParams"]) -> "ShippingRate":
        """
        Creates a new shipping rate object.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["ShippingRate.ListParams"]) -> ListObject["ShippingRate"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["ShippingRate.ListParams"]) -> ListObject["ShippingRate"]:
        """
        Returns a list of your shipping rates.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["ShippingRate.ModifyParams"]) -> "ShippingRate":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["ShippingRate.ModifyParams"]) -> "ShippingRate":
        """
        Updates an existing shipping rate object.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["ShippingRate.RetrieveParams"]) -> "ShippingRate":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["ShippingRate.RetrieveParams"]) -> "ShippingRate":
        """
        Returns the shipping rate object with the given ID.
        """
        instance = cls(id, **params)
