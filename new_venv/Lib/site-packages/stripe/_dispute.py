...
class Dispute(ListableAPIResource["Dispute"], UpdateableAPIResource["Dispute"]):
    """
        ...
        class EnhancedEvidence(StripeObject):
            class VisaCompellingEvidence3(StripeObject):
                class DisputedTransaction(StripeObject):
                    ...
                    """
                    merchandise_or_services: Optional[Literal["merchandise", "services"]]
                    """
    ...
    class ModifyParamsEvidence(TypedDict):
        ...
        The Stripe ID for the prior charge which appears to be a duplicate of the disputed charge.
        """
        enhanced_evidence: NotRequired["Literal['']|Dispute.ModifyParamsEvidenceEnhancedEvidence"]
        """
    ...
    class ModifyParamsEvidenceEnhancedEvidence(TypedDict):
        visa_compelling_evidence_3: NotRequired["Dispute.ModifyParamsEvidenceEnhancedEvidenceVisaCompellingEvidence3"]
        """
        Evidence provided for Visa Compelling Evidence 3.0 evidence submission.
        """
        visa_compliance: NotRequired["Dispute.ModifyParamsEvidenceEnhancedEvidenceVisaCompliance"]
        """
    ...
    @classmethod
    def _cls_close(cls, dispute: str, **params: Unpack["Dispute.CloseParams"]) -> "Dispute":
        """
    ...
    @overload
    @staticmethod
    def close(dispute: str, **params: Unpack["Dispute.CloseParams"]) -> "Dispute":
        """
        Closing the dispute for a charge indicates that you do not have any evidence to submit and are essentially dismissing the dispute, acknowledging it as lost.
    ...
    def close(self, **params: Unpack["Dispute.CloseParams"]) -> "Dispute":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Closing the dispute for a charge indicates that you do not have any evidence to submit and are essentially dismissing the dispute, acknowledging it as lost.
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/disputes/{dispute}/close".format(dispute=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_close_async(cls, dispute: str, **params: Unpack["Dispute.CloseParams"]) -> "Dispute":
        """
        Closing the dispute for a charge indicates that you do not have any evidence to submit and are essentially dismissing the dispute, acknowledging it as lost.
    ...
    @overload
    @staticmethod
    async def close_async(dispute: str, **params: Unpack["Dispute.CloseParams"]) -> "Dispute":
        """
        Closing the dispute for a charge indicates that you do not have any evidence to submit and are essentially dismissing the dispute, acknowledging it as lost.
    ...
    @overload
    async def close_async(self, **params: Unpack["Dispute.CloseParams"]) -> "Dispute":
        """
        Closing the dispute for a charge indicates that you do not have any evidence to submit and are essentially dismissing the dispute, acknowledging it as lost.
