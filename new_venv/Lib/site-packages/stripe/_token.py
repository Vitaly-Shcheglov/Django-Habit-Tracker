...
class Token(CreateableAPIResource["Token"]):
    ...
    class CreateParamsAccountCompany(TypedDict):
        ...
        """
        address_kana: NotRequired["Token.CreateParamsAccountCompanyAddressKana"]
        """
        The Kana variation of the company's primary address (Japan only).
        """
        address_kanji: NotRequired["Token.CreateParamsAccountCompanyAddressKanji"]
        """
        ...
        """
        directorship_declaration: NotRequired["Token.CreateParamsAccountCompanyDirectorshipDeclaration"]
        """
        ...
        """
        ownership_declaration: NotRequired["Token.CreateParamsAccountCompanyOwnershipDeclaration"]
        """
        ...
        """
        registration_date: NotRequired["Literal['']|Token.CreateParamsAccountCompanyRegistrationDate"]
        """
        ...
        """
        verification: NotRequired["Token.CreateParamsAccountCompanyVerification"]
        """
    ...
    class CreateParamsAccountCompanyVerification(TypedDict):
        document: NotRequired["Token.CreateParamsAccountCompanyVerificationDocument"]
        """
    ...
    class CreateParamsAccountIndividual(TypedDict):
        ...
        """
        address_kana: NotRequired["Token.CreateParamsAccountIndividualAddressKana"]
        """
        The Kana variation of the individual's primary address (Japan only).
        """
        address_kanji: NotRequired["Token.CreateParamsAccountIndividualAddressKanji"]
        """
        ...
        """
        registered_address: NotRequired["Token.CreateParamsAccountIndividualRegisteredAddress"]
        """
        The individual's registered address.
        """
        relationship: NotRequired["Token.CreateParamsAccountIndividualRelationship"]
        """
        ...
        """
        verification: NotRequired["Token.CreateParamsAccountIndividualVerification"]
        """
    ...
    class CreateParamsAccountIndividualVerification(TypedDict):
        additional_document: NotRequired["Token.CreateParamsAccountIndividualVerificationAdditionalDocument"]
        """
        A document showing address, either a passport, local ID card, or utility bill from a well-known utility company.
        """
        document: NotRequired["Token.CreateParamsAccountIndividualVerificationDocument"]
        """
    ...
    class CreateParamsPerson(TypedDict):
        additional_tos_acceptances: NotRequired["Token.CreateParamsPersonAdditionalTosAcceptances"]
        """
        ...
        Indicates if the person or any of their representatives, family members, or other closely related persons, declares that they hold or have held an important public job or function, in any jurisdiction.
        """
        registered_address: NotRequired["Token.CreateParamsPersonRegisteredAddress"]
        """
    ...
    class CreateParamsPersonAdditionalTosAcceptances(TypedDict):
        account: NotRequired["Token.CreateParamsPersonAdditionalTosAcceptancesAccount"]
        """
    ...
    class CreateParamsPersonDocuments(TypedDict):
        company_authorization: NotRequired["Token.CreateParamsPersonDocumentsCompanyAuthorization"]
        """
    ...
    class CreateParamsPersonUsCfpbData(TypedDict):
        ethnicity_details: NotRequired["Token.CreateParamsPersonUsCfpbDataEthnicityDetails"]
        """
        The persons ethnicity details
        """
        race_details: NotRequired["Token.CreateParamsPersonUsCfpbDataRaceDetails"]
        """
    ...
    class CreateParamsPersonVerification(TypedDict):
        additional_document: NotRequired["Token.CreateParamsPersonVerificationAdditionalDocument"]
        """
        A document showing address, either a passport, local ID card, or utility bill from a well-known utility company.
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Token.CreateParams"]) -> "Token":
        """
        Creates a single-use token that represents a bank account's details.
        You can use this token with any v1 API method in place of a bank account dictionary. You can only use this token once. To do so, attach it to a [connected account](https://docs.stripe.com/api#accounts) where [controller.requirement_collection](https://docs.stripe.com/api/accounts/object#account_object-controller-requirement_collection) is application, which includes Custom accounts.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Token.RetrieveParams"]) -> "Token":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Token.RetrieveParams"]) -> "Token":
        """
        Retrieves the token with the given ID.
        """
        instance = cls(id, **params)
