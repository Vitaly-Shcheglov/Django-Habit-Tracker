...
from stripe import (DEFAULT_API_BASE, DEFAULT_CONNECT_API_BASE,
                    DEFAULT_METER_EVENTS_API_BASE, DEFAULT_UPLOAD_API_BASE)
...
from stripe._requestor_options import BaseAddresses, RequestorOptions
...
from stripe._util import (_convert_to_stripe_object, deprecated,  # noqa: F401
                          get_api_mode)
...
class StripeClient(object):
        ...
        *,
        ...
        if http_client is None:
            http_client = new_default_http_client(
                async_fallback_client=new_http_client_async_fallback(proxy=proxy, verify_ssl_certs=verify_ssl_certs),
                proxy=proxy,
        ...
        self.financial_connections = FinancialConnectionsService(self._requestor)
        ...
        self.payment_method_domains = PaymentMethodDomainService(self._requestor)
        ...
        self.subscription_schedules = SubscriptionScheduleService(self._requestor)
    ...
    def parse_thin_event(
        ...
        payload = cast(Union[bytes, bytearray], raw).decode("utf-8") if hasattr(raw, "decode") else cast(str, raw)
