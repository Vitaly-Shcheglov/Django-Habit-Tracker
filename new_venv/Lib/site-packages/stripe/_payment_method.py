...
class PaymentMethod(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        afterpay_clearpay: NotRequired["PaymentMethod.CreateParamsAfterpayClearpay"]
        """
        ...
        """
        billing_details: NotRequired["PaymentMethod.CreateParamsBillingDetails"]
        """
        ...
        """
        customer_balance: NotRequired["PaymentMethod.CreateParamsCustomerBalance"]
        """
        ...
        """
        interac_present: NotRequired["PaymentMethod.CreateParamsInteracPresent"]
        """
    ...
    class CreateParamsBillingDetails(TypedDict):
        address: NotRequired["Literal['']|PaymentMethod.CreateParamsBillingDetailsAddress"]
        """
        Billing address.
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to `unspecified`.
        """
        billing_details: NotRequired["PaymentMethod.ModifyParamsBillingDetails"]
        """
        Billing information associated with the PaymentMethod that may be used or required by particular types of payment methods.
        """
    ...
    class ModifyParamsBillingDetails(TypedDict):
        address: NotRequired["Literal['']|PaymentMethod.ModifyParamsBillingDetailsAddress"]
        """
        Billing address.
        """
        email: NotRequired["Literal['']|str"]
    ...
    class ModifyParamsCardNetworks(TypedDict):
        preferred: NotRequired["Literal['']|Literal['cartes_bancaires', 'mastercard', 'visa']"]
        """
        The customer's preferred card network for co-branded cards. Supports `cartes_bancaires`, `mastercard`, or `visa`. Selection of a network that does not apply to the card will be stored as `invalid_preference` on the card.
        """
    ...
    def _cls_attach(
        ...
        **params: Unpack["PaymentMethod.AttachParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/payment_methods/{payment_method}/attach".format(payment_method=sanitize_id(payment_method)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def attach(payment_method: str, **params: Unpack["PaymentMethod.AttachParams"]) -> "PaymentMethod":
        """
        Attaches a PaymentMethod object to a Customer.
    ...
    @overload
    def attach(self, **params: Unpack["PaymentMethod.AttachParams"]) -> "PaymentMethod":
        """
        Attaches a PaymentMethod object to a Customer.
    ...
    def attach(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/payment_methods/{payment_method}/attach".format(payment_method=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def attach_async(payment_method: str, **params: Unpack["PaymentMethod.AttachParams"]) -> "PaymentMethod":
        """
        Attaches a PaymentMethod object to a Customer.
    ...
    @overload
    async def attach_async(self, **params: Unpack["PaymentMethod.AttachParams"]) -> "PaymentMethod":
        """
        Attaches a PaymentMethod object to a Customer.
    ...
    @classmethod
    def create(cls, **params: Unpack["PaymentMethod.CreateParams"]) -> "PaymentMethod":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["PaymentMethod.CreateParams"]) -> "PaymentMethod":
        """
        Creates a PaymentMethod object. Read the [Stripe.js reference](https://docs.stripe.com/docs/stripe-js/reference#stripe-create-payment-method) to learn how to create PaymentMethods via Stripe.js.
    ...
    def _cls_detach(
        ...
        **params: Unpack["PaymentMethod.DetachParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/payment_methods/{payment_method}/detach".format(payment_method=sanitize_id(payment_method)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def detach(payment_method: str, **params: Unpack["PaymentMethod.DetachParams"]) -> "PaymentMethod":
        """
        Detaches a PaymentMethod object from a Customer. After a PaymentMethod is detached, it can no longer be used for a payment or re-attached to a Customer.
        """
        ...
    ...
    @overload
    def detach(self, **params: Unpack["PaymentMethod.DetachParams"]) -> "PaymentMethod":
        """
        Detaches a PaymentMethod object from a Customer. After a PaymentMethod is detached, it can no longer be used for a payment or re-attached to a Customer.
        """
        ...
    ...
    def detach(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/payment_methods/{payment_method}/detach".format(payment_method=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def detach_async(payment_method: str, **params: Unpack["PaymentMethod.DetachParams"]) -> "PaymentMethod":
        """
        Detaches a PaymentMethod object from a Customer. After a PaymentMethod is detached, it can no longer be used for a payment or re-attached to a Customer.
        """
        ...
    ...
    @overload
    async def detach_async(self, **params: Unpack["PaymentMethod.DetachParams"]) -> "PaymentMethod":
        """
        Detaches a PaymentMethod object from a Customer. After a PaymentMethod is detached, it can no longer be used for a payment or re-attached to a Customer.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["PaymentMethod.ListParams"]) -> ListObject["PaymentMethod"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["PaymentMethod.ListParams"]) -> ListObject["PaymentMethod"]:
        """
        Returns a list of PaymentMethods for Treasury flows. If you want to list the PaymentMethods attached to a Customer for payments, you should use the [List a Customer's PaymentMethods](https://docs.stripe.com/docs/api/payment_methods/customer_list) API instead.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["PaymentMethod.ModifyParams"]) -> "PaymentMethod":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["PaymentMethod.ModifyParams"]) -> "PaymentMethod":
        """
        Updates a PaymentMethod object. A PaymentMethod must be attached a customer to be updated.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["PaymentMethod.RetrieveParams"]) -> "PaymentMethod":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["PaymentMethod.RetrieveParams"]) -> "PaymentMethod":
        """
        Retrieves a PaymentMethod object attached to the StripeAccount. To retrieve a payment method attached to a Customer, you should use [Retrieve a Customer's PaymentMethods](https://docs.stripe.com/docs/api/payment_methods/customer)
        """
        instance = cls(id, **params)
