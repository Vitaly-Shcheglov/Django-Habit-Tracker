...
class PaymentLinkService(StripeService):
    ...
    class CreateParams(TypedDict):
        after_completion: NotRequired["PaymentLinkService.CreateParamsAfterCompletion"]
        """
        ...
        """
        automatic_tax: NotRequired["PaymentLinkService.CreateParamsAutomaticTax"]
        """
        ...
        """
        consent_collection: NotRequired["PaymentLinkService.CreateParamsConsentCollection"]
        """
        ...
        """
        custom_fields: NotRequired[List["PaymentLinkService.CreateParamsCustomField"]]
        """
        ...
        """
        invoice_creation: NotRequired["PaymentLinkService.CreateParamsInvoiceCreation"]
        """
        ...
        """
        optional_items: NotRequired[List["PaymentLinkService.CreateParamsOptionalItem"]]
        """
        A list of optional items the customer can add to their order at checkout. Use this parameter to pass one-time or recurring [Prices](https://stripe.com/docs/api/prices).
        There is a maximum of 10 optional items allowed on a payment link, and the existing limits on the number of line items allowed on a payment link apply to the combined number of line items and optional items.
        There is a maximum of 20 combined line items and optional items.
        """
        payment_intent_data: NotRequired["PaymentLinkService.CreateParamsPaymentIntentData"]
        """
        ...
        """
        phone_number_collection: NotRequired["PaymentLinkService.CreateParamsPhoneNumberCollection"]
        """
        Controls phone number collection settings during checkout.

        We recommend that you review your privacy policy and check with your legal contacts.
        """
        restrictions: NotRequired["PaymentLinkService.CreateParamsRestrictions"]
        """
        Settings that restrict the usage of a payment link.
        """
        shipping_address_collection: NotRequired["PaymentLinkService.CreateParamsShippingAddressCollection"]
        """
        Configuration for collecting the customer's shipping address.
        """
        shipping_options: NotRequired[List["PaymentLinkService.CreateParamsShippingOption"]]
        """
        ...
        """
        subscription_data: NotRequired["PaymentLinkService.CreateParamsSubscriptionData"]
        """
        When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use `subscription_data`.
        """
        tax_id_collection: NotRequired["PaymentLinkService.CreateParamsTaxIdCollection"]
        """
        Controls tax ID collection during checkout.
        """
        transfer_data: NotRequired["PaymentLinkService.CreateParamsTransferData"]
        """
        The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
        """

    class CreateParamsAfterCompletion(TypedDict):
        hosted_confirmation: NotRequired["PaymentLinkService.CreateParamsAfterCompletionHostedConfirmation"]
        """
        Configuration when `type=hosted_confirmation`.
        """
        redirect: NotRequired["PaymentLinkService.CreateParamsAfterCompletionRedirect"]
        """
    ...
    class CreateParamsAutomaticTax(TypedDict):
        ...
        """
        liability: NotRequired["PaymentLinkService.CreateParamsAutomaticTaxLiability"]
        """
    ...
    class CreateParamsCustomField(TypedDict):
        dropdown: NotRequired["PaymentLinkService.CreateParamsCustomFieldDropdown"]
        """
        ...
        """
        numeric: NotRequired["PaymentLinkService.CreateParamsCustomFieldNumeric"]
        """
    ...
    class CreateParamsCustomFieldDropdown(TypedDict):
        ...
        """
        options: List["PaymentLinkService.CreateParamsCustomFieldDropdownOption"]
        """
    ...
    class CreateParamsCustomText(TypedDict):
        after_submit: NotRequired["Literal['']|PaymentLinkService.CreateParamsCustomTextAfterSubmit"]
        """
        Custom text that should be displayed after the payment confirmation button.
        """
        shipping_address: NotRequired["Literal['']|PaymentLinkService.CreateParamsCustomTextShippingAddress"]
        """
        Custom text that should be displayed alongside shipping address collection.
        """
        submit: NotRequired["Literal['']|PaymentLinkService.CreateParamsCustomTextSubmit"]
        """
    ...
    class CreateParamsInvoiceCreation(TypedDict):
        ...
        """
        invoice_data: NotRequired["PaymentLinkService.CreateParamsInvoiceCreationInvoiceData"]
        """
    ...
    class CreateParamsInvoiceCreationInvoiceData(TypedDict):
        ...
        """
        issuer: NotRequired["PaymentLinkService.CreateParamsInvoiceCreationInvoiceDataIssuer"]
        """
    ...
    class CreateParamsLineItem(TypedDict):
        adjustable_quantity: NotRequired["PaymentLinkService.CreateParamsLineItemAdjustableQuantity"]
        """
    ...
    class CreateParamsOptionalItem(TypedDict):
        adjustable_quantity: NotRequired["PaymentLinkService.CreateParamsOptionalItemAdjustableQuantity"]
        """
    ...
    class CreateParamsSubscriptionData(TypedDict):
        ...
        """
        invoice_settings: NotRequired["PaymentLinkService.CreateParamsSubscriptionDataInvoiceSettings"]
        """
        ...
        """
        trial_settings: NotRequired["PaymentLinkService.CreateParamsSubscriptionDataTrialSettings"]
        """
        Settings related to subscription trials.
        """

    class CreateParamsSubscriptionDataInvoiceSettings(TypedDict):
        issuer: NotRequired["PaymentLinkService.CreateParamsSubscriptionDataInvoiceSettingsIssuer"]
        """
        The connected account that issues the invoice. The invoice is presented with the branding and support information of the specified account.
        """
    ...
    class UpdateParams(TypedDict):
        ...
        """
        after_completion: NotRequired["PaymentLinkService.UpdateParamsAfterCompletion"]
        """
        Behavior after the purchase is complete.
        """
        allow_promotion_codes: NotRequired[bool]
        ...
        Enables user redeemable promotion codes.
        """
        automatic_tax: NotRequired["PaymentLinkService.UpdateParamsAutomaticTax"]
        """
        Configuration for automatic tax collection.
        """
        billing_address_collection: NotRequired[Literal["auto", "required"]]
        ...
        Configuration for collecting the customer's billing address. Defaults to `auto`.
        """
        custom_fields: NotRequired["Literal['']|List[PaymentLinkService.UpdateParamsCustomField]"]
        """
        Collect additional information from your customer using custom fields. Up to 3 fields are supported.
        """
        ...
        The custom message to be displayed to a customer when a payment link is no longer active.
        """
        invoice_creation: NotRequired["PaymentLinkService.UpdateParamsInvoiceCreation"]
        """
        Generate a post-purchase Invoice for one-time payments.
        """
        line_items: NotRequired[List["PaymentLinkService.UpdateParamsLineItem"]]
        """
        The line items representing what is being sold. Each line item represents an item being sold. Up to 20 line items are supported.
        """
        metadata: NotRequired[Dict[str, str]]
        ...
        Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`. Metadata associated with this Payment Link will automatically be copied to [checkout sessions](https://stripe.com/docs/api/checkout/sessions) created by this payment link.
        """
        payment_intent_data: NotRequired["PaymentLinkService.UpdateParamsPaymentIntentData"]
        """
        A subset of parameters to be passed to PaymentIntent creation for Checkout Sessions in `payment` mode.
        """
        payment_method_collection: NotRequired[Literal["always", "if_required"]]
        ...
        """
        phone_number_collection: NotRequired["PaymentLinkService.UpdateParamsPhoneNumberCollection"]
        """
        Controls phone number collection settings during checkout.

        We recommend that you review your privacy policy and check with your legal contacts.
        """
        restrictions: NotRequired["Literal['']|PaymentLinkService.UpdateParamsRestrictions"]
        """
        Settings that restrict the usage of a payment link.
        """
        ...
        Describes the type of transaction being performed in order to customize relevant text on the page, such as the submit button. Changing this value will also affect the hostname in the [url](https://stripe.com/docs/api/payment_links/payment_links/object#url) property (example: `donate.stripe.com`).
        """
        subscription_data: NotRequired["PaymentLinkService.UpdateParamsSubscriptionData"]
        """
        When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use `subscription_data`.
        """
    ...
    class UpdateParamsAfterCompletion(TypedDict):
        hosted_confirmation: NotRequired["PaymentLinkService.UpdateParamsAfterCompletionHostedConfirmation"]
        """
        Configuration when `type=hosted_confirmation`.
        """
        redirect: NotRequired["PaymentLinkService.UpdateParamsAfterCompletionRedirect"]
        """
        Configuration when `type=redirect`.
        """
        type: Literal["hosted_confirmation", "redirect"]
    ...
    class UpdateParamsAutomaticTax(TypedDict):
        ...
        Enabling this parameter causes the payment link to collect any billing address information necessary for tax calculation.
        """
        liability: NotRequired["PaymentLinkService.UpdateParamsAutomaticTaxLiability"]
        """
        The account that's liable for tax. If set, the business address and tax registrations required to perform the tax calculation are loaded from this account. The tax transaction is returned in the report of the connected account.
        """
    ...
    class UpdateParamsCustomField(TypedDict):
        dropdown: NotRequired["PaymentLinkService.UpdateParamsCustomFieldDropdown"]
        """
        Configuration for `type=dropdown` fields.
        """
        key: str
        ...
        The label for the field, displayed to the customer.
        """
        numeric: NotRequired["PaymentLinkService.UpdateParamsCustomFieldNumeric"]
        """
        Configuration for `type=numeric` fields.
        """
        optional: NotRequired[bool]
    ...
    class UpdateParamsCustomFieldDropdown(TypedDict):
        ...
        The value that will pre-fill the field on the payment page.Must match a `value` in the `options` array.
        """
        options: List["PaymentLinkService.UpdateParamsCustomFieldDropdownOption"]
        """
        The options available for the customer to select. Up to 200 options allowed.
        """
    ...
    class UpdateParamsCustomText(TypedDict):
        after_submit: NotRequired["Literal['']|PaymentLinkService.UpdateParamsCustomTextAfterSubmit"]
        """
        Custom text that should be displayed after the payment confirmation button.
        """
        shipping_address: NotRequired["Literal['']|PaymentLinkService.UpdateParamsCustomTextShippingAddress"]
        """
        Custom text that should be displayed alongside shipping address collection.
        """
        submit: NotRequired["Literal['']|PaymentLinkService.UpdateParamsCustomTextSubmit"]
        """
        Custom text that should be displayed alongside the payment confirmation button.
        """
        terms_of_service_acceptance: NotRequired[
    ...
    class UpdateParamsInvoiceCreation(TypedDict):
        ...
        Whether the feature is enabled
        """
        invoice_data: NotRequired["PaymentLinkService.UpdateParamsInvoiceCreationInvoiceData"]
        """
        Invoice PDF configuration.
        """
    ...
    class UpdateParamsInvoiceCreationInvoiceData(TypedDict):
        ...
        Default footer to be displayed on invoices for this customer.
        """
        issuer: NotRequired["PaymentLinkService.UpdateParamsInvoiceCreationInvoiceDataIssuer"]
        """
        The connected account that issues the invoice. The invoice is presented with the branding and support information of the specified account.
        """
        metadata: NotRequired["Literal['']|Dict[str, str]"]
    ...
    class UpdateParamsLineItem(TypedDict):
        adjustable_quantity: NotRequired["PaymentLinkService.UpdateParamsLineItemAdjustableQuantity"]
        """
        When set, provides configuration for this item's quantity to be adjusted by the customer during checkout.
        """
        id: str
    ...
    class UpdateParamsSubscriptionData(TypedDict):
        invoice_settings: NotRequired["PaymentLinkService.UpdateParamsSubscriptionDataInvoiceSettings"]
        """
        All invoices will be billed using the specified settings.
        """
        metadata: NotRequired["Literal['']|Dict[str, str]"]
        ...
        Integer representing the number of trial period days before the customer is charged for the first time. Has to be at least 1.
        """
        trial_settings: NotRequired["Literal['']|PaymentLinkService.UpdateParamsSubscriptionDataTrialSettings"]
        """
        Settings related to subscription trials.
        """

    class UpdateParamsSubscriptionDataInvoiceSettings(TypedDict):
        issuer: NotRequired["PaymentLinkService.UpdateParamsSubscriptionDataInvoiceSettingsIssuer"]
        """
        The connected account that issues the invoice. The invoice is presented with the branding and support information of the specified account.
        """
