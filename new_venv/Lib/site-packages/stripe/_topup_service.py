...
class TopupService(StripeService):
    ...
    def create(self, params: "TopupService.CreateParams", options: RequestOptions = {}) -> Topup:
        """
    ...
    async def create_async(self, params: "TopupService.CreateParams", options: RequestOptions = {}) -> Topup:
        """
        Top up the balance of an account
        """
        return cast(
