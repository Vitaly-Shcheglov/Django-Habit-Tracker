...
class Product(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        marketing_features: NotRequired[List["Product.CreateParamsMarketingFeature"]]
        """
        ...
        """
        package_dimensions: NotRequired["Product.CreateParamsPackageDimensions"]
        """
    ...
    class CreateParamsDefaultPriceData(TypedDict):
        ...
        """
        currency_options: NotRequired[Dict[str, "Product.CreateParamsDefaultPriceDataCurrencyOptions"]]
        """
        Prices defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        """
        custom_unit_amount: NotRequired["Product.CreateParamsDefaultPriceDataCustomUnitAmount"]
        """
    ...
    class CreateParamsDefaultPriceDataCurrencyOptions(TypedDict):
        custom_unit_amount: NotRequired["Product.CreateParamsDefaultPriceDataCurrencyOptionsCustomUnitAmount"]
        """
        When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
        """
        tax_behavior: NotRequired[Literal["exclusive", "inclusive", "unspecified"]]
        ...
        Only required if a [default tax behavior](https://stripe.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
        """
        tiers: NotRequired[List["Product.CreateParamsDefaultPriceDataCurrencyOptionsTier"]]
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
        """
        marketing_features: NotRequired["Literal['']|List[Product.ModifyParamsMarketingFeature]"]
        """
        A list of up to 15 marketing features for this product. These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
        """
        ...
        The product's name, meant to be displayable to the customer.
        """
        package_dimensions: NotRequired["Literal['']|Product.ModifyParamsPackageDimensions"]
        """
        The dimensions of this product for shipping purposes.
        """
        shippable: NotRequired[bool]
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Product.CreateParams"]) -> "Product":
        """
        Creates a new product object.
        """
        return cast(
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["Product.DeleteParams"]) -> "Product":
        """
    ...
    @overload
    @staticmethod
    def delete(sid: str, **params: Unpack["Product.DeleteParams"]) -> "Product":
        """
        Delete a product. Deleting a product is only possible if it has no prices associated with it. Additionally, deleting a product with type=good is only possible if it has no SKUs associated with it.
        """
        ...
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["Product.DeleteParams"]) -> "Product":
        """
        Delete a product. Deleting a product is only possible if it has no prices associated with it. Additionally, deleting a product with type=good is only possible if it has no SKUs associated with it.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["Product.DeleteParams"]) -> "Product":
        """
        Delete a product. Deleting a product is only possible if it has no prices associated with it. Additionally, deleting a product with type=good is only possible if it has no SKUs associated with it.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["Product.DeleteParams"]) -> "Product":
        """
        Delete a product. Deleting a product is only possible if it has no prices associated with it. Additionally, deleting a product with type=good is only possible if it has no SKUs associated with it.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["Product.ListParams"]) -> ListObject["Product"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Product.ListParams"]) -> ListObject["Product"]:
        """
        Returns a list of your products. The products are returned sorted by creation date, with the most recently created products appearing first.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Product.ModifyParams"]) -> "Product":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Product.ModifyParams"]) -> "Product":
        """
        Updates the specific product by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Product.RetrieveParams"]) -> "Product":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Product.RetrieveParams"]) -> "Product":
        """
        Retrieves the details of an existing product. Supply the unique product ID from either a product creation request or the product list, and Stripe will return the corresponding product information.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def search(cls, *args, **kwargs: Unpack["Product.SearchParams"]) -> SearchResultObject["Product"]:
        """
    ...
    @classmethod
    async def search_async(cls, *args, **kwargs: Unpack["Product.SearchParams"]) -> SearchResultObject["Product"]:
        """
        Search for products you've previously created using Stripe's [Search Query Language](https://docs.stripe.com/docs/search#search-query-language).
        Don't use search in read-after-write flows where strict consistency is necessary. Under normal operating
        conditions, data is searchable in less than a minute. Occasionally, propagation of new or updated data can be up
        to an hour behind during outages. Search functionality is not available to merchants in India.
        """
        return await cls._search_async(search_url="/v1/products/search", *args, **kwargs)

    @classmethod
    def search_auto_paging_iter(cls, *args, **kwargs: Unpack["Product.SearchParams"]) -> Iterator["Product"]:
    ...
    def delete_feature(
        ...
        **params: Unpack["Product.DeleteFeatureParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "delete",
                "/v1/products/{product}/features/{id}".format(product=sanitize_id(product), id=sanitize_id(id)),
                params=params,
            ),
        )
    ...
    def list_features(
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/products/{product}/features".format(product=sanitize_id(product)),
                params=params,
            ),
        )
    ...
    @classmethod
    def create_feature(cls, product: str, **params: Unpack["Product.CreateFeatureParams"]) -> "ProductFeature":
        """
