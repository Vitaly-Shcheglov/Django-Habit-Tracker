...
class Source(CreateableAPIResource["Source"], UpdateableAPIResource["Source"]):
    ...
    class CreateParams(RequestOptions):
        ...
        """
        flow: NotRequired[Literal["code_verification", "none", "receiver", "redirect"]]
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Source.CreateParams"]) -> "Source":
        """
        Creates a new source object.
        """
        return cast(
    ...
    def _cls_list_source_transactions(
        ...
        **params: Unpack["Source.ListSourceTransactionsParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/sources/{source}/source_transactions".format(source=sanitize_id(source)),
                params=params,
            ),
        )
    ...
    def list_source_transactions(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "get",
                "/v1/sources/{source}/source_transactions".format(source=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Source.ModifyParams"]) -> "Source":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Source.ModifyParams"]) -> "Source":
        """
        Updates the specified source by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Source.RetrieveParams"]) -> "Source":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Source.RetrieveParams"]) -> "Source":
        """
        Retrieves an existing source object. Supply the unique source ID from a source creation request and Stripe will return the corresponding up-to-date source object information.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def _cls_verify(cls, source: str, **params: Unpack["Source.VerifyParams"]) -> "Source":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/sources/{source}/verify".format(source=sanitize_id(source)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def verify(source: str, **params: Unpack["Source.VerifyParams"]) -> "Source":
        """
        Verify a given source.
        """
        ...
    ...
    def verify(self, **params: Unpack["Source.VerifyParams"]) -> "Source":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Verify a given source.
        """
        return cast(
            ...
            self._request(
                "post",
                "/v1/sources/{source}/verify".format(source=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_verify_async(cls, source: str, **params: Unpack["Source.VerifyParams"]) -> "Source":
        """
        Verify a given source.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def verify_async(source: str, **params: Unpack["Source.VerifyParams"]) -> "Source":
        """
        Verify a given source.
        """
        ...
    ...
    @overload
    async def verify_async(self, **params: Unpack["Source.VerifyParams"]) -> "Source":
        """
        Verify a given source.
        """
        ...
    ...
    def detach(self, **params) -> "Source":
        ...
        if hasattr(self, "customer") and self.customer:
            ...
            raise InvalidRequestError(
                "Source %s does not appear to be currently attached " "to a customer object." % token,
                "id",
            )
