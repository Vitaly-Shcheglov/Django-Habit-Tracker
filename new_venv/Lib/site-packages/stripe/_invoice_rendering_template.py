...
class InvoiceRenderingTemplate(ListableAPIResource["InvoiceRenderingTemplate"]):
    """
    Invoice Rendering Templates are used to configure how invoices are rendered on surfaces like the PDF. Invoice Rendering Templates
    can be created from within the Dashboard, and they can be used over the API when creating invoices.
    """

    OBJECT_NAME: ClassVar[Literal["invoice_rendering_template"]] = "invoice_rendering_template"
    ...
    def _cls_archive(
        ...
        **params: Unpack["InvoiceRenderingTemplate.ArchiveParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/invoice_rendering_templates/{template}/archive".format(template=sanitize_id(template)),
                params=params,
            ),
        )
    ...
    @overload
    def archive(self, **params: Unpack["InvoiceRenderingTemplate.ArchiveParams"]) -> "InvoiceRenderingTemplate":
        """
        Updates the status of an invoice rendering template to ‘archived' so no new Stripe objects (customers, invoices, etc.) can reference it. The template can also no longer be updated. However, if the template is already set on a Stripe object, it will continue to be applied on invoices generated by it.
        """
        ...
    ...
    def archive(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/invoice_rendering_templates/{template}/archive".format(template=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @classmethod
    def list(cls, **params: Unpack["InvoiceRenderingTemplate.ListParams"]) -> ListObject["InvoiceRenderingTemplate"]:
        """
    ...
    def _cls_unarchive(
        ...
        **params: Unpack["InvoiceRenderingTemplate.UnarchiveParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/invoice_rendering_templates/{template}/unarchive".format(template=sanitize_id(template)),
                params=params,
            ),
        )
    ...
    @overload
    def unarchive(self, **params: Unpack["InvoiceRenderingTemplate.UnarchiveParams"]) -> "InvoiceRenderingTemplate":
        """
        Unarchive an invoice rendering template so it can be used on new Stripe objects again.
        """
        ...
    ...
    def unarchive(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/invoice_rendering_templates/{template}/unarchive".format(template=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
