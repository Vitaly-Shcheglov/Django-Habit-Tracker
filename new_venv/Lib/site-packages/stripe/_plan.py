...
class Plan(
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Plan.CreateParams"]) -> "Plan":
        """
        You can now model subscriptions more flexibly using the [Prices API](https://docs.stripe.com/api#prices). It replaces the Plans API and is backwards compatible to simplify your migration.
        """
        return cast(
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["Plan.DeleteParams"]) -> "Plan":
        """
    ...
    def delete(self, **params: Unpack["Plan.DeleteParams"]) -> "Plan":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Deleting plans means new subscribers can't be added. Existing subscribers aren't affected.
        """
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["Plan.DeleteParams"]) -> "Plan":
        """
        Deleting plans means new subscribers can't be added. Existing subscribers aren't affected.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["Plan.DeleteParams"]) -> "Plan":
        """
        Deleting plans means new subscribers can't be added. Existing subscribers aren't affected.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["Plan.DeleteParams"]) -> "Plan":
        """
        Deleting plans means new subscribers can't be added. Existing subscribers aren't affected.
        """
        ...
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Plan.ListParams"]) -> ListObject["Plan"]:
        """
        Returns a list of your plans.
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Plan.ModifyParams"]) -> "Plan":
        """
        Updates the specified plan by setting the values of the parameters passed. Any parameters not provided are left unchanged. By design, you cannot change a plan's ID, amount, currency, or billing cycle.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Plan.RetrieveParams"]) -> "Plan":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Plan.RetrieveParams"]) -> "Plan":
        """
        Retrieves the plan with the given ID.
        """
        instance = cls(id, **params)
