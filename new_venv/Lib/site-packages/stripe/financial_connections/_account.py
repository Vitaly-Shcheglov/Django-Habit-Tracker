...
class Account(ListableAPIResource["Account"]):
    ...
    OBJECT_NAME: ClassVar[Literal["financial_connections.account"]] = "financial_connections.account"
    ...
    """
    permissions: Optional[List[Literal["balances", "ownership", "payment_method", "transactions"]]]
    """
    ...
    @classmethod
    def _cls_disconnect(cls, account: str, **params: Unpack["Account.DisconnectParams"]) -> "Account":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/financial_connections/accounts/{account}/disconnect".format(account=sanitize_id(account)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def disconnect(account: str, **params: Unpack["Account.DisconnectParams"]) -> "Account":
        """
        Disables your access to a Financial Connections Account. You will no longer be able to access data associated with the account (e.g. balances, transactions).
        """
        ...
    ...
    @overload
    def disconnect(self, **params: Unpack["Account.DisconnectParams"]) -> "Account":
        """
        Disables your access to a Financial Connections Account. You will no longer be able to access data associated with the account (e.g. balances, transactions).
        """
        ...
    ...
    def disconnect(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/financial_connections/accounts/{account}/disconnect".format(account=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_disconnect_async(cls, account: str, **params: Unpack["Account.DisconnectParams"]) -> "Account":
        """
        Disables your access to a Financial Connections Account. You will no longer be able to access data associated with the account (e.g. balances, transactions).
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def disconnect_async(account: str, **params: Unpack["Account.DisconnectParams"]) -> "Account":
        """
        Disables your access to a Financial Connections Account. You will no longer be able to access data associated with the account (e.g. balances, transactions).
        """
        ...
    ...
    @overload
    async def disconnect_async(self, **params: Unpack["Account.DisconnectParams"]) -> "Account":
        """
        Disables your access to a Financial Connections Account. You will no longer be able to access data associated with the account (e.g. balances, transactions).
        """
        ...
    ...
    def _cls_list_owners(
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/financial_connections/accounts/{account}/owners".format(account=sanitize_id(account)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def list_owners(account: str, **params: Unpack["Account.ListOwnersParams"]) -> ListObject["AccountOwner"]:
        """
        Lists all owners for a given Account
        """
        ...
    ...
    @overload
    def list_owners(self, **params: Unpack["Account.ListOwnersParams"]) -> ListObject["AccountOwner"]:
        """
        Lists all owners for a given Account
        """
        ...
    ...
    def list_owners(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "get",
                "/v1/financial_connections/accounts/{account}/owners".format(account=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    async def list_owners_async(self, **params: Unpack["Account.ListOwnersParams"]) -> ListObject["AccountOwner"]:
        """
        Lists all owners for a given Account
        """
        ...
    ...
    @classmethod
    def _cls_refresh_account(cls, account: str, **params: Unpack["Account.RefreshAccountParams"]) -> "Account":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/financial_connections/accounts/{account}/refresh".format(account=sanitize_id(account)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def refresh_account(account: str, **params: Unpack["Account.RefreshAccountParams"]) -> "Account":
        """
        Refreshes the data associated with a Financial Connections Account.
        """
        ...
    ...
    @overload
    def refresh_account(self, **params: Unpack["Account.RefreshAccountParams"]) -> "Account":
        """
        Refreshes the data associated with a Financial Connections Account.
        """
        ...
    ...
    def refresh_account(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/financial_connections/accounts/{account}/refresh".format(account=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def refresh_account_async(account: str, **params: Unpack["Account.RefreshAccountParams"]) -> "Account":
        """
        Refreshes the data associated with a Financial Connections Account.
        """
        ...
    ...
    @overload
    async def refresh_account_async(self, **params: Unpack["Account.RefreshAccountParams"]) -> "Account":
        """
        Refreshes the data associated with a Financial Connections Account.
        """
        ...
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Account.RetrieveParams"]) -> "Account":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Account.RetrieveParams"]) -> "Account":
        """
        Retrieves the details of an Financial Connections Account.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def _cls_subscribe(cls, account: str, **params: Unpack["Account.SubscribeParams"]) -> "Account":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/financial_connections/accounts/{account}/subscribe".format(account=sanitize_id(account)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def subscribe(account: str, **params: Unpack["Account.SubscribeParams"]) -> "Account":
        """
        Subscribes to periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    @overload
    def subscribe(self, **params: Unpack["Account.SubscribeParams"]) -> "Account":
        """
        Subscribes to periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    def subscribe(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/financial_connections/accounts/{account}/subscribe".format(account=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_subscribe_async(cls, account: str, **params: Unpack["Account.SubscribeParams"]) -> "Account":
        """
        Subscribes to periodic refreshes of data associated with a Financial Connections Account.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def subscribe_async(account: str, **params: Unpack["Account.SubscribeParams"]) -> "Account":
        """
        Subscribes to periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    @overload
    async def subscribe_async(self, **params: Unpack["Account.SubscribeParams"]) -> "Account":
        """
        Subscribes to periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    @classmethod
    def _cls_unsubscribe(cls, account: str, **params: Unpack["Account.UnsubscribeParams"]) -> "Account":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/financial_connections/accounts/{account}/unsubscribe".format(account=sanitize_id(account)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def unsubscribe(account: str, **params: Unpack["Account.UnsubscribeParams"]) -> "Account":
        """
        Unsubscribes from periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    @overload
    def unsubscribe(self, **params: Unpack["Account.UnsubscribeParams"]) -> "Account":
        """
        Unsubscribes from periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    def unsubscribe(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/financial_connections/accounts/{account}/unsubscribe".format(account=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_unsubscribe_async(cls, account: str, **params: Unpack["Account.UnsubscribeParams"]) -> "Account":
        """
        Unsubscribes from periodic refreshes of data associated with a Financial Connections Account.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def unsubscribe_async(account: str, **params: Unpack["Account.UnsubscribeParams"]) -> "Account":
        """
        Unsubscribes from periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
    ...
    @overload
    async def unsubscribe_async(self, **params: Unpack["Account.UnsubscribeParams"]) -> "Account":
        """
        Unsubscribes from periodic refreshes of data associated with a Financial Connections Account.
        """
        ...
