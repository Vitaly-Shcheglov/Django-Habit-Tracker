...
class OutboundTransferService(StripeService):
    ...
    class ReturnOutboundTransferParams(TypedDict):
        ...
        Specifies which fields in the response should be expanded.
        """
        returned_details: NotRequired["OutboundTransferService.ReturnOutboundTransferParamsReturnedDetails"]
        """
    ...
    class UpdateParamsTrackingDetails(TypedDict):
        ach: NotRequired["OutboundTransferService.UpdateParamsTrackingDetailsAch"]
        """
        ...
        """
        us_domestic_wire: NotRequired["OutboundTransferService.UpdateParamsTrackingDetailsUsDomesticWire"]
        """
