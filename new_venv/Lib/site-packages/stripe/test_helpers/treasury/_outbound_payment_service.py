...
class OutboundPaymentService(StripeService):
    ...
    class ReturnOutboundPaymentParams(TypedDict):
        ...
        Specifies which fields in the response should be expanded.
        """
        returned_details: NotRequired["OutboundPaymentService.ReturnOutboundPaymentParamsReturnedDetails"]
        """
    ...
    class UpdateParamsTrackingDetails(TypedDict):
        ach: NotRequired["OutboundPaymentService.UpdateParamsTrackingDetailsAch"]
        """
        ...
        """
        us_domestic_wire: NotRequired["OutboundPaymentService.UpdateParamsTrackingDetailsUsDomesticWire"]
        """
