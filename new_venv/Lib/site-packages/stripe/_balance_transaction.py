...
class BalanceTransaction(ListableAPIResource["BalanceTransaction"]):
    ...
    OBJECT_NAME: ClassVar[Literal["balance_transaction"]] = "balance_transaction"
    ...
    """
    balance_type: Literal["issuing", "payments", "refund_and_dispute_prefunding"]
    """
    ...
    @classmethod
    def list(cls, **params: Unpack["BalanceTransaction.ListParams"]) -> ListObject["BalanceTransaction"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["BalanceTransaction.ListParams"]) -> ListObject["BalanceTransaction"]:
        """
        Returns a list of transactions that have contributed to the Stripe account balance (e.g., charges, transfers, and so forth). The transactions are returned in sorted order, with the most recent transactions appearing first.
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["BalanceTransaction.RetrieveParams"]) -> "BalanceTransaction":
        """
