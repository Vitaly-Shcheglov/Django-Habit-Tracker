...
class CreditNote(
    ...
    class CreateParamsLine(TypedDict):
        ...
        """
        tax_amounts: NotRequired["Literal['']|List[CreditNote.CreateParamsLineTaxAmount]"]
        """
    ...
    class PreviewLinesParamsLine(TypedDict):
        ...
        The line item quantity to credit.
        """
        tax_amounts: NotRequired["Literal['']|List[CreditNote.PreviewLinesParamsLineTaxAmount]"]
        """
        A list of up to 10 tax amounts for the credit note line item. Cannot be mixed with `tax_rates`.
        """
        tax_rates: NotRequired["Literal['']|List[str]"]
    ...
    class PreviewParamsLine(TypedDict):
        ...
        The line item quantity to credit.
        """
        tax_amounts: NotRequired["Literal['']|List[CreditNote.PreviewParamsLineTaxAmount]"]
        """
        A list of up to 10 tax amounts for the credit note line item. Cannot be mixed with `tax_rates`.
        """
        tax_rates: NotRequired["Literal['']|List[str]"]
    ...
    ID of the customer.
    """
    customer_balance_transaction: Optional[ExpandableField["CustomerBalanceTransaction"]]
    """
    ...
    @classmethod
    def create(cls, **params: Unpack["CreditNote.CreateParams"]) -> "CreditNote":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["CreditNote.CreateParams"]) -> "CreditNote":
        """
        Issue a credit note to adjust the amount of a finalized invoice. A credit note will first reduce the invoice's amount_remaining (and amount_due), but not below zero.
        This amount is indicated by the credit note's pre_payment_amount. The excess amount is indicated by post_payment_amount, and it can result in any combination of the following:
    ...
    @classmethod
    def list(cls, **params: Unpack["CreditNote.ListParams"]) -> ListObject["CreditNote"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["CreditNote.ListParams"]) -> ListObject["CreditNote"]:
        """
        Returns a list of credit notes.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["CreditNote.ModifyParams"]) -> "CreditNote":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["CreditNote.ModifyParams"]) -> "CreditNote":
        """
        Updates an existing credit note.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def preview(cls, **params: Unpack["CreditNote.PreviewParams"]) -> "CreditNote":
        """
    ...
    @classmethod
    async def preview_async(cls, **params: Unpack["CreditNote.PreviewParams"]) -> "CreditNote":
        """
        Get a preview of a credit note without creating it.
        """
        return cast(
    ...
    @classmethod
    def preview_lines(cls, **params: Unpack["CreditNote.PreviewLinesParams"]) -> ListObject["CreditNoteLineItem"]:
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["CreditNote.RetrieveParams"]) -> "CreditNote":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["CreditNote.RetrieveParams"]) -> "CreditNote":
        """
        Retrieves the credit note object with the given identifier.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def _cls_void_credit_note(cls, id: str, **params: Unpack["CreditNote.VoidCreditNoteParams"]) -> "CreditNote":
        """
    ...
    @overload
    @staticmethod
    def void_credit_note(id: str, **params: Unpack["CreditNote.VoidCreditNoteParams"]) -> "CreditNote":
        """
        Marks a credit note as void. Learn more about [voiding credit notes](https://docs.stripe.com/docs/billing/invoices/credit-notes#voiding).
        """
        ...
    ...
    @overload
    def void_credit_note(self, **params: Unpack["CreditNote.VoidCreditNoteParams"]) -> "CreditNote":
        """
        Marks a credit note as void. Learn more about [voiding credit notes](https://docs.stripe.com/docs/billing/invoices/credit-notes#voiding).
        """
        ...
    ...
    def void_credit_note(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/credit_notes/{id}/void".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def void_credit_note_async(id: str, **params: Unpack["CreditNote.VoidCreditNoteParams"]) -> "CreditNote":
        """
        Marks a credit note as void. Learn more about [voiding credit notes](https://docs.stripe.com/docs/billing/invoices/credit-notes#voiding).
        """
        ...
    ...
    @overload
    async def void_credit_note_async(self, **params: Unpack["CreditNote.VoidCreditNoteParams"]) -> "CreditNote":
        """
        Marks a credit note as void. Learn more about [voiding credit notes](https://docs.stripe.com/docs/billing/invoices/credit-notes#voiding).
        """
        ...
    ...
    def list_lines(
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/credit_notes/{credit_note}/lines".format(credit_note=sanitize_id(credit_note)),
                params=params,
            ),
        )
