...
class Configuration(
    ...
    OBJECT_NAME: ClassVar[Literal["billing_portal.configuration"]] = "billing_portal.configuration"
    ...
    class Features(StripeObject):
        class CustomerUpdate(StripeObject):
            allowed_updates: List[Literal["address", "email", "name", "phone", "shipping", "tax_id"]]
            """
        ...
        class SubscriptionUpdate(StripeObject):
            ...
            default_allowed_updates: List[Literal["price", "promotion_code", "quantity"]]
            """
    ...
    class CreateParamsFeatures(TypedDict):
        customer_update: NotRequired["Configuration.CreateParamsFeaturesCustomerUpdate"]
        """
        Information about updating the customer details in the portal.
        """
        invoice_history: NotRequired["Configuration.CreateParamsFeaturesInvoiceHistory"]
        """
        Information about showing the billing history in the portal.
        """
        payment_method_update: NotRequired["Configuration.CreateParamsFeaturesPaymentMethodUpdate"]
        """
        Information about updating payment methods in the portal.
        """
        subscription_cancel: NotRequired["Configuration.CreateParamsFeaturesSubscriptionCancel"]
        """
        Information about canceling subscriptions in the portal.
        """
        subscription_update: NotRequired["Configuration.CreateParamsFeaturesSubscriptionUpdate"]
        """
    ...
    class CreateParamsFeaturesSubscriptionCancel(TypedDict):
        cancellation_reason: NotRequired["Configuration.CreateParamsFeaturesSubscriptionCancelCancellationReason"]
        """
    ...
    class CreateParamsFeaturesSubscriptionUpdate(TypedDict):
        default_allowed_updates: NotRequired["Literal['']|List[Literal['price', 'promotion_code', 'quantity']]"]
        """
        ...
        """
        schedule_at_period_end: NotRequired["Configuration.CreateParamsFeaturesSubscriptionUpdateScheduleAtPeriodEnd"]
        """
    ...
    class CreateParamsFeaturesSubscriptionUpdateScheduleAtPeriodEnd(TypedDict):
        conditions: NotRequired[
            List["Configuration.CreateParamsFeaturesSubscriptionUpdateScheduleAtPeriodEndCondition"]
        ]
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        """
        business_profile: NotRequired["Configuration.ModifyParamsBusinessProfile"]
        """
        The business information shown to customers in the portal.
        """
        default_return_url: NotRequired["Literal['']|str"]
    ...
    class ModifyParamsFeatures(TypedDict):
        customer_update: NotRequired["Configuration.ModifyParamsFeaturesCustomerUpdate"]
        """
        Information about updating the customer details in the portal.
        """
        invoice_history: NotRequired["Configuration.ModifyParamsFeaturesInvoiceHistory"]
        """
        Information about showing the billing history in the portal.
        """
        payment_method_update: NotRequired["Configuration.ModifyParamsFeaturesPaymentMethodUpdate"]
        """
        Information about updating payment methods in the portal.
        """
        subscription_cancel: NotRequired["Configuration.ModifyParamsFeaturesSubscriptionCancel"]
        """
        Information about canceling subscriptions in the portal.
        """
        subscription_update: NotRequired["Configuration.ModifyParamsFeaturesSubscriptionUpdate"]
        """
        Information about updating subscriptions in the portal.
        """
    ...
    class ModifyParamsFeaturesSubscriptionCancel(TypedDict):
        cancellation_reason: NotRequired["Configuration.ModifyParamsFeaturesSubscriptionCancelCancellationReason"]
        """
        Whether the cancellation reasons will be collected in the portal and which options are exposed to the customer
        """
        enabled: NotRequired[bool]
    ...
    class ModifyParamsFeaturesSubscriptionUpdate(TypedDict):
        ...
        Whether the feature is enabled.
        """
        products: NotRequired["Literal['']|List[Configuration.ModifyParamsFeaturesSubscriptionUpdateProduct]"]
        """
        The list of up to 10 products that support subscription updates.
        """
        proration_behavior: NotRequired[Literal["always_invoice", "create_prorations", "none"]]
        ...
        Determines how to handle prorations resulting from subscription updates. Valid values are `none`, `create_prorations`, and `always_invoice`.
        """
        schedule_at_period_end: NotRequired["Configuration.ModifyParamsFeaturesSubscriptionUpdateScheduleAtPeriodEnd"]
        """
        Setting to control when an update should be scheduled at the end of the period instead of applying immediately.
        """
    ...
    @classmethod
    def create(cls, **params: Unpack["Configuration.CreateParams"]) -> "Configuration":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Configuration.CreateParams"]) -> "Configuration":
        """
        Creates a configuration that describes the functionality and behavior of a PortalSession
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["Configuration.ListParams"]) -> ListObject["Configuration"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Configuration.ListParams"]) -> ListObject["Configuration"]:
        """
        Returns a list of configurations that describe the functionality of the customer portal.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Configuration.ModifyParams"]) -> "Configuration":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Configuration.ModifyParams"]) -> "Configuration":
        """
        Updates a configuration that describes the functionality of the customer portal.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Configuration.RetrieveParams"]) -> "Configuration":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Configuration.RetrieveParams"]) -> "Configuration":
        """
        Retrieves a configuration that describes the functionality of the customer portal.
        """
        instance = cls(id, **params)
