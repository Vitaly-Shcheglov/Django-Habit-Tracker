...
class SessionService(StripeService):
    ...
    class CreateParamsFlowData(TypedDict):
        after_completion: NotRequired["SessionService.CreateParamsFlowDataAfterCompletion"]
        """
        Behavior after the flow is completed.
        """
        subscription_cancel: NotRequired["SessionService.CreateParamsFlowDataSubscriptionCancel"]
        """
        Configuration when `flow_data.type=subscription_cancel`.
        """
        subscription_update: NotRequired["SessionService.CreateParamsFlowDataSubscriptionUpdate"]
        """
        Configuration when `flow_data.type=subscription_update`.
        """
        subscription_update_confirm: NotRequired["SessionService.CreateParamsFlowDataSubscriptionUpdateConfirm"]
        """
    ...
    class CreateParamsFlowDataAfterCompletion(TypedDict):
        hosted_confirmation: NotRequired["SessionService.CreateParamsFlowDataAfterCompletionHostedConfirmation"]
        """
        Configuration when `after_completion.type=hosted_confirmation`.
        """
        redirect: NotRequired["SessionService.CreateParamsFlowDataAfterCompletionRedirect"]
        """
    ...
    class CreateParamsFlowDataSubscriptionCancel(TypedDict):
        retention: NotRequired["SessionService.CreateParamsFlowDataSubscriptionCancelRetention"]
        """
    ...
    class CreateParamsFlowDataSubscriptionUpdateConfirm(TypedDict):
        discounts: NotRequired[List["SessionService.CreateParamsFlowDataSubscriptionUpdateConfirmDiscount"]]
        """
        The coupon or promotion code to apply to this subscription update.
        """
        items: List["SessionService.CreateParamsFlowDataSubscriptionUpdateConfirmItem"]
        """
