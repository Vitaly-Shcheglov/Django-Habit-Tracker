...
class ExchangeRate(ListableAPIResource["ExchangeRate"]):
    ...
    *Using this Exchange Rates API beta for any purpose other than to transact on Stripe is strictly prohibited and constitutes a violation of Stripe's terms of service.*
    ...
    @classmethod
    def list(cls, **params: Unpack["ExchangeRate.ListParams"]) -> ListObject["ExchangeRate"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["ExchangeRate.ListParams"]) -> ListObject["ExchangeRate"]:
        """
        Returns a list of objects that contain the rates at which foreign currencies are converted to one another. Only shows the currencies for which Stripe supports.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["ExchangeRate.RetrieveParams"]) -> "ExchangeRate":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["ExchangeRate.RetrieveParams"]) -> "ExchangeRate":
        """
        Retrieves the exchange rates from the given currency to every supported currency.
        """
        instance = cls(id, **params)
