...
class ConfigurationService(StripeService):
    class CreateParams(TypedDict):
        bbpos_wisepos_e: NotRequired["ConfigurationService.CreateParamsBbposWiseposE"]
        """
        ...
        """
        offline: NotRequired["Literal['']|ConfigurationService.CreateParamsOffline"]
        """
        Configurations for collecting transactions offline.
        """
        reboot_window: NotRequired["ConfigurationService.CreateParamsRebootWindow"]
        """
        ...
        """
        tipping: NotRequired["Literal['']|ConfigurationService.CreateParamsTipping"]
        """
        Tipping configurations for readers supporting on-reader tips
        """
        verifone_p400: NotRequired["ConfigurationService.CreateParamsVerifoneP400"]
        """
    ...
    class CreateParamsWifi(TypedDict):
        enterprise_eap_peap: NotRequired["ConfigurationService.CreateParamsWifiEnterpriseEapPeap"]
        """
        Credentials for a WPA-Enterprise WiFi network using the EAP-PEAP authentication method.
        """
        enterprise_eap_tls: NotRequired["ConfigurationService.CreateParamsWifiEnterpriseEapTls"]
        """
        Credentials for a WPA-Enterprise WiFi network using the EAP-TLS authentication method.
        """
        personal_psk: NotRequired["ConfigurationService.CreateParamsWifiPersonalPsk"]
        """
    ...
    class UpdateParams(TypedDict):
        bbpos_wisepos_e: NotRequired["Literal['']|ConfigurationService.UpdateParamsBbposWiseposE"]
        """
        An object containing device type specific settings for BBPOS WisePOS E readers
        """
        expand: NotRequired[List[str]]
        ...
        Name of the configuration
        """
        offline: NotRequired["Literal['']|ConfigurationService.UpdateParamsOffline"]
        """
        Configurations for collecting transactions offline.
        """
        reboot_window: NotRequired["Literal['']|ConfigurationService.UpdateParamsRebootWindow"]
        """
        Reboot time settings for readers that support customized reboot time configuration.
        """
        stripe_s700: NotRequired["Literal['']|ConfigurationService.UpdateParamsStripeS700"]
        """
        An object containing device type specific settings for Stripe S700 readers
        """
        tipping: NotRequired["Literal['']|ConfigurationService.UpdateParamsTipping"]
        """
        Tipping configurations for readers supporting on-reader tips
        """
        verifone_p400: NotRequired["Literal['']|ConfigurationService.UpdateParamsVerifoneP400"]
        """
        An object containing device type specific settings for Verifone P400 readers
        """
    ...
    class UpdateParamsWifi(TypedDict):
        enterprise_eap_peap: NotRequired["ConfigurationService.UpdateParamsWifiEnterpriseEapPeap"]
        """
        Credentials for a WPA-Enterprise WiFi network using the EAP-PEAP authentication method.
        """
        enterprise_eap_tls: NotRequired["ConfigurationService.UpdateParamsWifiEnterpriseEapTls"]
        """
        Credentials for a WPA-Enterprise WiFi network using the EAP-TLS authentication method.
        """
        personal_psk: NotRequired["ConfigurationService.UpdateParamsWifiPersonalPsk"]
        """
        Credentials for a WPA-Personal WiFi network.
        """
        type: Literal["enterprise_eap_peap", "enterprise_eap_tls", "personal_psk"]
