...
from typing_extensions import (TYPE_CHECKING, Literal, NotRequired, Type,
                               TypedDict, Unpack)
...
class Reader(
    ...
    class Action(StripeObject):
        ...
        class RefundPayment(StripeObject):
            ...
            """
            reason: Optional[Literal["duplicate", "fraudulent", "requested_by_customer"]]
            """
    ...
    class CollectInputsParamsInput(TypedDict):
        ...
        """
        type: Literal["email", "numeric", "phone", "selection", "signature", "text"]
        """
    ...
    class CollectPaymentMethodParams(RequestOptions):
        collect_config: NotRequired["Reader.CollectPaymentMethodParamsCollectConfig"]
        """
    ...
    class CollectPaymentMethodParamsCollectConfig(TypedDict):
        ...
        Override showing a tipping selection screen on this transaction.
        """
        tipping: NotRequired["Reader.CollectPaymentMethodParamsCollectConfigTipping"]
        """
    ...
    class ConfirmPaymentIntentParams(RequestOptions):
        confirm_config: NotRequired["Reader.ConfirmPaymentIntentParamsConfirmConfig"]
        """
        Configuration overrides.
        """
        expand: NotRequired[List[str]]
    ...
    class PresentPaymentMethodParams(RequestOptions):
        ...
        """
        card_present: NotRequired["Reader.PresentPaymentMethodParamsCardPresent"]
        """
        ...
        Specifies which fields in the response should be expanded.
        """
        interac_present: NotRequired["Reader.PresentPaymentMethodParamsInteracPresent"]
        """
    ...
    class ProcessPaymentIntentParams(RequestOptions):
        ...
        PaymentIntent ID
        """
        process_config: NotRequired["Reader.ProcessPaymentIntentParamsProcessConfig"]
        """
        Configuration overrides
        """
    ...
    class ProcessPaymentIntentParamsProcessConfig(TypedDict):
        ...
        Override showing a tipping selection screen on this transaction.
        """
        tipping: NotRequired["Reader.ProcessPaymentIntentParamsProcessConfigTipping"]
        """
        Tipping configuration for this transaction.
        """
    ...
    class ProcessSetupIntentParams(RequestOptions):
        ...
        Specifies which fields in the response should be expanded.
        """
        process_config: NotRequired["Reader.ProcessSetupIntentParamsProcessConfig"]
        """
        Configuration overrides
        """
        setup_intent: str
    ...
    class RefundPaymentParams(RequestOptions):
        ...
        Boolean indicating whether the application fee should be refunded when refunding this charge. If a full charge refund is given, the full application fee will be refunded. Otherwise, the application fee will be refunded in an amount proportional to the amount of the charge refunded. An application fee can be refunded only by the application that created the charge.
        """
        refund_payment_config: NotRequired["Reader.RefundPaymentParamsRefundPaymentConfig"]
        """
        Configuration overrides
        """
    ...
    @classmethod
    def _cls_cancel_action(cls, reader: str, **params: Unpack["Reader.CancelActionParams"]) -> "Reader":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/cancel_action".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def cancel_action(reader: str, **params: Unpack["Reader.CancelActionParams"]) -> "Reader":
        """
        Cancels the current reader action.
        """
        ...
    ...
    @overload
    def cancel_action(self, **params: Unpack["Reader.CancelActionParams"]) -> "Reader":
        """
        Cancels the current reader action.
        """
        ...
    ...
    def cancel_action(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/cancel_action".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_cancel_action_async(cls, reader: str, **params: Unpack["Reader.CancelActionParams"]) -> "Reader":
        """
        Cancels the current reader action.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def cancel_action_async(reader: str, **params: Unpack["Reader.CancelActionParams"]) -> "Reader":
        """
        Cancels the current reader action.
        """
        ...
    ...
    @overload
    async def cancel_action_async(self, **params: Unpack["Reader.CancelActionParams"]) -> "Reader":
        """
        Cancels the current reader action.
        """
        ...
    ...
    @classmethod
    def _cls_collect_inputs(cls, reader: str, **params: Unpack["Reader.CollectInputsParams"]) -> "Reader":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/collect_inputs".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def collect_inputs(reader: str, **params: Unpack["Reader.CollectInputsParams"]) -> "Reader":
        """
        Initiates an input collection flow on a Reader.
        """
        ...
    ...
    @overload
    def collect_inputs(self, **params: Unpack["Reader.CollectInputsParams"]) -> "Reader":
        """
        Initiates an input collection flow on a Reader.
        """
        ...
    ...
    def collect_inputs(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/collect_inputs".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_collect_inputs_async(cls, reader: str, **params: Unpack["Reader.CollectInputsParams"]) -> "Reader":
        """
        Initiates an input collection flow on a Reader.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def collect_inputs_async(reader: str, **params: Unpack["Reader.CollectInputsParams"]) -> "Reader":
        """
        Initiates an input collection flow on a Reader.
        """
        ...
    ...
    @overload
    async def collect_inputs_async(self, **params: Unpack["Reader.CollectInputsParams"]) -> "Reader":
        """
        Initiates an input collection flow on a Reader.
        """
        ...
    ...
    def _cls_collect_payment_method(
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/collect_payment_method".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def collect_payment_method(reader: str, **params: Unpack["Reader.CollectPaymentMethodParams"]) -> "Reader":
        """
        Initiates a payment flow on a Reader and updates the PaymentIntent with card details before manual confirmation.
        """
        ...
    ...
    @overload
    def collect_payment_method(self, **params: Unpack["Reader.CollectPaymentMethodParams"]) -> "Reader":
        """
        Initiates a payment flow on a Reader and updates the PaymentIntent with card details before manual confirmation.
        """
        ...
    ...
    def collect_payment_method(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/collect_payment_method".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    async def collect_payment_method_async(self, **params: Unpack["Reader.CollectPaymentMethodParams"]) -> "Reader":
        """
        Initiates a payment flow on a Reader and updates the PaymentIntent with card details before manual confirmation.
        """
        ...
    ...
    def _cls_confirm_payment_intent(
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/confirm_payment_intent".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def confirm_payment_intent(reader: str, **params: Unpack["Reader.ConfirmPaymentIntentParams"]) -> "Reader":
        """
        Finalizes a payment on a Reader.
        """
        ...
    ...
    @overload
    def confirm_payment_intent(self, **params: Unpack["Reader.ConfirmPaymentIntentParams"]) -> "Reader":
        """
        Finalizes a payment on a Reader.
        """
        ...
    ...
    def confirm_payment_intent(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/confirm_payment_intent".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    async def confirm_payment_intent_async(self, **params: Unpack["Reader.ConfirmPaymentIntentParams"]) -> "Reader":
        """
        Finalizes a payment on a Reader.
        """
        ...
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Reader.CreateParams"]) -> "Reader":
        """
        Creates a new Reader object.
        """
        return cast(
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["Reader.DeleteParams"]) -> "Reader":
        """
    ...
    def delete(self, **params: Unpack["Reader.DeleteParams"]) -> "Reader":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Deletes a Reader object.
        """
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["Reader.DeleteParams"]) -> "Reader":
        """
        Deletes a Reader object.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["Reader.DeleteParams"]) -> "Reader":
        """
        Deletes a Reader object.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["Reader.DeleteParams"]) -> "Reader":
        """
        Deletes a Reader object.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["Reader.ListParams"]) -> ListObject["Reader"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Reader.ListParams"]) -> ListObject["Reader"]:
        """
        Returns a list of Reader objects.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Reader.ModifyParams"]) -> "Reader":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Reader.ModifyParams"]) -> "Reader":
        """
        Updates a Reader object by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    def _cls_process_payment_intent(
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/process_payment_intent".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def process_payment_intent(reader: str, **params: Unpack["Reader.ProcessPaymentIntentParams"]) -> "Reader":
        """
        Initiates a payment flow on a Reader.
        """
        ...
    ...
    @overload
    def process_payment_intent(self, **params: Unpack["Reader.ProcessPaymentIntentParams"]) -> "Reader":
        """
        Initiates a payment flow on a Reader.
        """
        ...
    ...
    def process_payment_intent(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/process_payment_intent".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    async def process_payment_intent_async(self, **params: Unpack["Reader.ProcessPaymentIntentParams"]) -> "Reader":
        """
        Initiates a payment flow on a Reader.
        """
        ...
    ...
    @classmethod
    def _cls_process_setup_intent(cls, reader: str, **params: Unpack["Reader.ProcessSetupIntentParams"]) -> "Reader":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/process_setup_intent".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def process_setup_intent(reader: str, **params: Unpack["Reader.ProcessSetupIntentParams"]) -> "Reader":
        """
        Initiates a setup intent flow on a Reader.
        """
        ...
    ...
    @overload
    def process_setup_intent(self, **params: Unpack["Reader.ProcessSetupIntentParams"]) -> "Reader":
        """
        Initiates a setup intent flow on a Reader.
        """
        ...
    ...
    def process_setup_intent(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/process_setup_intent".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def process_setup_intent_async(reader: str, **params: Unpack["Reader.ProcessSetupIntentParams"]) -> "Reader":
        """
        Initiates a setup intent flow on a Reader.
        """
        ...
    ...
    @overload
    async def process_setup_intent_async(self, **params: Unpack["Reader.ProcessSetupIntentParams"]) -> "Reader":
        """
        Initiates a setup intent flow on a Reader.
        """
        ...
    ...
    @classmethod
    def _cls_refund_payment(cls, reader: str, **params: Unpack["Reader.RefundPaymentParams"]) -> "Reader":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/refund_payment".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def refund_payment(reader: str, **params: Unpack["Reader.RefundPaymentParams"]) -> "Reader":
        """
        Initiates a refund on a Reader
        """
        ...
    ...
    @overload
    def refund_payment(self, **params: Unpack["Reader.RefundPaymentParams"]) -> "Reader":
        """
        Initiates a refund on a Reader
        """
        ...
    ...
    def refund_payment(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/refund_payment".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_refund_payment_async(cls, reader: str, **params: Unpack["Reader.RefundPaymentParams"]) -> "Reader":
        """
        Initiates a refund on a Reader
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def refund_payment_async(reader: str, **params: Unpack["Reader.RefundPaymentParams"]) -> "Reader":
        """
        Initiates a refund on a Reader
        """
        ...
    ...
    @overload
    async def refund_payment_async(self, **params: Unpack["Reader.RefundPaymentParams"]) -> "Reader":
        """
        Initiates a refund on a Reader
        """
        ...
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Reader.RetrieveParams"]) -> "Reader":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Reader.RetrieveParams"]) -> "Reader":
        """
        Retrieves a Reader object.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def _cls_set_reader_display(cls, reader: str, **params: Unpack["Reader.SetReaderDisplayParams"]) -> "Reader":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/terminal/readers/{reader}/set_reader_display".format(reader=sanitize_id(reader)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def set_reader_display(reader: str, **params: Unpack["Reader.SetReaderDisplayParams"]) -> "Reader":
        """
        Sets reader display to show cart details.
        """
        ...
    ...
    @overload
    def set_reader_display(self, **params: Unpack["Reader.SetReaderDisplayParams"]) -> "Reader":
        """
        Sets reader display to show cart details.
        """
        ...
    ...
    def set_reader_display(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/terminal/readers/{reader}/set_reader_display".format(reader=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def set_reader_display_async(reader: str, **params: Unpack["Reader.SetReaderDisplayParams"]) -> "Reader":
        """
        Sets reader display to show cart details.
        """
        ...
    ...
    @overload
    async def set_reader_display_async(self, **params: Unpack["Reader.SetReaderDisplayParams"]) -> "Reader":
        """
        Sets reader display to show cart details.
        """
        ...
    ...
    class TestHelpers(APIResourceTestHelpers["Reader"]):
        ...
        @overload
        @staticmethod
        def present_payment_method(reader: str, **params: Unpack["Reader.PresentPaymentMethodParams"]) -> "Reader":
            """
            Presents a payment method on a simulated reader. Can be used to simulate accepting a payment, saving a card or refunding a transaction.
            """
            ...
        ...
        @overload
        def present_payment_method(self, **params: Unpack["Reader.PresentPaymentMethodParams"]) -> "Reader":
            """
            Presents a payment method on a simulated reader. Can be used to simulate accepting a payment, saving a card or refunding a transaction.
            """
            ...
        ...
        @overload
        def succeed_input_collection(self, **params: Unpack["Reader.SucceedInputCollectionParams"]) -> "Reader":
            """
            Use this endpoint to trigger a successful input collection on a simulated reader.
            """
            ...
        ...
        @overload
        def timeout_input_collection(self, **params: Unpack["Reader.TimeoutInputCollectionParams"]) -> "Reader":
            """
            Use this endpoint to complete an input collection with a timeout error on a simulated reader.
            """
            ...
