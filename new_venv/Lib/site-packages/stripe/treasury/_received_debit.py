...
class ReceivedDebit(ListableAPIResource["ReceivedDebit"]):
    ...
    OBJECT_NAME: ClassVar[Literal["treasury.received_debit"]] = "treasury.received_debit"
    ...
    class CreateParams(RequestOptions):
        ...
        """
        initiating_payment_method_details: NotRequired["ReceivedDebit.CreateParamsInitiatingPaymentMethodDetails"]
        """
    ...
    class CreateParamsInitiatingPaymentMethodDetails(TypedDict):
        ...
        The source type.
        """
        us_bank_account: NotRequired["ReceivedDebit.CreateParamsInitiatingPaymentMethodDetailsUsBankAccount"]
        """
    ...
    @classmethod
    def list(cls, **params: Unpack["ReceivedDebit.ListParams"]) -> ListObject["ReceivedDebit"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["ReceivedDebit.ListParams"]) -> ListObject["ReceivedDebit"]:
        """
        Returns a list of ReceivedDebits.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["ReceivedDebit.RetrieveParams"]) -> "ReceivedDebit":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["ReceivedDebit.RetrieveParams"]) -> "ReceivedDebit":
        """
        Retrieves the details of an existing ReceivedDebit by passing the unique ReceivedDebit ID from the ReceivedDebit list
        """
        instance = cls(id, **params)
    ...
    class TestHelpers(APIResourceTestHelpers["ReceivedDebit"]):
        ...
        @classmethod
        def create(cls, **params: Unpack["ReceivedDebit.CreateParams"]) -> "ReceivedDebit":
            """
        ...
        @classmethod
        async def create_async(cls, **params: Unpack["ReceivedDebit.CreateParams"]) -> "ReceivedDebit":
            """
            Use this endpoint to simulate a test mode ReceivedDebit initiated by a third party. In live mode, you can't directly create ReceivedDebits initiated by third parties.
            """
            return cast(
