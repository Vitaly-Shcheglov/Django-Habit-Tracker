...
class ReceivedCredit(ListableAPIResource["ReceivedCredit"]):
    ...
    OBJECT_NAME: ClassVar[Literal["treasury.received_credit"]] = "treasury.received_credit"
    ...
    class CreateParams(RequestOptions):
        ...
        """
        initiating_payment_method_details: NotRequired["ReceivedCredit.CreateParamsInitiatingPaymentMethodDetails"]
        """
    ...
    class CreateParamsInitiatingPaymentMethodDetails(TypedDict):
        ...
        The source type.
        """
        us_bank_account: NotRequired["ReceivedCredit.CreateParamsInitiatingPaymentMethodDetailsUsBankAccount"]
        """
    ...
    @classmethod
    def list(cls, **params: Unpack["ReceivedCredit.ListParams"]) -> ListObject["ReceivedCredit"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["ReceivedCredit.ListParams"]) -> ListObject["ReceivedCredit"]:
        """
        Returns a list of ReceivedCredits.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["ReceivedCredit.RetrieveParams"]) -> "ReceivedCredit":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["ReceivedCredit.RetrieveParams"]) -> "ReceivedCredit":
        """
        Retrieves the details of an existing ReceivedCredit by passing the unique ReceivedCredit ID from the ReceivedCredit list.
        """
        instance = cls(id, **params)
    ...
    class TestHelpers(APIResourceTestHelpers["ReceivedCredit"]):
        ...
        @classmethod
        def create(cls, **params: Unpack["ReceivedCredit.CreateParams"]) -> "ReceivedCredit":
            """
        ...
        @classmethod
        async def create_async(cls, **params: Unpack["ReceivedCredit.CreateParams"]) -> "ReceivedCredit":
            """
            Use this endpoint to simulate a test mode ReceivedCredit initiated by a third party. In live mode, you can't directly create ReceivedCredits initiated by third parties.
            """
            return cast(
