...
class FinancialAccountService(StripeService):
    ...
    class CloseParams(TypedDict):
        ...
        """
        forwarding_settings: NotRequired["FinancialAccountService.CloseParamsForwardingSettings"]
        """
    ...
    class CreateParams(TypedDict):
        ...
        """
        platform_restrictions: NotRequired["FinancialAccountService.CreateParamsPlatformRestrictions"]
        """
    ...
    class CreateParamsFeatures(TypedDict):
        card_issuing: NotRequired["FinancialAccountService.CreateParamsFeaturesCardIssuing"]
        """
        Encodes the FinancialAccount's ability to be used with the Issuing product, including attaching cards to and drawing funds from the FinancialAccount.
        """
        deposit_insurance: NotRequired["FinancialAccountService.CreateParamsFeaturesDepositInsurance"]
        """
        Represents whether this FinancialAccount is eligible for deposit insurance. Various factors determine the insurance amount.
        """
        financial_addresses: NotRequired["FinancialAccountService.CreateParamsFeaturesFinancialAddresses"]
        """
        Contains Features that add FinancialAddresses to the FinancialAccount.
        """
        inbound_transfers: NotRequired["FinancialAccountService.CreateParamsFeaturesInboundTransfers"]
        """
        Contains settings related to adding funds to a FinancialAccount from another Account with the same owner.
        """
        intra_stripe_flows: NotRequired["FinancialAccountService.CreateParamsFeaturesIntraStripeFlows"]
        """
        Represents the ability for the FinancialAccount to send money to, or receive money from other FinancialAccounts (for example, via OutboundPayment).
        """
        outbound_payments: NotRequired["FinancialAccountService.CreateParamsFeaturesOutboundPayments"]
        """
        Includes Features related to initiating money movement out of the FinancialAccount to someone else's bucket of money.
        """
        outbound_transfers: NotRequired["FinancialAccountService.CreateParamsFeaturesOutboundTransfers"]
        """
    ...
    class CreateParamsFeaturesFinancialAddresses(TypedDict):
        aba: NotRequired["FinancialAccountService.CreateParamsFeaturesFinancialAddressesAba"]
        """
    ...
    class CreateParamsFeaturesInboundTransfers(TypedDict):
        ach: NotRequired["FinancialAccountService.CreateParamsFeaturesInboundTransfersAch"]
        """
    ...
    class CreateParamsFeaturesOutboundPayments(TypedDict):
        ach: NotRequired["FinancialAccountService.CreateParamsFeaturesOutboundPaymentsAch"]
        """
        Enables ACH transfers via the OutboundPayments API.
        """
        us_domestic_wire: NotRequired["FinancialAccountService.CreateParamsFeaturesOutboundPaymentsUsDomesticWire"]
        """
    ...
    class CreateParamsFeaturesOutboundTransfers(TypedDict):
        ach: NotRequired["FinancialAccountService.CreateParamsFeaturesOutboundTransfersAch"]
        """
        Enables ACH transfers via the OutboundTransfers API.
        """
        us_domestic_wire: NotRequired["FinancialAccountService.CreateParamsFeaturesOutboundTransfersUsDomesticWire"]
        """
    ...
    class UpdateParams(TypedDict):
        ...
        """
        forwarding_settings: NotRequired["FinancialAccountService.UpdateParamsForwardingSettings"]
        """
        A different bank account where funds can be deposited/debited in order to get the closing FA's balance to $0
        """
        metadata: NotRequired[Dict[str, str]]
        ...
        The nickname for the FinancialAccount.
        """
        platform_restrictions: NotRequired["FinancialAccountService.UpdateParamsPlatformRestrictions"]
        """
        The set of functionalities that the platform can restrict on the FinancialAccount.
        """

    class UpdateParamsFeatures(TypedDict):
        card_issuing: NotRequired["FinancialAccountService.UpdateParamsFeaturesCardIssuing"]
        """
        Encodes the FinancialAccount's ability to be used with the Issuing product, including attaching cards to and drawing funds from the FinancialAccount.
        """
        deposit_insurance: NotRequired["FinancialAccountService.UpdateParamsFeaturesDepositInsurance"]
        """
        Represents whether this FinancialAccount is eligible for deposit insurance. Various factors determine the insurance amount.
        """
        financial_addresses: NotRequired["FinancialAccountService.UpdateParamsFeaturesFinancialAddresses"]
        """
        Contains Features that add FinancialAddresses to the FinancialAccount.
        """
        inbound_transfers: NotRequired["FinancialAccountService.UpdateParamsFeaturesInboundTransfers"]
        """
        Contains settings related to adding funds to a FinancialAccount from another Account with the same owner.
        """
        intra_stripe_flows: NotRequired["FinancialAccountService.UpdateParamsFeaturesIntraStripeFlows"]
        """
        Represents the ability for the FinancialAccount to send money to, or receive money from other FinancialAccounts (for example, via OutboundPayment).
        """
        outbound_payments: NotRequired["FinancialAccountService.UpdateParamsFeaturesOutboundPayments"]
        """
        Includes Features related to initiating money movement out of the FinancialAccount to someone else's bucket of money.
        """
        outbound_transfers: NotRequired["FinancialAccountService.UpdateParamsFeaturesOutboundTransfers"]
        """
        Contains a Feature and settings related to moving money out of the FinancialAccount into another Account with the same owner.
        """
    ...
    class UpdateParamsFeaturesFinancialAddresses(TypedDict):
        aba: NotRequired["FinancialAccountService.UpdateParamsFeaturesFinancialAddressesAba"]
        """
        Adds an ABA FinancialAddress to the FinancialAccount.
        """
    ...
    class UpdateParamsFeaturesInboundTransfers(TypedDict):
        ach: NotRequired["FinancialAccountService.UpdateParamsFeaturesInboundTransfersAch"]
        """
        Enables ACH Debits via the InboundTransfers API.
        """
    ...
    class UpdateParamsFeaturesOutboundPayments(TypedDict):
        ach: NotRequired["FinancialAccountService.UpdateParamsFeaturesOutboundPaymentsAch"]
        """
        Enables ACH transfers via the OutboundPayments API.
        """
        us_domestic_wire: NotRequired["FinancialAccountService.UpdateParamsFeaturesOutboundPaymentsUsDomesticWire"]
        """
        Enables US domestic wire transfers via the OutboundPayments API.
        """
    ...
    class UpdateParamsFeaturesOutboundTransfers(TypedDict):
        ach: NotRequired["FinancialAccountService.UpdateParamsFeaturesOutboundTransfersAch"]
        """
        Enables ACH transfers via the OutboundTransfers API.
        """
        us_domestic_wire: NotRequired["FinancialAccountService.UpdateParamsFeaturesOutboundTransfersUsDomesticWire"]
        """
        Enables US domestic wire transfers via the OutboundTransfers API.
        """
