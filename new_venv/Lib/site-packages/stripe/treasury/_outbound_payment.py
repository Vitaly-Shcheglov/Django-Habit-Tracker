...
class OutboundPayment(
    ...
    OBJECT_NAME: ClassVar[Literal["treasury.outbound_payment"]] = "treasury.outbound_payment"
    ...
    class CreateParams(RequestOptions):
        ...
        """
        destination_payment_method_data: NotRequired["OutboundPayment.CreateParamsDestinationPaymentMethodData"]
        """
        Hash used to generate the PaymentMethod to be used for this OutboundPayment. Exclusive with `destination_payment_method`.
        """
        destination_payment_method_options: NotRequired["OutboundPayment.CreateParamsDestinationPaymentMethodOptions"]
        """
        Payment method-specific configuration for this OutboundPayment.
        """
        end_user_details: NotRequired["OutboundPayment.CreateParamsEndUserDetails"]
        """
        End user details.
        """
        expand: NotRequired[List[str]]
    ...
    class CreateParamsDestinationPaymentMethodData(TypedDict):
        billing_details: NotRequired["OutboundPayment.CreateParamsDestinationPaymentMethodDataBillingDetails"]
        """
        ...
        """
        us_bank_account: NotRequired["OutboundPayment.CreateParamsDestinationPaymentMethodDataUsBankAccount"]
        """
    ...
    class ListParams(RequestOptions):
        ...
        """
        status: NotRequired[Literal["canceled", "failed", "posted", "processing", "returned"]]
        """
    ...
    class ReturnOutboundPaymentParams(RequestOptions):
        ...
        Specifies which fields in the response should be expanded.
        """
        returned_details: NotRequired["OutboundPayment.ReturnOutboundPaymentParamsReturnedDetails"]
        """
    ...
    class UpdateParamsTrackingDetails(TypedDict):
        ...
        The US bank account network used to send funds.
        """
        us_domestic_wire: NotRequired["OutboundPayment.UpdateParamsTrackingDetailsUsDomesticWire"]
        """
    ...
    """
    destination_payment_method_details: Optional[DestinationPaymentMethodDetails]
    """
    ...
    @classmethod
    def _cls_cancel(cls, id: str, **params: Unpack["OutboundPayment.CancelParams"]) -> "OutboundPayment":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/treasury/outbound_payments/{id}/cancel".format(id=sanitize_id(id)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def cancel(id: str, **params: Unpack["OutboundPayment.CancelParams"]) -> "OutboundPayment":
        """
        Cancel an OutboundPayment.
        """
        ...
    ...
    @overload
    def cancel(self, **params: Unpack["OutboundPayment.CancelParams"]) -> "OutboundPayment":
        """
        Cancel an OutboundPayment.
        """
        ...
    ...
    def cancel(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/treasury/outbound_payments/{id}/cancel".format(id=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_cancel_async(cls, id: str, **params: Unpack["OutboundPayment.CancelParams"]) -> "OutboundPayment":
        """
        Cancel an OutboundPayment.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def cancel_async(id: str, **params: Unpack["OutboundPayment.CancelParams"]) -> "OutboundPayment":
        """
        Cancel an OutboundPayment.
        """
        ...
    ...
    @overload
    async def cancel_async(self, **params: Unpack["OutboundPayment.CancelParams"]) -> "OutboundPayment":
        """
        Cancel an OutboundPayment.
        """
        ...
    ...
    @classmethod
    def create(cls, **params: Unpack["OutboundPayment.CreateParams"]) -> "OutboundPayment":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["OutboundPayment.CreateParams"]) -> "OutboundPayment":
        """
        Creates an OutboundPayment.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["OutboundPayment.ListParams"]) -> ListObject["OutboundPayment"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["OutboundPayment.ListParams"]) -> ListObject["OutboundPayment"]:
        """
        Returns a list of OutboundPayments sent from the specified FinancialAccount.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["OutboundPayment.RetrieveParams"]) -> "OutboundPayment":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["OutboundPayment.RetrieveParams"]) -> "OutboundPayment":
        """
        Retrieves the details of an existing OutboundPayment by passing the unique OutboundPayment ID from either the OutboundPayment creation request or OutboundPayment list.
        """
        instance = cls(id, **params)
    ...
    class TestHelpers(APIResourceTestHelpers["OutboundPayment"]):
        ...
        @classmethod
        def _cls_fail(cls, id: str, **params: Unpack["OutboundPayment.FailParams"]) -> "OutboundPayment":
            """
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/outbound_payments/{id}/fail".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        def fail(id: str, **params: Unpack["OutboundPayment.FailParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the failed status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @overload
        def fail(self, **params: Unpack["OutboundPayment.FailParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the failed status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @classmethod
        async def _cls_fail_async(cls, id: str, **params: Unpack["OutboundPayment.FailParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the failed status. The OutboundPayment must already be in the processing state.
            """
            return cast(
        ...
        @overload
        @staticmethod
        async def fail_async(id: str, **params: Unpack["OutboundPayment.FailParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the failed status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @overload
        async def fail_async(self, **params: Unpack["OutboundPayment.FailParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the failed status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @classmethod
        def _cls_post(cls, id: str, **params: Unpack["OutboundPayment.PostParams"]) -> "OutboundPayment":
            """
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/outbound_payments/{id}/post".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        def post(id: str, **params: Unpack["OutboundPayment.PostParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the posted status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @overload
        def post(self, **params: Unpack["OutboundPayment.PostParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the posted status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @classmethod
        async def _cls_post_async(cls, id: str, **params: Unpack["OutboundPayment.PostParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the posted status. The OutboundPayment must already be in the processing state.
            """
            return cast(
        ...
        @overload
        @staticmethod
        async def post_async(id: str, **params: Unpack["OutboundPayment.PostParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the posted status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        @overload
        async def post_async(self, **params: Unpack["OutboundPayment.PostParams"]) -> "OutboundPayment":
            """
            Transitions a test mode created OutboundPayment to the posted status. The OutboundPayment must already be in the processing state.
            """
            ...
        ...
        def _cls_return_outbound_payment(
            ...
            **params: Unpack["OutboundPayment.ReturnOutboundPaymentParams"],
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/outbound_payments/{id}/return".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @classmethod
        def _cls_update(cls, id: str, **params: Unpack["OutboundPayment.UpdateParams"]) -> "OutboundPayment":
            """
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/outbound_payments/{id}".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        def update(id: str, **params: Unpack["OutboundPayment.UpdateParams"]) -> "OutboundPayment":
            """
            Updates a test mode created OutboundPayment with tracking details. The OutboundPayment must not be cancelable, and cannot be in the canceled or failed states.
            """
            ...
        ...
        @overload
        def update(self, **params: Unpack["OutboundPayment.UpdateParams"]) -> "OutboundPayment":
            """
            Updates a test mode created OutboundPayment with tracking details. The OutboundPayment must not be cancelable, and cannot be in the canceled or failed states.
            """
            ...
        ...
        def update(  # pyright: ignore[reportGeneralTypeIssues]
            ...
            return cast(
                ...
                self.resource._request(
                    "post",
                    "/v1/test_helpers/treasury/outbound_payments/{id}".format(id=sanitize_id(self.resource.get("id"))),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        async def update_async(id: str, **params: Unpack["OutboundPayment.UpdateParams"]) -> "OutboundPayment":
            """
            Updates a test mode created OutboundPayment with tracking details. The OutboundPayment must not be cancelable, and cannot be in the canceled or failed states.
            """
            ...
        ...
        @overload
        async def update_async(self, **params: Unpack["OutboundPayment.UpdateParams"]) -> "OutboundPayment":
            """
            Updates a test mode created OutboundPayment with tracking details. The OutboundPayment must not be cancelable, and cannot be in the canceled or failed states.
            """
            ...
