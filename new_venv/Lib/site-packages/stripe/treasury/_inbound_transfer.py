...
class InboundTransfer(
    ...
    OBJECT_NAME: ClassVar[Literal["treasury.inbound_transfer"]] = "treasury.inbound_transfer"
    ...
    class FailParams(RequestOptions):
        ...
        Specifies which fields in the response should be expanded.
        """
        failure_details: NotRequired["InboundTransfer.FailParamsFailureDetails"]
        """
    ...
    class ListParams(RequestOptions):
        ...
        """
        status: NotRequired[Literal["canceled", "failed", "processing", "succeeded"]]
        """
    ...
    @overload
    @staticmethod
    def cancel(inbound_transfer: str, **params: Unpack["InboundTransfer.CancelParams"]) -> "InboundTransfer":
        """
        Cancels an InboundTransfer.
        """
        ...
    ...
    @overload
    def cancel(self, **params: Unpack["InboundTransfer.CancelParams"]) -> "InboundTransfer":
        """
        Cancels an InboundTransfer.
        """
        ...
    ...
    @overload
    async def cancel_async(self, **params: Unpack["InboundTransfer.CancelParams"]) -> "InboundTransfer":
        """
        Cancels an InboundTransfer.
        """
        ...
    ...
    @classmethod
    def create(cls, **params: Unpack["InboundTransfer.CreateParams"]) -> "InboundTransfer":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["InboundTransfer.CreateParams"]) -> "InboundTransfer":
        """
        Creates an InboundTransfer.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["InboundTransfer.ListParams"]) -> ListObject["InboundTransfer"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["InboundTransfer.ListParams"]) -> ListObject["InboundTransfer"]:
        """
        Returns a list of InboundTransfers sent from the specified FinancialAccount.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["InboundTransfer.RetrieveParams"]) -> "InboundTransfer":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["InboundTransfer.RetrieveParams"]) -> "InboundTransfer":
        """
        Retrieves the details of an existing InboundTransfer.
        """
        instance = cls(id, **params)
    ...
    class TestHelpers(APIResourceTestHelpers["InboundTransfer"]):
        ...
        @classmethod
        def _cls_fail(cls, id: str, **params: Unpack["InboundTransfer.FailParams"]) -> "InboundTransfer":
            """
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/inbound_transfers/{id}/fail".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        def fail(id: str, **params: Unpack["InboundTransfer.FailParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the failed status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        @overload
        def fail(self, **params: Unpack["InboundTransfer.FailParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the failed status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        @classmethod
        async def _cls_fail_async(cls, id: str, **params: Unpack["InboundTransfer.FailParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the failed status. The InboundTransfer must already be in the processing state.
            """
            return cast(
        ...
        @overload
        @staticmethod
        async def fail_async(id: str, **params: Unpack["InboundTransfer.FailParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the failed status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        @overload
        async def fail_async(self, **params: Unpack["InboundTransfer.FailParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the failed status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        def _cls_return_inbound_transfer(
            ...
            **params: Unpack["InboundTransfer.ReturnInboundTransferParams"],
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/inbound_transfers/{id}/return".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @classmethod
        def _cls_succeed(cls, id: str, **params: Unpack["InboundTransfer.SucceedParams"]) -> "InboundTransfer":
            """
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/treasury/inbound_transfers/{id}/succeed".format(id=sanitize_id(id)),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        def succeed(id: str, **params: Unpack["InboundTransfer.SucceedParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the succeeded status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        @overload
        def succeed(self, **params: Unpack["InboundTransfer.SucceedParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the succeeded status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        @overload
        @staticmethod
        async def succeed_async(id: str, **params: Unpack["InboundTransfer.SucceedParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the succeeded status. The InboundTransfer must already be in the processing state.
            """
            ...
        ...
        @overload
        async def succeed_async(self, **params: Unpack["InboundTransfer.SucceedParams"]) -> "InboundTransfer":
            """
            Transitions a test mode created InboundTransfer to the succeeded status. The InboundTransfer must already be in the processing state.
            """
            ...
