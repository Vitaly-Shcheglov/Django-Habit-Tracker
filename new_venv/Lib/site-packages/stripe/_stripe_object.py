...
from typing_extensions import TYPE_CHECKING, Literal, Self, Type
...
class StripeObject(Dict[str, Any]):
    ...
    @_util.deprecated("This will be removed in a future version of stripe-python.")
    def request(
        self,
    ...
    @_util.deprecated("Deprecated. The public interface will be removed in a future version.")
    ...
    @_util.deprecated("For internal stripe-python use only. The public interface will be removed in a future version.")
