...
def is_appengine_dev():
    return "APPENGINE_RUNTIME" in os.environ and "Dev" in os.environ.get("SERVER_SOFTWARE", "")
    ...
    if isinstance(resp, list):
        ...
        if isinstance(klass_name, str):
            if api_mode == "V2" and klass_name == "v2.core.event":
                ...
                klass = get_thin_event_classes().get(event_name, stripe.StripeObject)
            else:
                klass = get_object_classes(api_mode).get(klass_name, stripe.StripeObject)
