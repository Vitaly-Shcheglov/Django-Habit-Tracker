...
class Transaction(APIResource["Transaction"]):
    ...
    class CreateReversalParams(RequestOptions):
        ...
        """
        line_items: NotRequired[List["Transaction.CreateReversalParamsLineItem"]]
        """
        ...
        """
        shipping_cost: NotRequired["Transaction.CreateReversalParamsShippingCost"]
        """
    ...
    @classmethod
    def create_from_calculation(cls, **params: Unpack["Transaction.CreateFromCalculationParams"]) -> "Transaction":
        """
    ...
    @classmethod
    def create_reversal(cls, **params: Unpack["Transaction.CreateReversalParams"]) -> "Transaction":
        """
    ...
    @classmethod
    async def create_reversal_async(cls, **params: Unpack["Transaction.CreateReversalParams"]) -> "Transaction":
        """
        Partially or fully reverses a previously created Transaction.
        """
        return cast(
    ...
    def _cls_list_line_items(
        ...
        **params: Unpack["Transaction.ListLineItemsParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/tax/transactions/{transaction}/line_items".format(transaction=sanitize_id(transaction)),
                params=params,
            ),
        )
    ...
    def list_line_items(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "get",
                "/v1/tax/transactions/{transaction}/line_items".format(transaction=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
