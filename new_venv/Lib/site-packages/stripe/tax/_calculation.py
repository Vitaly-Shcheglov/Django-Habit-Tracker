...
class Calculation(CreateableAPIResource["Calculation"]):
    ...
    class CustomerDetails(StripeObject):
        ...
        """
        taxability_override: Literal["customer_exempt", "none", "reverse_charge"]
        """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        customer_details: NotRequired["Calculation.CreateParamsCustomerDetails"]
        """
        ...
        """
        ship_from_details: NotRequired["Calculation.CreateParamsShipFromDetails"]
        """
    ...
    class CreateParamsCustomerDetails(TypedDict):
        ...
        The customer's IP address (IPv4 or IPv6).
        """
        tax_ids: NotRequired[List["Calculation.CreateParamsCustomerDetailsTaxId"]]
        """
        ...
        """
        taxability_override: NotRequired[Literal["customer_exempt", "none", "reverse_charge"]]
        """
    ...
    @classmethod
    def create(cls, **params: Unpack["Calculation.CreateParams"]) -> "Calculation":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Calculation.CreateParams"]) -> "Calculation":
        """
        Calculates tax based on the input and returns a Tax Calculation object.
        """
        return cast(
    ...
    def _cls_list_line_items(
        ...
        **params: Unpack["Calculation.ListLineItemsParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/tax/calculations/{calculation}/line_items".format(calculation=sanitize_id(calculation)),
                params=params,
            ),
        )
    ...
    def list_line_items(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "get",
                "/v1/tax/calculations/{calculation}/line_items".format(calculation=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Calculation.RetrieveParams"]) -> "Calculation":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Calculation.RetrieveParams"]) -> "Calculation":
        """
        Retrieves a Tax Calculation object, if the calculation hasn't expired.
        """
        instance = cls(id, **params)
