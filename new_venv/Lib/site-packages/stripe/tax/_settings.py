...
class Settings(
    ...
    class Defaults(StripeObject):
        tax_behavior: Optional[Literal["exclusive", "inclusive", "inferred_by_currency"]]
        """
    ...
    class ModifyParamsDefaults(TypedDict):
        tax_behavior: NotRequired[Literal["exclusive", "inclusive", "inferred_by_currency"]]
        """
    ...
    @classmethod
    async def modify_async(cls, **params: Unpack["Settings.ModifyParams"]) -> "Settings":
        """
        Updates Tax Settings parameters used in tax calculations. All parameters are editable but none can be removed once set.
        """
        return cast(
    ...
    @classmethod
    def retrieve(cls, **params: Unpack["Settings.RetrieveParams"]) -> "Settings":
        """
    ...
    @classmethod
    async def retrieve_async(cls, **params: Unpack["Settings.RetrieveParams"]) -> "Settings":
        """
        Retrieves Tax Settings for a merchant.
        """
        instance = cls(None, **params)
