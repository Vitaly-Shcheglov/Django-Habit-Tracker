...
class InvoiceItem(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        discounts: NotRequired["Literal['']|List[InvoiceItem.CreateParamsDiscount]"]
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        """
        discounts: NotRequired["Literal['']|List[InvoiceItem.ModifyParamsDiscount]"]
        """
    ...
    @classmethod
    def create(cls, **params: Unpack["InvoiceItem.CreateParams"]) -> "InvoiceItem":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["InvoiceItem.CreateParams"]) -> "InvoiceItem":
        """
        Creates an item to be added to a draft invoice (up to 250 items per invoice). If no invoice is specified, the item will be on the next invoice created for the customer specified.
        """
        return cast(
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["InvoiceItem.DeleteParams"]) -> "InvoiceItem":
        """
    ...
    @overload
    @staticmethod
    def delete(sid: str, **params: Unpack["InvoiceItem.DeleteParams"]) -> "InvoiceItem":
        """
        Deletes an invoice item, removing it from an invoice. Deleting invoice items is only possible when they're not attached to invoices, or if it's attached to a draft invoice.
        """
        ...
    ...
    @overload
    def delete(self, **params: Unpack["InvoiceItem.DeleteParams"]) -> "InvoiceItem":
        """
        Deletes an invoice item, removing it from an invoice. Deleting invoice items is only possible when they're not attached to invoices, or if it's attached to a draft invoice.
        """
        ...
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["InvoiceItem.DeleteParams"]) -> "InvoiceItem":
        """
        Deletes an invoice item, removing it from an invoice. Deleting invoice items is only possible when they're not attached to invoices, or if it's attached to a draft invoice.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["InvoiceItem.DeleteParams"]) -> "InvoiceItem":
        """
        Deletes an invoice item, removing it from an invoice. Deleting invoice items is only possible when they're not attached to invoices, or if it's attached to a draft invoice.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["InvoiceItem.DeleteParams"]) -> "InvoiceItem":
        """
        Deletes an invoice item, removing it from an invoice. Deleting invoice items is only possible when they're not attached to invoices, or if it's attached to a draft invoice.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["InvoiceItem.ListParams"]) -> ListObject["InvoiceItem"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["InvoiceItem.ListParams"]) -> ListObject["InvoiceItem"]:
        """
        Returns a list of your invoice items. Invoice items are returned sorted by creation date, with the most recently created invoice items appearing first.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["InvoiceItem.ModifyParams"]) -> "InvoiceItem":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["InvoiceItem.ModifyParams"]) -> "InvoiceItem":
        """
        Updates the amount or description of an invoice item on an upcoming invoice. Updating an invoice item is only possible before the invoice it's attached to is closed.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["InvoiceItem.RetrieveParams"]) -> "InvoiceItem":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["InvoiceItem.RetrieveParams"]) -> "InvoiceItem":
        """
        Retrieves the invoice item with the given ID.
        """
        instance = cls(id, **params)
