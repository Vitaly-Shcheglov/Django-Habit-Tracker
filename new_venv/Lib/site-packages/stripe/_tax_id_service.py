...
class TaxIdService(StripeService):
    ...
    def create(self, params: "TaxIdService.CreateParams", options: RequestOptions = {}) -> TaxId:
        """
    ...
    async def create_async(self, params: "TaxIdService.CreateParams", options: RequestOptions = {}) -> TaxId:
        """
        Creates a new account or customer tax_id object.
        """
        return cast(
