...
class TaxId(
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["TaxId.CreateParams"]) -> "TaxId":
        """
        Creates a new account or customer tax_id object.
        """
        return cast(
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["TaxId.DeleteParams"]) -> "TaxId":
        """
    ...
    def delete(self, **params: Unpack["TaxId.DeleteParams"]) -> "TaxId":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Deletes an existing account or customer tax_id object.
        """
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["TaxId.DeleteParams"]) -> "TaxId":
        """
        Deletes an existing account or customer tax_id object.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["TaxId.DeleteParams"]) -> "TaxId":
        """
        Deletes an existing account or customer tax_id object.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["TaxId.DeleteParams"]) -> "TaxId":
        """
        Deletes an existing account or customer tax_id object.
        """
        ...
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["TaxId.ListParams"]) -> ListObject["TaxId"]:
        """
        Returns a list of tax IDs.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["TaxId.RetrieveParams"]) -> "TaxId":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["TaxId.RetrieveParams"]) -> "TaxId":
        """
        Retrieves an account or customer tax_id object.
        """
        instance = cls(id, **params)
