...
class CreditNoteService(StripeService):
    ...
    class CreateParams(TypedDict):
        ...
        """
        shipping_cost: NotRequired["CreditNoteService.CreateParamsShippingCost"]
        """
    ...
    class CreateParamsLine(TypedDict):
        ...
        """
        tax_amounts: NotRequired["Literal['']|List[CreditNoteService.CreateParamsLineTaxAmount]"]
        """
    ...
    class PreviewParams(TypedDict):
        ...
        Refunds to link to this credit note.
        """
        shipping_cost: NotRequired["CreditNoteService.PreviewParamsShippingCost"]
        """
        When shipping_cost contains the shipping_rate from the invoice, the shipping_cost is included in the credit note. One of `amount`, `lines`, or `shipping_cost` must be provided.
        """
    ...
    class PreviewParamsLine(TypedDict):
        ...
        The line item quantity to credit.
        """
        tax_amounts: NotRequired["Literal['']|List[CreditNoteService.PreviewParamsLineTaxAmount]"]
        """
        A list of up to 10 tax amounts for the credit note line item. Cannot be mixed with `tax_rates`.
        """
        tax_rates: NotRequired["Literal['']|List[str]"]
