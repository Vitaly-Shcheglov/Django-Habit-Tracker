...
class PaymentMethodDomain(
    ...
    OBJECT_NAME: ClassVar[Literal["payment_method_domain"]] = "payment_method_domain"
    ...
    @classmethod
    def create(cls, **params: Unpack["PaymentMethodDomain.CreateParams"]) -> "PaymentMethodDomain":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["PaymentMethodDomain.CreateParams"]) -> "PaymentMethodDomain":
        """
        Creates a payment method domain.
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["PaymentMethodDomain.ListParams"]) -> ListObject["PaymentMethodDomain"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["PaymentMethodDomain.ListParams"]) -> ListObject["PaymentMethodDomain"]:
        """
        Lists the details of existing payment method domains.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["PaymentMethodDomain.ModifyParams"]) -> "PaymentMethodDomain":
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["PaymentMethodDomain.RetrieveParams"]) -> "PaymentMethodDomain":
        """
    ...
    @overload
    def validate(self, **params: Unpack["PaymentMethodDomain.ValidateParams"]) -> "PaymentMethodDomain":
        """
        Some payment methods might require additional steps to register a domain. If the requirements weren't satisfied when the domain was created, the payment method will be inactive on the domain.
        The payment method doesn't appear in Elements or Embedded Checkout for this domain until it is active.
    ...
    @overload
    async def validate_async(self, **params: Unpack["PaymentMethodDomain.ValidateParams"]) -> "PaymentMethodDomain":
        """
        Some payment methods might require additional steps to register a domain. If the requirements weren't satisfied when the domain was created, the payment method will be inactive on the domain.
        The payment method doesn't appear in Elements or Embedded Checkout for this domain until it is active.
