...
class Refund(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        reason: NotRequired[Literal["duplicate", "fraudulent", "requested_by_customer"]]
        """
    ...
    """
    pending_reason: Optional[Literal["charge_pending", "insufficient_funds", "processing"]]
    """
    ...
    @classmethod
    def _cls_cancel(cls, refund: str, **params: Unpack["Refund.CancelParams"]) -> "Refund":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/refunds/{refund}/cancel".format(refund=sanitize_id(refund)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def cancel(refund: str, **params: Unpack["Refund.CancelParams"]) -> "Refund":
        """
        Cancels a refund with a status of requires_action.
    ...
    def cancel(self, **params: Unpack["Refund.CancelParams"]) -> "Refund":  # pyright: ignore[reportGeneralTypeIssues]
        """
        Cancels a refund with a status of requires_action.
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/refunds/{refund}/cancel".format(refund=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_cancel_async(cls, refund: str, **params: Unpack["Refund.CancelParams"]) -> "Refund":
        """
        Cancels a refund with a status of requires_action.
    ...
    @overload
    @staticmethod
    async def cancel_async(refund: str, **params: Unpack["Refund.CancelParams"]) -> "Refund":
        """
        Cancels a refund with a status of requires_action.
    ...
    @overload
    async def cancel_async(self, **params: Unpack["Refund.CancelParams"]) -> "Refund":
        """
        Cancels a refund with a status of requires_action.
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Refund.CreateParams"]) -> "Refund":
        """
        When you create a new refund, you must specify a Charge or a PaymentIntent object on which to create it.
    ...
    @classmethod
    def list(cls, **params: Unpack["Refund.ListParams"]) -> ListObject["Refund"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Refund.ListParams"]) -> ListObject["Refund"]:
        """
        Returns a list of all refunds you created. We return the refunds in sorted order, with the most recent refunds appearing first. The 10 most recent refunds are always available by default on the Charge object.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Refund.ModifyParams"]) -> "Refund":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Refund.ModifyParams"]) -> "Refund":
        """
        Updates the refund that you specify by setting the values of the passed parameters. Any parameters that you don't provide remain unchanged.
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Refund.RetrieveParams"]) -> "Refund":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Refund.RetrieveParams"]) -> "Refund":
        """
        Retrieves the details of an existing refund.
        """
        instance = cls(id, **params)
    ...
    class TestHelpers(APIResourceTestHelpers["Refund"]):
        ...
        @classmethod
        def _cls_expire(cls, refund: str, **params: Unpack["Refund.ExpireParams"]) -> "Refund":
            """
            ...
            return cast(
                ...
                cls._static_request(
                    "post",
                    "/v1/test_helpers/refunds/{refund}/expire".format(refund=sanitize_id(refund)),
                    params=params,
                ),
            )
        ...
        @overload
        @staticmethod
        def expire(refund: str, **params: Unpack["Refund.ExpireParams"]) -> "Refund":
            """
            Expire a refund with a status of requires_action.
            """
            ...
        ...
        def expire(  # pyright: ignore[reportGeneralTypeIssues]
            ...
            return cast(
                ...
                self.resource._request(
                    "post",
                    "/v1/test_helpers/refunds/{refund}/expire".format(refund=sanitize_id(self.resource.get("id"))),
                    params=params,
                ),
            )

        @classmethod
        async def _cls_expire_async(cls, refund: str, **params: Unpack["Refund.ExpireParams"]) -> "Refund":
            """
            Expire a refund with a status of requires_action.
            """
            return cast(
        ...
        @overload
        @staticmethod
        async def expire_async(refund: str, **params: Unpack["Refund.ExpireParams"]) -> "Refund":
            """
            Expire a refund with a status of requires_action.
            """
            ...
        ...
        @overload
        async def expire_async(self, **params: Unpack["Refund.ExpireParams"]) -> "Refund":
            """
            Expire a refund with a status of requires_action.
            """
            ...
