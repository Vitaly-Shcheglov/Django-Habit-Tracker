...
class ReportRun(
    ...
    OBJECT_NAME: ClassVar[Literal["reporting.report_run"]] = "reporting.report_run"
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["ReportRun.CreateParams"]) -> "ReportRun":
        """
        Creates a new object and begin running the report. (Certain report types require a [live-mode API key](https://stripe.com/docs/keys#test-live-modes).)
        """
        return cast(
    ...
    @classmethod
    def list(cls, **params: Unpack["ReportRun.ListParams"]) -> ListObject["ReportRun"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["ReportRun.ListParams"]) -> ListObject["ReportRun"]:
        """
        Returns a list of Report Runs, with the most recent appearing first.
        """
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["ReportRun.RetrieveParams"]) -> "ReportRun":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["ReportRun.RetrieveParams"]) -> "ReportRun":
        """
        Retrieves the details of an existing Report Run.
        """
        instance = cls(id, **params)
