...
class QuoteService(StripeService):
    def __init__(self, requestor):
        ...
        self.computed_upfront_line_items = QuoteComputedUpfrontLineItemsService(
            self._requestor,
        )
    ...
    class CreateParams(TypedDict):
        ...
        """
        discounts: NotRequired["Literal['']|List[QuoteService.CreateParamsDiscount]"]
        """
        ...
        """
        invoice_settings: NotRequired["QuoteService.CreateParamsInvoiceSettings"]
        """
        ...
        """
        subscription_data: NotRequired["QuoteService.CreateParamsSubscriptionData"]
        """
        ...
        """
        transfer_data: NotRequired["Literal['']|QuoteService.CreateParamsTransferData"]
        """
    ...
    class CreateParamsAutomaticTax(TypedDict):
        ...
        """
        liability: NotRequired["QuoteService.CreateParamsAutomaticTaxLiability"]
        """
    ...
    class CreateParamsLineItem(TypedDict):
        discounts: NotRequired["Literal['']|List[QuoteService.CreateParamsLineItemDiscount]"]
        """
    ...
    class CreateParamsLineItemPriceData(TypedDict):
        ...
        """
        recurring: NotRequired["QuoteService.CreateParamsLineItemPriceDataRecurring"]
        """
    ...
    class CreateParamsSubscriptionData(TypedDict):
        billing_mode: NotRequired["QuoteService.CreateParamsSubscriptionDataBillingMode"]
        """
    ...
    class UpdateParams(TypedDict):
        ...
        """
        discounts: NotRequired["Literal['']|List[QuoteService.UpdateParamsDiscount]"]
        """
        The discounts applied to the quote.
        """
        expand: NotRequired[List[str]]
        ...
        """
        invoice_settings: NotRequired["QuoteService.UpdateParamsInvoiceSettings"]
        """
        All invoices will be billed using the specified settings.
        """
        ...
        The account on behalf of which to charge.
        """
        subscription_data: NotRequired["QuoteService.UpdateParamsSubscriptionData"]
        """
        When creating a subscription or subscription schedule, the specified configuration data will be used. There must be at least one line item with a recurring price for a subscription or subscription schedule to be created. A subscription schedule is created if `subscription_data[effective_date]` is present and in the future, otherwise a subscription is created.
        """
        transfer_data: NotRequired["Literal['']|QuoteService.UpdateParamsTransferData"]
        """
        The data with which to automatically create a Transfer for each of the invoices.
        """
    ...
    class UpdateParamsAutomaticTax(TypedDict):
        ...
        Controls whether Stripe will automatically compute tax on the resulting invoices or subscriptions as well as the quote itself.
        """
        liability: NotRequired["QuoteService.UpdateParamsAutomaticTaxLiability"]
        """
        The account that's liable for tax. If set, the business address and tax registrations required to perform the tax calculation are loaded from this account. The tax transaction is returned in the report of the connected account.
        """
    ...
    class UpdateParamsLineItem(TypedDict):
        discounts: NotRequired["Literal['']|List[QuoteService.UpdateParamsLineItemDiscount]"]
        """
        The discounts applied to this line item.
        """
        id: NotRequired[str]
    ...
    class UpdateParamsLineItemPriceData(TypedDict):
        ...
        The ID of the [Product](https://docs.stripe.com/api/products) that this [Price](https://docs.stripe.com/api/prices) will belong to.
        """
        recurring: NotRequired["QuoteService.UpdateParamsLineItemPriceDataRecurring"]
        """
        The recurring components of a price such as `interval` and `interval_count`.
        """
        tax_behavior: NotRequired[Literal["exclusive", "inclusive", "unspecified"]]
