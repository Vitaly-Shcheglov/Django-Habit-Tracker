...
class Charge(
    ...
    class Outcome(StripeObject):
        ...
        advice_code: Optional[Literal["confirm_card_data", "do_not_try_again", "try_again_later"]]
        """
    ...
    class PaymentMethodDetails(StripeObject):
        ...
        class Card(StripeObject):
            ...
            class ThreeDSecure(StripeObject):
                authentication_flow: Optional[Literal["challenge", "frictionless"]]
                """
                For authenticated transactions: how the customer was authenticated by
                the issuing bank.
                """
                electronic_commerce_indicator: Optional[Literal["01", "02", "05", "06", "07"]]
                """
        ...
        class InteracPresent(StripeObject):
            class Receipt(StripeObject):
                account_type: Optional[Literal["checking", "savings", "unknown"]]
                """
                The type of account being debited or credited
                """
                application_cryptogram: Optional[str]
        ...
        class Konbini(StripeObject):
            class Store(StripeObject):
                chain: Optional[Literal["familymart", "lawson", "ministop", "seicomart"]]
                """
        ...
        class Paypal(StripeObject):
            class SellerProtection(StripeObject):
                dispute_categories: Optional[List[Literal["fraudulent", "product_not_received"]]]
                """
    ...
    """
    failure_balance_transaction: Optional[ExpandableField["BalanceTransaction"]]
    """
    ...
    @classmethod
    def _cls_capture(cls, charge: str, **params: Unpack["Charge.CaptureParams"]) -> "Charge":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/charges/{charge}/capture".format(charge=sanitize_id(charge)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def capture(charge: str, **params: Unpack["Charge.CaptureParams"]) -> "Charge":
        """
        Capture the payment of an existing, uncaptured charge that was created with the capture option set to false.
    ...
    def capture(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/charges/{charge}/capture".format(charge=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_capture_async(cls, charge: str, **params: Unpack["Charge.CaptureParams"]) -> "Charge":
        """
        Capture the payment of an existing, uncaptured charge that was created with the capture option set to false.
    ...
    @overload
    @staticmethod
    async def capture_async(charge: str, **params: Unpack["Charge.CaptureParams"]) -> "Charge":
        """
        Capture the payment of an existing, uncaptured charge that was created with the capture option set to false.
    ...
    @overload
    async def capture_async(self, **params: Unpack["Charge.CaptureParams"]) -> "Charge":
        """
        Capture the payment of an existing, uncaptured charge that was created with the capture option set to false.
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Charge.CreateParams"]) -> "Charge":
        """
        This method is no longer recommended—use the [Payment Intents API](https://docs.stripe.com/docs/api/payment_intents)
        to initiate a new payment instead. Confirmation of the PaymentIntent creates the Charge
        object used to request payment.
    ...
    @classmethod
    def list(cls, **params: Unpack["Charge.ListParams"]) -> ListObject["Charge"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Charge.ListParams"]) -> ListObject["Charge"]:
        """
        Returns a list of charges you've previously created. The charges are returned in sorted order, with the most recent charges appearing first.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Charge.ModifyParams"]) -> "Charge":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Charge.ModifyParams"]) -> "Charge":
        """
        Updates the specified charge by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Charge.RetrieveParams"]) -> "Charge":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Charge.RetrieveParams"]) -> "Charge":
        """
        Retrieves the details of a charge that has previously been created. Supply the unique charge ID that was returned from your previous request, and Stripe will return the corresponding charge information. The same information is returned when creating or refunding the charge.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def search(cls, *args, **kwargs: Unpack["Charge.SearchParams"]) -> SearchResultObject["Charge"]:
        """
    ...
    @classmethod
    async def search_async(cls, *args, **kwargs: Unpack["Charge.SearchParams"]) -> SearchResultObject["Charge"]:
        """
        Search for charges you've previously created using Stripe's [Search Query Language](https://docs.stripe.com/docs/search#search-query-language).
        Don't use search in read-after-write flows where strict consistency is necessary. Under normal operating
        conditions, data is searchable in less than a minute. Occasionally, propagation of new or updated data can be up
        to an hour behind during outages. Search functionality is not available to merchants in India.
        """
        return await cls._search_async(search_url="/v1/charges/search", *args, **kwargs)
    ...
    def retrieve_refund(
        ...
        **params: Unpack["Charge.RetrieveRefundParams"],
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/charges/{charge}/refunds/{refund}".format(charge=sanitize_id(charge), refund=sanitize_id(refund)),
                params=params,
            ),
        )
    ...
    @classmethod
    def list_refunds(cls, charge: str, **params: Unpack["Charge.ListRefundsParams"]) -> ListObject["Refund"]:
        """
        ...
        return cast(
            ...
            cls._static_request(
                "get",
                "/v1/charges/{charge}/refunds".format(charge=sanitize_id(charge)),
                params=params,
            ),
        )
