...
class SubscriptionService(StripeService):
    class CancelParams(TypedDict):
        cancellation_details: NotRequired["SubscriptionService.CancelParamsCancellationDetails"]
        """
    ...
    class CreateParams(TypedDict):
        add_invoice_items: NotRequired[List["SubscriptionService.CreateParamsAddInvoiceItem"]]
        """
        ...
        """
        automatic_tax: NotRequired["SubscriptionService.CreateParamsAutomaticTax"]
        """
        ...
        """
        billing_cycle_anchor_config: NotRequired["SubscriptionService.CreateParamsBillingCycleAnchorConfig"]
        """
        Mutually exclusive with billing_cycle_anchor and only valid with monthly and yearly price intervals. When provided, the billing_cycle_anchor is set to the next occurence of the day_of_month at the hour, minute, and second UTC.
        """
        billing_mode: NotRequired["SubscriptionService.CreateParamsBillingMode"]
        """
        Controls how prorations and invoices for subscriptions are calculated and orchestrated.
        """
        billing_thresholds: NotRequired["Literal['']|SubscriptionService.CreateParamsBillingThresholds"]
        """
        ...
        """
        discounts: NotRequired["Literal['']|List[SubscriptionService.CreateParamsDiscount]"]
        """
        ...
        Specifies which fields in the response should be expanded.
        """
        invoice_settings: NotRequired["SubscriptionService.CreateParamsInvoiceSettings"]
        """
        ...
        """
        payment_settings: NotRequired["SubscriptionService.CreateParamsPaymentSettings"]
        """
        ...
        """
        transfer_data: NotRequired["SubscriptionService.CreateParamsTransferData"]
        """
        ...
        """
        trial_settings: NotRequired["SubscriptionService.CreateParamsTrialSettings"]
        """
    ...
    class CreateParamsAddInvoiceItem(TypedDict):
        ...
        """
        price_data: NotRequired["SubscriptionService.CreateParamsAddInvoiceItemPriceData"]
        """
    ...
    class CreateParamsAutomaticTax(TypedDict):
        ...
        """
        liability: NotRequired["SubscriptionService.CreateParamsAutomaticTaxLiability"]
        """
    ...
    class CreateParamsInvoiceSettings(TypedDict):
        ...
        """
        issuer: NotRequired["SubscriptionService.CreateParamsInvoiceSettingsIssuer"]
        """
    ...
    class CreateParamsItem(TypedDict):
        billing_thresholds: NotRequired["Literal['']|SubscriptionService.CreateParamsItemBillingThresholds"]
        """
        Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. Pass an empty string to remove previously-defined thresholds.
        """
        discounts: NotRequired["Literal['']|List[SubscriptionService.CreateParamsItemDiscount]"]
        """
        ...
        """
        price_data: NotRequired["SubscriptionService.CreateParamsItemPriceData"]
        """
    ...
    class CreateParamsPaymentSettings(TypedDict):
        payment_method_options: NotRequired["SubscriptionService.CreateParamsPaymentSettingsPaymentMethodOptions"]
        """
    ...
    class CreateParamsPaymentSettingsPaymentMethodOptions(TypedDict):
        ...
        """
        card: NotRequired["Literal['']|SubscriptionService.CreateParamsPaymentSettingsPaymentMethodOptionsCard"]
        """
        ...
        """
        konbini: NotRequired["Literal['']|SubscriptionService.CreateParamsPaymentSettingsPaymentMethodOptionsKonbini"]
        """
    ...
    class ListParams(TypedDict):
        automatic_tax: NotRequired["SubscriptionService.ListParamsAutomaticTax"]
        """
        ...
        """
        current_period_end: NotRequired["SubscriptionService.ListParamsCurrentPeriodEnd|int"]
        """
        Only return subscriptions whose current_period_end falls within the given date interval.
        """
        current_period_start: NotRequired["SubscriptionService.ListParamsCurrentPeriodStart|int"]
        """
    ...
    class UpdateParams(TypedDict):
        add_invoice_items: NotRequired[List["SubscriptionService.UpdateParamsAddInvoiceItem"]]
        """
        A list of prices and quantities that will generate invoice items appended to the next invoice for this subscription. You may pass up to 20 items.
        """
        application_fee_percent: NotRequired["Literal['']|float"]
        ...
        A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice total that will be transferred to the application owner's Stripe account. The request must be made by a platform account on a connected account in order to set an application fee percentage. For more information, see the application fees [documentation](https://stripe.com/docs/connect/subscriptions#collecting-fees-on-subscriptions).
        """
        automatic_tax: NotRequired["SubscriptionService.UpdateParamsAutomaticTax"]
        """
        ...
        """
        billing_thresholds: NotRequired["Literal['']|SubscriptionService.UpdateParamsBillingThresholds"]
        """
        Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. When updating, pass an empty string to remove previously-defined thresholds.
        """
        ...
        Indicate whether this subscription should cancel at the end of the current period (`current_period_end`). Defaults to `false`.
        """
        cancellation_details: NotRequired["SubscriptionService.UpdateParamsCancellationDetails"]
        """
        Details about why this subscription was cancelled
        """
        collection_method: NotRequired[Literal["charge_automatically", "send_invoice"]]
        ...
        The subscription's description, meant to be displayable to the customer. Use this field to optionally store an explanation of the subscription for rendering in Stripe surfaces and certain local payment methods UIs.
        """
        discounts: NotRequired["Literal['']|List[SubscriptionService.UpdateParamsDiscount]"]
        """
        The coupons to redeem into discounts for the subscription. If not specified or empty, inherits the discount from the subscription's customer.
        """
        expand: NotRequired[List[str]]
        ...
        Specifies which fields in the response should be expanded.
        """
        invoice_settings: NotRequired["SubscriptionService.UpdateParamsInvoiceSettings"]
        """
        All invoices will be billed using the specified settings.
        """
        ...
        The account on behalf of which to charge, for each of the subscription's invoices.
        """
        pause_collection: NotRequired["Literal['']|SubscriptionService.UpdateParamsPauseCollection"]
        """
        ...
        """
        payment_settings: NotRequired["SubscriptionService.UpdateParamsPaymentSettings"]
        """
        Payment settings to pass to invoices created by the subscription.
        """
        pending_invoice_item_interval: NotRequired[
        ...
        """
        transfer_data: NotRequired["Literal['']|SubscriptionService.UpdateParamsTransferData"]
        """
        ...
        Indicates if a plan's `trial_period_days` should be applied to the subscription. Setting `trial_end` per subscription is preferred, and this defaults to `false`. Setting this flag to `true` together with `trial_end` is not allowed. See [Using trial periods on subscriptions](https://stripe.com/docs/billing/subscriptions/trials) to learn more.
        """
        trial_settings: NotRequired["SubscriptionService.UpdateParamsTrialSettings"]
        """
        Settings related to subscription trials.
        """

    class UpdateParamsAddInvoiceItem(TypedDict):
        discounts: NotRequired[List["SubscriptionService.UpdateParamsAddInvoiceItemDiscount"]]
        """
        The coupons to redeem into discounts for the item.
        """
        price: NotRequired[str]
        ...
        The ID of the price object. One of `price` or `price_data` is required.
        """
        price_data: NotRequired["SubscriptionService.UpdateParamsAddInvoiceItemPriceData"]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline. One of `price` or `price_data` is required.
        """
        quantity: NotRequired[int]
    ...
    class UpdateParamsAutomaticTax(TypedDict):
        ...
        Enabled automatic tax calculation which will automatically compute tax rates on all invoices generated by the subscription.
        """
        liability: NotRequired["SubscriptionService.UpdateParamsAutomaticTaxLiability"]
        """
        The account that's liable for tax. If set, the business address and tax registrations required to perform the tax calculation are loaded from this account. The tax transaction is returned in the report of the connected account.
        """
    ...
    class UpdateParamsInvoiceSettings(TypedDict):
        ...
        The account tax IDs associated with the subscription. Will be set on invoices generated by the subscription.
        """
        issuer: NotRequired["SubscriptionService.UpdateParamsInvoiceSettingsIssuer"]
        """
        The connected account that issues the invoice. The invoice is presented with the branding and support information of the specified account.
        """
    ...
    class UpdateParamsItem(TypedDict):
        billing_thresholds: NotRequired["Literal['']|SubscriptionService.UpdateParamsItemBillingThresholds"]
        """
        Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. Pass an empty string to remove previously-defined thresholds.
        """
        ...
        """
        discounts: NotRequired["Literal['']|List[SubscriptionService.UpdateParamsItemDiscount]"]
        """
        The coupons to redeem into discounts for the subscription item.
        """
        id: NotRequired[str]
        ...
        """
        price_data: NotRequired["SubscriptionService.UpdateParamsItemPriceData"]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline. One of `price` or `price_data` is required.
        """
        quantity: NotRequired[int]
    ...
    class UpdateParamsPaymentSettings(TypedDict):
        payment_method_options: NotRequired["SubscriptionService.UpdateParamsPaymentSettingsPaymentMethodOptions"]
        """
        Payment-method-specific configuration to provide to invoices created by the subscription.
        """
        payment_method_types: NotRequired[
    ...
    class UpdateParamsPaymentSettingsPaymentMethodOptions(TypedDict):
        ...
        This sub-hash contains details about the Bancontact payment method options to pass to the invoice's PaymentIntent.
        """
        card: NotRequired["Literal['']|SubscriptionService.UpdateParamsPaymentSettingsPaymentMethodOptionsCard"]
        """
        This sub-hash contains details about the Card payment method options to pass to the invoice's PaymentIntent.
        """
        customer_balance: NotRequired[
        ...
        This sub-hash contains details about the Bank transfer payment method options to pass to the invoice's PaymentIntent.
        """
        konbini: NotRequired["Literal['']|SubscriptionService.UpdateParamsPaymentSettingsPaymentMethodOptionsKonbini"]
        """
        This sub-hash contains details about the Konbini payment method options to pass to the invoice's PaymentIntent.
        """
        sepa_debit: NotRequired[
