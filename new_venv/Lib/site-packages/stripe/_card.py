...
from typing_extensions import TYPE_CHECKING, Literal, Unpack
...
class Card(DeletableAPIResource["Card"], UpdateableAPIResource["Card"]):
    ...
    *As of May 1, 2021, card fingerprint in India for Connect changed to allow two fingerprints for the same card---one for India and one for the rest of the world.*
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["Card.DeleteParams"]) -> Union["BankAccount", "Card"]:
        """
    ...
    @overload
    @staticmethod
    def delete(sid: str, **params: Unpack["Card.DeleteParams"]) -> Union["BankAccount", "Card"]:
        """
        Delete a specified external account for a given account.
        """
        ...
    ...
    @overload
    def delete(self, **params: Unpack["Card.DeleteParams"]) -> Union["BankAccount", "Card"]:
        """
        Delete a specified external account for a given account.
        """
        ...
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["Card.DeleteParams"]) -> Union["BankAccount", "Card"]:
        """
        Delete a specified external account for a given account.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["Card.DeleteParams"]) -> Union["BankAccount", "Card"]:
        """
        Delete a specified external account for a given account.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["Card.DeleteParams"]) -> Union["BankAccount", "Card"]:
        """
        Delete a specified external account for a given account.
        """
        ...
    ...
    def instance_url(self):
        ...
        if hasattr(self, "customer"):
            ...
            raise InvalidRequestError(
                "Could not determine whether card_id %s is " "attached to a customer, or " "account." % token,
                "id",
            )
