...
class Coupon(
    ...
    class CreateParams(RequestOptions):
        ...
        """
        currency_options: NotRequired[Dict[str, "Coupon.CreateParamsCurrencyOptions"]]
        """
    ...
    class ModifyParams(RequestOptions):
        currency_options: NotRequired[Dict[str, "Coupon.ModifyParamsCurrencyOptions"]]
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Coupon.CreateParams"]) -> "Coupon":
        """
        You can create coupons easily via the [coupon management](https://dashboard.stripe.com/coupons) page of the Stripe dashboard. Coupon creation is also accessible via the API if you need to create coupons on the fly.
    ...
    @classmethod
    def _cls_delete(cls, sid: str, **params: Unpack["Coupon.DeleteParams"]) -> "Coupon":
        """
    ...
    def delete(self, **params: Unpack["Coupon.DeleteParams"]) -> "Coupon":  # pyright: ignore[reportGeneralTypeIssues]
        """
        You can delete coupons via the [coupon management](https://dashboard.stripe.com/coupons) page of the Stripe dashboard. However, deleting a coupon does not affect any customers who have already applied the coupon; it means that new customers can't redeem the coupon. You can also delete coupons via the API.
        """
    ...
    @classmethod
    async def _cls_delete_async(cls, sid: str, **params: Unpack["Coupon.DeleteParams"]) -> "Coupon":
        """
        You can delete coupons via the [coupon management](https://dashboard.stripe.com/coupons) page of the Stripe dashboard. However, deleting a coupon does not affect any customers who have already applied the coupon; it means that new customers can't redeem the coupon. You can also delete coupons via the API.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(sid))
    ...
    @overload
    @staticmethod
    async def delete_async(sid: str, **params: Unpack["Coupon.DeleteParams"]) -> "Coupon":
        """
        You can delete coupons via the [coupon management](https://dashboard.stripe.com/coupons) page of the Stripe dashboard. However, deleting a coupon does not affect any customers who have already applied the coupon; it means that new customers can't redeem the coupon. You can also delete coupons via the API.
        """
        ...
    ...
    @overload
    async def delete_async(self, **params: Unpack["Coupon.DeleteParams"]) -> "Coupon":
        """
        You can delete coupons via the [coupon management](https://dashboard.stripe.com/coupons) page of the Stripe dashboard. However, deleting a coupon does not affect any customers who have already applied the coupon; it means that new customers can't redeem the coupon. You can also delete coupons via the API.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["Coupon.ListParams"]) -> ListObject["Coupon"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Coupon.ListParams"]) -> ListObject["Coupon"]:
        """
        Returns a list of your coupons.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Coupon.ModifyParams"]) -> "Coupon":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Coupon.ModifyParams"]) -> "Coupon":
        """
        Updates the metadata of a coupon. Other coupon details (currency, duration, amount_off) are, by design, not editable.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Coupon.RetrieveParams"]) -> "Coupon":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Coupon.RetrieveParams"]) -> "Coupon":
        """
        Retrieves the coupon with the given ID.
        """
        instance = cls(id, **params)
