...
class OAuth(object):
    ...
    @staticmethod
    def authorize_url(express: bool = False, **params: Unpack[OAuthAuthorizeUrlParams]) -> str:
        if express is False:
    ...
    @staticmethod
    def token(api_key: Optional[str] = None, **params: Unpack[OAuthTokenParams]) -> OAuthToken:
    ...
    @staticmethod
    def deauthorize(api_key: Optional[str] = None, **params: Unpack[OAuthDeauthorizeParams]) -> OAuthDeauthorization:
        options: RequestOptions = {"api_key": api_key}
        requestor = _APIRequestor._global_instance()
        OAuth._set_client_id(params)
        return cast(
