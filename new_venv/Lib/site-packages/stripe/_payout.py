...
class Payout(
    ...
    @classmethod
    def _cls_cancel(cls, payout: str, **params: Unpack["Payout.CancelParams"]) -> "Payout":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/payouts/{payout}/cancel".format(payout=sanitize_id(payout)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def cancel(payout: str, **params: Unpack["Payout.CancelParams"]) -> "Payout":
        """
        You can cancel a previously created payout if its status is pending. Stripe refunds the funds to your available balance. You can't cancel automatic Stripe payouts.
        """
        ...
    ...
    def cancel(self, **params: Unpack["Payout.CancelParams"]) -> "Payout":  # pyright: ignore[reportGeneralTypeIssues]
        """
        You can cancel a previously created payout if its status is pending. Stripe refunds the funds to your available balance. You can't cancel automatic Stripe payouts.
        """
        return cast(
            ...
            self._request(
                "post",
                "/v1/payouts/{payout}/cancel".format(payout=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_cancel_async(cls, payout: str, **params: Unpack["Payout.CancelParams"]) -> "Payout":
        """
        You can cancel a previously created payout if its status is pending. Stripe refunds the funds to your available balance. You can't cancel automatic Stripe payouts.
        """
        return cast(
    ...
    @overload
    @staticmethod
    async def cancel_async(payout: str, **params: Unpack["Payout.CancelParams"]) -> "Payout":
        """
        You can cancel a previously created payout if its status is pending. Stripe refunds the funds to your available balance. You can't cancel automatic Stripe payouts.
        """
        ...
    ...
    @overload
    async def cancel_async(self, **params: Unpack["Payout.CancelParams"]) -> "Payout":
        """
        You can cancel a previously created payout if its status is pending. Stripe refunds the funds to your available balance. You can't cancel automatic Stripe payouts.
        """
        ...
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Payout.CreateParams"]) -> "Payout":
        """
        To send funds to your own bank account, create a new payout object. Your [Stripe balance](https://docs.stripe.com/api#balance) must cover the payout amount. If it doesn't, you receive an “Insufficient Funds” error.
    ...
    @classmethod
    def list(cls, **params: Unpack["Payout.ListParams"]) -> ListObject["Payout"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Payout.ListParams"]) -> ListObject["Payout"]:
        """
        Returns a list of existing payouts sent to third-party bank accounts or payouts that Stripe sent to you. The payouts return in sorted order, with the most recently created payouts appearing first.
        """
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Payout.ModifyParams"]) -> "Payout":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Payout.ModifyParams"]) -> "Payout":
        """
        Updates the specified payout by setting the values of the parameters you pass. We don't change parameters that you don't provide. This request only accepts the metadata as arguments.
        """
        url = "%s/%s" % (cls.class_url(), sanitize_id(id))
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Payout.RetrieveParams"]) -> "Payout":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Payout.RetrieveParams"]) -> "Payout":
        """
        Retrieves the details of an existing payout. Supply the unique payout ID from either a payout creation request or the payout list. Stripe returns the corresponding payout information.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def _cls_reverse(cls, payout: str, **params: Unpack["Payout.ReverseParams"]) -> "Payout":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/payouts/{payout}/reverse".format(payout=sanitize_id(payout)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def reverse(payout: str, **params: Unpack["Payout.ReverseParams"]) -> "Payout":
        """
        Reverses a payout by debiting the destination bank account. At this time, you can only reverse payouts for connected accounts to US bank accounts. If the payout is manual and in the pending status, use /v1/payouts/:id/cancel instead.
    ...
    def reverse(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/payouts/{payout}/reverse".format(payout=sanitize_id(self.get("id"))),
                params=params,
            ),
        )

    @classmethod
    async def _cls_reverse_async(cls, payout: str, **params: Unpack["Payout.ReverseParams"]) -> "Payout":
        """
        Reverses a payout by debiting the destination bank account. At this time, you can only reverse payouts for connected accounts to US bank accounts. If the payout is manual and in the pending status, use /v1/payouts/:id/cancel instead.
    ...
    @overload
    @staticmethod
    async def reverse_async(payout: str, **params: Unpack["Payout.ReverseParams"]) -> "Payout":
        """
        Reverses a payout by debiting the destination bank account. At this time, you can only reverse payouts for connected accounts to US bank accounts. If the payout is manual and in the pending status, use /v1/payouts/:id/cancel instead.
    ...
    @overload
    async def reverse_async(self, **params: Unpack["Payout.ReverseParams"]) -> "Payout":
        """
        Reverses a payout by debiting the destination bank account. At this time, you can only reverse payouts for connected accounts to US bank accounts. If the payout is manual and in the pending status, use /v1/payouts/:id/cancel instead.
