        ...
        if http_body:
            ...
            if hasattr(http_body, "decode"):
                try:
                    ...
                    body = "<Could not decode body as utf-8. " "Please report to support@stripe.com>"
...
class APIConnectionError(StripeError):
    ...
    def __init__(
        ...
        super(APIConnectionError, self).__init__(message, http_body, http_status, json_body, headers, code)
...
class CardError(StripeErrorWithParamCode):
    def __init__(
        ...
        super(CardError, self).__init__(message, http_body, http_status, json_body, headers, code)
        self.param = param
...
class InvalidRequestError(StripeErrorWithParamCode):
    def __init__(
        ...
        super(InvalidRequestError, self).__init__(message, http_body, http_status, json_body, headers, code)
        self.param = param
