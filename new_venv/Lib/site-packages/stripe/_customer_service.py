...
class CustomerService(StripeService):
    ...
    class CreateParams(TypedDict):
        ...
        """
        invoice_settings: NotRequired["CustomerService.CreateParamsInvoiceSettings"]
        """
        ...
        """
        shipping: NotRequired["Literal['']|CustomerService.CreateParamsShipping"]
        """
        ...
        """
        tax_id_data: NotRequired[List["CustomerService.CreateParamsTaxIdDatum"]]
        """
    ...
    class CreateParamsCashBalance(TypedDict):
        settings: NotRequired["CustomerService.CreateParamsCashBalanceSettings"]
        """
    ...
    class CreateParamsInvoiceSettings(TypedDict):
        custom_fields: NotRequired["Literal['']|List[CustomerService.CreateParamsInvoiceSettingsCustomField]"]
        """
        ...
        """
        rendering_options: NotRequired["Literal['']|CustomerService.CreateParamsInvoiceSettingsRenderingOptions"]
        """
    ...
    class UpdateParams(TypedDict):
        ...
        The prefix for the customer used to generate unique invoice numbers. Must be 3–12 uppercase letters or numbers.
        """
        invoice_settings: NotRequired["CustomerService.UpdateParamsInvoiceSettings"]
        """
        Default invoice settings for this customer.
        """
        metadata: NotRequired["Literal['']|Dict[str, str]"]
        ...
        Customer's preferred languages, ordered by preference.
        """
        shipping: NotRequired["Literal['']|CustomerService.UpdateParamsShipping"]
        """
        The customer's shipping information. Appears on invoices emailed to this customer.
        """
        source: NotRequired[str]
    ...
    class UpdateParamsCashBalance(TypedDict):
        settings: NotRequired["CustomerService.UpdateParamsCashBalanceSettings"]
        """
        Settings controlling the behavior of the customer's cash balance,
        such as reconciliation of funds received.
        """
    ...
    class UpdateParamsInvoiceSettings(TypedDict):
        custom_fields: NotRequired["Literal['']|List[CustomerService.UpdateParamsInvoiceSettingsCustomField]"]
        """
        The list of up to 4 default custom fields to be displayed on invoices for this customer. When updating, pass an empty string to remove previously-defined fields.
        """
        default_payment_method: NotRequired[str]
        ...
        Default footer to be displayed on invoices for this customer.
        """
        rendering_options: NotRequired["Literal['']|CustomerService.UpdateParamsInvoiceSettingsRenderingOptions"]
        """
        Default options for invoice PDF rendering for this customer.
        """
