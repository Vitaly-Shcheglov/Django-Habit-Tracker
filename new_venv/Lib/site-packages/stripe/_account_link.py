...
class AccountLink(CreateableAPIResource["AccountLink"]):
    ...
    class CreateParams(RequestOptions):
        ...
        """
        collection_options: NotRequired["AccountLink.CreateParamsCollectionOptions"]
        """
    ...
    @classmethod
    def create(cls, **params: Unpack["AccountLink.CreateParams"]) -> "AccountLink":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["AccountLink.CreateParams"]) -> "AccountLink":
        """
        Creates an AccountLink object that includes a single-use Stripe URL that the platform can redirect their user to in order to take them through the Connect Onboarding flow.
        """
        return cast(
