...
class Subscription(
    ...
    class CancellationDetails(StripeObject):
        ...
        """
        reason: Optional[Literal["cancellation_requested", "payment_disputed", "payment_failed"]]
        """
    ...
    class PaymentSettings(StripeObject):
        ...
        """
        save_default_payment_method: Optional[Literal["off", "on_subscription"]]
        """
    ...
    class CancelParams(RequestOptions):
        cancellation_details: NotRequired["Subscription.CancelParamsCancellationDetails"]
        """
    ...
    class CreateParams(RequestOptions):
        add_invoice_items: NotRequired[List["Subscription.CreateParamsAddInvoiceItem"]]
        """
        ...
        """
        billing_cycle_anchor_config: NotRequired["Subscription.CreateParamsBillingCycleAnchorConfig"]
        """
        ...
        Controls how prorations and invoices for subscriptions are calculated and orchestrated.
        """
        billing_thresholds: NotRequired["Literal['']|Subscription.CreateParamsBillingThresholds"]
        """
        ...
        """
        discounts: NotRequired["Literal['']|List[Subscription.CreateParamsDiscount]"]
        """
        ...
        Specifies which fields in the response should be expanded.
        """
        invoice_settings: NotRequired["Subscription.CreateParamsInvoiceSettings"]
        """
        ...
        """
        payment_settings: NotRequired["Subscription.CreateParamsPaymentSettings"]
        """
        Payment settings to pass to invoices created by the subscription.
        """
        pending_invoice_item_interval: NotRequired["Literal['']|Subscription.CreateParamsPendingInvoiceItemInterval"]
        """
    ...
    class CreateParamsAddInvoiceItem(TypedDict):
        discounts: NotRequired[List["Subscription.CreateParamsAddInvoiceItemDiscount"]]
        """
        ...
        """
        price_data: NotRequired["Subscription.CreateParamsAddInvoiceItemPriceData"]
        """
    ...
    class CreateParamsAutomaticTax(TypedDict):
        ...
        """
        liability: NotRequired["Subscription.CreateParamsAutomaticTaxLiability"]
        """
        The account that's liable for tax. If set, the business address and tax registrations required to perform the tax calculation are loaded from this account. The tax transaction is returned in the report of the connected account.
        """
    ...
    class CreateParamsItem(TypedDict):
        billing_thresholds: NotRequired["Literal['']|Subscription.CreateParamsItemBillingThresholds"]
        """
        Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. Pass an empty string to remove previously-defined thresholds.
        """
        discounts: NotRequired["Literal['']|List[Subscription.CreateParamsItemDiscount]"]
        """
    ...
    class CreateParamsPaymentSettings(TypedDict):
        payment_method_options: NotRequired["Subscription.CreateParamsPaymentSettingsPaymentMethodOptions"]
        """
        Payment-method-specific configuration to provide to invoices created by the subscription.
        """
    ...
    class CreateParamsPaymentSettingsPaymentMethodOptions(TypedDict):
        acss_debit: NotRequired["Literal['']|Subscription.CreateParamsPaymentSettingsPaymentMethodOptionsAcssDebit"]
        """
        This sub-hash contains details about the Canadian pre-authorized debit payment method options to pass to the invoice's PaymentIntent.
        """
        bancontact: NotRequired["Literal['']|Subscription.CreateParamsPaymentSettingsPaymentMethodOptionsBancontact"]
        """
        ...
        """
        konbini: NotRequired["Literal['']|Subscription.CreateParamsPaymentSettingsPaymentMethodOptionsKonbini"]
        """
        This sub-hash contains details about the Konbini payment method options to pass to the invoice's PaymentIntent.
        """
        sepa_debit: NotRequired["Literal['']|Subscription.CreateParamsPaymentSettingsPaymentMethodOptionsSepaDebit"]
        """
    ...
    class CreateParamsPaymentSettingsPaymentMethodOptionsCard(TypedDict):
        mandate_options: NotRequired["Subscription.CreateParamsPaymentSettingsPaymentMethodOptionsCardMandateOptions"]
        """
    ...
    class ListParams(RequestOptions):
        ...
        """
        current_period_end: NotRequired["Subscription.ListParamsCurrentPeriodEnd|int"]
        """
        Only return subscriptions whose current_period_end falls within the given date interval.
        """
        current_period_start: NotRequired["Subscription.ListParamsCurrentPeriodStart|int"]
        """
    ...
    class ModifyParams(RequestOptions):
        add_invoice_items: NotRequired[List["Subscription.ModifyParamsAddInvoiceItem"]]
        """
        A list of prices and quantities that will generate invoice items appended to the next invoice for this subscription. You may pass up to 20 items.
        """
        application_fee_percent: NotRequired["Literal['']|float"]
        ...
        """
        billing_thresholds: NotRequired["Literal['']|Subscription.ModifyParamsBillingThresholds"]
        """
        Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. When updating, pass an empty string to remove previously-defined thresholds.
        """
        ...
        Indicate whether this subscription should cancel at the end of the current period (`current_period_end`). Defaults to `false`.
        """
        cancellation_details: NotRequired["Subscription.ModifyParamsCancellationDetails"]
        """
        Details about why this subscription was cancelled
        """
        collection_method: NotRequired[Literal["charge_automatically", "send_invoice"]]
        ...
        The subscription's description, meant to be displayable to the customer. Use this field to optionally store an explanation of the subscription for rendering in Stripe surfaces and certain local payment methods UIs.
        """
        discounts: NotRequired["Literal['']|List[Subscription.ModifyParamsDiscount]"]
        """
        The coupons to redeem into discounts for the subscription. If not specified or empty, inherits the discount from the subscription's customer.
        """
        expand: NotRequired[List[str]]
        ...
        Specifies which fields in the response should be expanded.
        """
        invoice_settings: NotRequired["Subscription.ModifyParamsInvoiceSettings"]
        """
        All invoices will be billed using the specified settings.
        """
        ...
        The account on behalf of which to charge, for each of the subscription's invoices.
        """
        pause_collection: NotRequired["Literal['']|Subscription.ModifyParamsPauseCollection"]
        """
        ...
        """
        payment_settings: NotRequired["Subscription.ModifyParamsPaymentSettings"]
        """
        Payment settings to pass to invoices created by the subscription.
        """
        pending_invoice_item_interval: NotRequired["Literal['']|Subscription.ModifyParamsPendingInvoiceItemInterval"]
        """
        Specifies an interval for how often to bill for any pending invoice items. It is analogous to calling [Create an invoice](https://stripe.com/docs/api#create_invoice) for the given subscription at the specified interval.
        """
        proration_behavior: NotRequired[Literal["always_invoice", "create_prorations", "none"]]
        ...
        """
        transfer_data: NotRequired["Literal['']|Subscription.ModifyParamsTransferData"]
        """
    ...
    class ModifyParamsAddInvoiceItem(TypedDict):
        discounts: NotRequired[List["Subscription.ModifyParamsAddInvoiceItemDiscount"]]
        """
        The coupons to redeem into discounts for the item.
        """
        price: NotRequired[str]
        ...
        The ID of the price object. One of `price` or `price_data` is required.
        """
        price_data: NotRequired["Subscription.ModifyParamsAddInvoiceItemPriceData"]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline. One of `price` or `price_data` is required.
        """
        quantity: NotRequired[int]
    ...
    class ModifyParamsAutomaticTax(TypedDict):
        ...
        Enabled automatic tax calculation which will automatically compute tax rates on all invoices generated by the subscription.
        """
        liability: NotRequired["Subscription.ModifyParamsAutomaticTaxLiability"]
        """
        The account that's liable for tax. If set, the business address and tax registrations required to perform the tax calculation are loaded from this account. The tax transaction is returned in the report of the connected account.
        """
    ...
    class ModifyParamsItem(TypedDict):
        billing_thresholds: NotRequired["Literal['']|Subscription.ModifyParamsItemBillingThresholds"]
        """
        Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. Pass an empty string to remove previously-defined thresholds.
        """
        ...
        """
        discounts: NotRequired["Literal['']|List[Subscription.ModifyParamsItemDiscount]"]
        """
        The coupons to redeem into discounts for the subscription item.
        """
        id: NotRequired[str]
    ...
    class ModifyParamsPaymentSettings(TypedDict):
        payment_method_options: NotRequired["Subscription.ModifyParamsPaymentSettingsPaymentMethodOptions"]
        """
        Payment-method-specific configuration to provide to invoices created by the subscription.
        """
        payment_method_types: NotRequired[
    ...
    class ModifyParamsPaymentSettingsPaymentMethodOptions(TypedDict):
        acss_debit: NotRequired["Literal['']|Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsAcssDebit"]
        """
        This sub-hash contains details about the Canadian pre-authorized debit payment method options to pass to the invoice's PaymentIntent.
        """
        bancontact: NotRequired["Literal['']|Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsBancontact"]
        """
        This sub-hash contains details about the Bancontact payment method options to pass to the invoice's PaymentIntent.
        """
        card: NotRequired["Literal['']|Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsCard"]
        """
        This sub-hash contains details about the Card payment method options to pass to the invoice's PaymentIntent.
        """
        customer_balance: NotRequired[
        ...
        This sub-hash contains details about the Bank transfer payment method options to pass to the invoice's PaymentIntent.
        """
        konbini: NotRequired["Literal['']|Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsKonbini"]
        """
        This sub-hash contains details about the Konbini payment method options to pass to the invoice's PaymentIntent.
        """
        sepa_debit: NotRequired["Literal['']|Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsSepaDebit"]
        """
        This sub-hash contains details about the SEPA Direct Debit payment method options to pass to the invoice's PaymentIntent.
        """
        us_bank_account: NotRequired[
    ...
    class ModifyParamsPaymentSettingsPaymentMethodOptionsCard(TypedDict):
        mandate_options: NotRequired["Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsCardMandateOptions"]
        """
        Configuration options for setting up an eMandate for cards issued in India.
        """
        network: NotRequired[
        ...
        return cast(
            ...
            cls._static_request(
                ...
                "/v1/subscriptions/{subscription_exposed_id}".format(
                    subscription_exposed_id=sanitize_id(subscription_exposed_id)
                ),
                params=params,
            ),
        )
    ...
    @overload
    def cancel(self, **params: Unpack["Subscription.CancelParams"]) -> "Subscription":
        """
        Cancels a customer's subscription immediately. The customer won't be charged again for the subscription. After it's canceled, you can no longer update the subscription or its [metadata](https://docs.stripe.com/metadata).
    ...
    @overload
    async def cancel_async(self, **params: Unpack["Subscription.CancelParams"]) -> "Subscription":
        """
        Cancels a customer's subscription immediately. The customer won't be charged again for the subscription. After it's canceled, you can no longer update the subscription or its [metadata](https://docs.stripe.com/metadata).
    ...
    @classmethod
    def create(cls, **params: Unpack["Subscription.CreateParams"]) -> "Subscription":
        """
    ...
    @classmethod
    async def create_async(cls, **params: Unpack["Subscription.CreateParams"]) -> "Subscription":
        """
        Creates a new subscription on an existing customer. Each customer can have up to 500 active or scheduled subscriptions.
    ...
    @overload
    def delete_discount(self, **params: Unpack["Subscription.DeleteDiscountParams"]) -> "Discount":
        """
        Removes the currently applied discount on a subscription.
        """
        ...
    ...
    @overload
    async def delete_discount_async(self, **params: Unpack["Subscription.DeleteDiscountParams"]) -> "Discount":
        """
        Removes the currently applied discount on a subscription.
        """
        ...
    ...
    @classmethod
    def list(cls, **params: Unpack["Subscription.ListParams"]) -> ListObject["Subscription"]:
        """
    ...
    @classmethod
    async def list_async(cls, **params: Unpack["Subscription.ListParams"]) -> ListObject["Subscription"]:
        """
        By default, returns a list of subscriptions that have not been canceled. In order to list canceled subscriptions, specify status=canceled.
        """
    ...
    @classmethod
    def _cls_migrate(cls, subscription: str, **params: Unpack["Subscription.MigrateParams"]) -> "Subscription":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/subscriptions/{subscription}/migrate".format(subscription=sanitize_id(subscription)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def migrate(subscription: str, **params: Unpack["Subscription.MigrateParams"]) -> "Subscription":
        """
        Upgrade the billing_mode of an existing subscription.
        """
        ...
    ...
    @overload
    def migrate(self, **params: Unpack["Subscription.MigrateParams"]) -> "Subscription":
        """
        Upgrade the billing_mode of an existing subscription.
        """
        ...
    ...
    def migrate(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/subscriptions/{subscription}/migrate".format(subscription=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def migrate_async(subscription: str, **params: Unpack["Subscription.MigrateParams"]) -> "Subscription":
        """
        Upgrade the billing_mode of an existing subscription.
        """
        ...
    ...
    @overload
    async def migrate_async(self, **params: Unpack["Subscription.MigrateParams"]) -> "Subscription":
        """
        Upgrade the billing_mode of an existing subscription.
        """
        ...
    ...
    @classmethod
    def modify(cls, id: str, **params: Unpack["Subscription.ModifyParams"]) -> "Subscription":
        """
    ...
    @classmethod
    async def modify_async(cls, id: str, **params: Unpack["Subscription.ModifyParams"]) -> "Subscription":
        """
        Updates an existing subscription to match the specified parameters.
        When changing prices or quantities, we optionally prorate the price we charge next month to make up for any price changes.
        To preview how the proration is calculated, use the [create preview](https://docs.stripe.com/docs/api/invoices/create_preview) endpoint.
    ...
    @classmethod
    def _cls_resume(cls, subscription: str, **params: Unpack["Subscription.ResumeParams"]) -> "Subscription":
        """
        ...
        return cast(
            ...
            cls._static_request(
                "post",
                "/v1/subscriptions/{subscription}/resume".format(subscription=sanitize_id(subscription)),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    def resume(subscription: str, **params: Unpack["Subscription.ResumeParams"]) -> "Subscription":
        """
        Initiates resumption of a paused subscription, optionally resetting the billing cycle anchor and creating prorations. If a resumption invoice is generated, it must be paid or marked uncollectible before the subscription will be unpaused. If payment succeeds the subscription will become active, and if payment fails the subscription will be past_due. The resumption invoice will void automatically if not paid by the expiration date.
        """
        ...
    ...
    @overload
    def resume(self, **params: Unpack["Subscription.ResumeParams"]) -> "Subscription":
        """
        Initiates resumption of a paused subscription, optionally resetting the billing cycle anchor and creating prorations. If a resumption invoice is generated, it must be paid or marked uncollectible before the subscription will be unpaused. If payment succeeds the subscription will become active, and if payment fails the subscription will be past_due. The resumption invoice will void automatically if not paid by the expiration date.
        """
        ...
    ...
    def resume(  # pyright: ignore[reportGeneralTypeIssues]
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v1/subscriptions/{subscription}/resume".format(subscription=sanitize_id(self.get("id"))),
                params=params,
            ),
        )
    ...
    @overload
    @staticmethod
    async def resume_async(subscription: str, **params: Unpack["Subscription.ResumeParams"]) -> "Subscription":
        """
        Initiates resumption of a paused subscription, optionally resetting the billing cycle anchor and creating prorations. If a resumption invoice is generated, it must be paid or marked uncollectible before the subscription will be unpaused. If payment succeeds the subscription will become active, and if payment fails the subscription will be past_due. The resumption invoice will void automatically if not paid by the expiration date.
        """
        ...
    ...
    @overload
    async def resume_async(self, **params: Unpack["Subscription.ResumeParams"]) -> "Subscription":
        """
        Initiates resumption of a paused subscription, optionally resetting the billing cycle anchor and creating prorations. If a resumption invoice is generated, it must be paid or marked uncollectible before the subscription will be unpaused. If payment succeeds the subscription will become active, and if payment fails the subscription will be past_due. The resumption invoice will void automatically if not paid by the expiration date.
        """
        ...
    ...
    @classmethod
    def retrieve(cls, id: str, **params: Unpack["Subscription.RetrieveParams"]) -> "Subscription":
        """
    ...
    @classmethod
    async def retrieve_async(cls, id: str, **params: Unpack["Subscription.RetrieveParams"]) -> "Subscription":
        """
        Retrieves the subscription with the given ID.
        """
        instance = cls(id, **params)
    ...
    @classmethod
    def search(cls, *args, **kwargs: Unpack["Subscription.SearchParams"]) -> SearchResultObject["Subscription"]:
        """
    ...
    async def search_async(
        ...
        to an hour behind during outages. Search functionality is not available to merchants in India.
        """
        return await cls._search_async(search_url="/v1/subscriptions/search", *args, **kwargs)

    @classmethod
    def search_auto_paging_iter(cls, *args, **kwargs: Unpack["Subscription.SearchParams"]) -> Iterator["Subscription"]:
