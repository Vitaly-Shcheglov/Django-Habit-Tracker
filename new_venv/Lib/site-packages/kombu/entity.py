...
class Exchange(MaybeChannelBound):
    ...
    def bind_to(self, exchange="", routing_key="", arguments=None, nowait=False, channel=None, **kwargs):
    ...
    def unbind_from(self, source="", routing_key="", nowait=False, arguments=None, channel=None):
    ...
    def publish(self, message, routing_key=None, mandatory=False, immediate=False, exchange=None):
        """Publish message.
    ...
    def delete(self, if_unused=False, nowait=False):
        ...
        ---------
            ...
            nowait (bool): If set the server will not respond, and a
                response will not be waited for. Default is :const:`False`.
        """
        return self.channel.exchange_delete(exchange=self.name, if_unused=if_unused, nowait=nowait)
...
class Queue(MaybeChannelBound):
    ...
    def __init__(
        self, name="", exchange=None, routing_key="", channel=None, bindings=None, on_declared=None, **kwargs
    ):
        super().__init__(**kwargs)
        self.name = name or self.name
    ...
    def queue_bind(self, nowait=False, channel=None):
        ...
        return self.bind_to(self.exchange, self.routing_key, self.binding_arguments, channel=channel, nowait=nowait)
    ...
    def consume(self, consumer_tag="", callback=None, no_ack=None, nowait=False, on_cancel=None):
    ...
    def delete(self, if_unused=False, if_empty=False, nowait=False):
        ...
        ---------
            ...
            nowait (bool): Do not wait for a reply.
        """
        return self.channel.queue_delete(queue=self.name, if_unused=if_unused, if_empty=if_empty, nowait=nowait)

    def queue_unbind(self, arguments=None, nowait=False, channel=None):
        return self.unbind_from(self.exchange, self.routing_key, arguments, nowait, channel)
