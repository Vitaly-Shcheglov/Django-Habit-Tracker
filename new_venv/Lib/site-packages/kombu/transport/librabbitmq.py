...
class Channel(amqp.Channel, base.StdChannel):
    ...
    def prepare_message(
        ...
        properties.update({"content_type": content_type, "content_encoding": content_encoding, "headers": headers})
...
class Transport(base.Transport):
    ...
    connection_errors = base.Transport.connection_errors + (ConnectionError, socket.error, IOError, OSError)
