...
class Channel(virtual.Channel):
    ...
    def _put(self, queue, message, **kwargs):
        ...
        if self.ttl:
            ...
            if msg_expire is not None and (data["expire_at"] is None or msg_expire < data["expire_at"]):
    ...
    def get_table(self, exchange):
        ...
        return localRoutes | frozenset((r["routing_key"], r["pattern"], r["queue"]) for r in brokerRoutes)
    ...
    def _create_broadcast(self, database):
        ...
        database.create_collection(self.broadcast_collection, size=self.capped_queue_size, capped=True)
...
class Transport(virtual.Transport):
    ...
    connection_errors = virtual.Transport.connection_errors + (errors.ConnectionFailure,)
    channel_errors = virtual.Transport.channel_errors + (errors.ConnectionFailure, errors.OperationFailure)
    driver_type = "mongodb"
    driver_name = "pymongo"
