...
class Queue:
    ...
    id = Column(Integer, Sequence("queue_id_sequence"), primary_key=True, autoincrement=True)
...
class Message:
    ...
    id = Column(Integer, Sequence("message_id_sequence"), primary_key=True, autoincrement=True)
    ...
    def queue_id(self):
        return Column(
            Integer, ForeignKey("%s.id" % class_registry["Queue"].__tablename__, name="FK_kombu_message_queue")
        )
