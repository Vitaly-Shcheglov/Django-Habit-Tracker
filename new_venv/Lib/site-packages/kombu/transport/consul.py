...
class Channel(virtual.Channel):
    ...
    def _acquire_lock(self, queue, raising=LockError):
        ...
        logger.debug("Trying to create lock object %s with session %s", lock_key, session_id)
    ...
    def _get(self, queue, timeout=None):
        ...
        with self._queue_lock(queue, raising=Empty):
            ...
            try:
                ...
                logger.debug("Removing key %s with modifyindex %s", data[0]["Key"], data[0]["ModifyIndex"])
...
class Transport(virtual.Transport):
    ...
    if consul:
        connection_errors = virtual.Transport.connection_errors + (consul.ConsulException, consul.base.ConsulException)

        channel_errors = virtual.Transport.channel_errors + (consul.ConsulException, consul.base.ConsulException)
