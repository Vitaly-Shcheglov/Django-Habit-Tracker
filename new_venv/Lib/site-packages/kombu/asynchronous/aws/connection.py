...
class AsyncAWSQueryConnection(AsyncConnection):
    ...
    def get_list(
        self, operation, params, markers, path="/", parent=None, verb="POST", callback=None, protocol_params=None
    ):
        return self.make_request(
            ...
            path,
            verb,
            callback=transform(self._on_list_ready, callback, parent or self, markers, operation),
    ...
    def get_status(self, operation, params, path="/", parent=None, verb="GET", callback=None, protocol_params=None):
        return self.make_request(
            ...
            path,
            verb,
            callback=transform(self._on_status_ready, callback, parent or self, operation),
            protocol_params=protocol_params,
        )
