...
class Message:
    ...
    def ack(self, multiple=False):
        ...
        if self.acknowledged:
            raise self.MessageStateError("Message already acknowledged with state: {0._state}".format(self))
    ...
    def _decode(self):
        return loads(self.body, self.content_type, self.content_encoding, accept=self.accept)
