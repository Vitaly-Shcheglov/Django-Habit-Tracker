...
class Connection(AbstractChannel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.client_properties = dict(self.library_properties, **client_properties or {})
        self.locale = locale
        self.host = host
    ...
    def __repr__(self):
        if self._transport:
            return f"<AMQP Connection: {self.host}/{self.virtual_host} " f"using {self._transport} at {id(self):#x}>"
        else:
            return f"<AMQP Connection: {self.host}/{self.virtual_host} " f"(disconnected) at {id(self):#x}>"
    ...
    def _on_start(self, version_major, version_minor, server_properties, mechanisms, locales, argsig="FsSs"):
        ...
        for authentication in self.authentication:
            ...
            raise ConnectionError(
                ...
                "(can offer: {}; available: {})".format(
                    b", ".join(m.mechanism for m in self.authentication if m.mechanism).decode(),
    ...
    def Transport(
        self, host, connect_timeout, ssl=False, read_timeout=None, write_timeout=None, socket_settings=None, **kwargs
    ):
        return Transport(
            host,
    ...
    def _get_free_channel_id(self):
        ...
        raise ResourceError(
            "No free channel ids, current={}, channel_max={}".format(len(self.channels), self.channel_max),
            spec.Channel.Open,
        )
