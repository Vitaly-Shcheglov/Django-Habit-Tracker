...
class Channel(AbstractChannel):
    ...
    def exchange_declare(
        ...
        self.send_method(
            ...
            argsig,
            (0, exchange, type, passive, durable, auto_delete, False, nowait, arguments),
    ...
    def exchange_bind(self, destination, source="", routing_key="", nowait=False, arguments=None, argsig="BsssbF"):
    ...
    def exchange_unbind(self, destination, source="", routing_key="", nowait=False, arguments=None, argsig="BsssbF"):
    ...
    def queue_bind(self, queue, exchange="", routing_key="", nowait=False, arguments=None, argsig="BsssbF"):
    ...
    def queue_unbind(self, queue, exchange, routing_key="", nowait=False, arguments=None, argsig="BsssF"):
    ...
    def queue_delete(self, queue="", if_unused=False, if_empty=False, nowait=False, argsig="Bsbbb"):
        """Delete a queue.
    ...
    def _basic_publish(
        ...
        try:
            with self.connection.transport.having_timeout(timeout):
                return self.send_method(
                    spec.Basic.Publish, argsig, (0, exchange, routing_key, mandatory, immediate), msg
                )
        except socket.timeout:
