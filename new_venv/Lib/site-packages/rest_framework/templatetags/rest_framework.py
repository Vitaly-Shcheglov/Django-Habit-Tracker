...
def form_for_link(link):
    ...
    properties = OrderedDict([(field.name, field.schema or coreschema.String()) for field in link.fields])
...
def format_value(value):
    ...
    if value is None or isinstance(value, bool):
        ...
        if (value.startswith("http:") or value.startswith("https:") or value.startswith("/")) and not re.search(
            r"\s", value
        ):
