...
class BooleanField(Field):
    ...
    initial = False
    TRUE_VALUES = {"t", "T", "y", "Y", "yes", "Yes", "YES", "true", "True", "TRUE", "on", "On", "ON", "1", 1, True}
    FALSE_VALUES = {
        "f",
        "F",
        "n",
    ...
    def __init__(self, allow_unicode=False, **kwargs):
        ...
        if self.allow_unicode:
            validator = RegexValidator(
                re.compile(r"^[-\w]+\Z", re.UNICODE), message=self.error_messages["invalid_unicode"]
            )
        else:
...
class FilePathField(ChoiceField):
    default_error_messages = {"invalid_choice": _('"{input}" is not a valid path choice.')}

    def __init__(
        self, path, match=None, recursive=False, allow_files=True, allow_folders=False, required=None, **kwargs
    ):
