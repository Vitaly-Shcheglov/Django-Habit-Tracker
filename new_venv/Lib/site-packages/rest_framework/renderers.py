    ...
    default_style = ClassLookupDict(
        {
            ...
            serializers.EmailField: {"base_template": "input.html", "input_type": "email"},
            serializers.URLField: {"base_template": "input.html", "input_type": "url"},
            serializers.IntegerField: {"base_template": "input.html", "input_type": "number"},
            serializers.FloatField: {"base_template": "input.html", "input_type": "number"},
            serializers.DateTimeField: {"base_template": "input.html", "input_type": "datetime-local"},
            serializers.DateField: {"base_template": "input.html", "input_type": "date"},
            serializers.TimeField: {"base_template": "input.html", "input_type": "time"},
            serializers.FileField: {"base_template": "input.html", "input_type": "file"},
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_default_renderer(self, view):
        ...
        """
        renderers = [renderer for renderer in view.renderer_classes if not issubclass(renderer, BrowsableAPIRenderer)]
    ...
    def _get_serializer(self, serializer_class, view_instance, request, *args, **kwargs):
        kwargs["context"] = {"request": request, "format": self.format, "view": view_instance}
    ...
    def render_form_for_serializer(self, serializer):
        ...
        return form_renderer.render(
            serializer.data, self.accepted_media_type, {"style": {"template_pack": "rest_framework/horizontal"}}
        )
...
class _BaseOpenAPIRenderer:
    ...
    def get_structure(self, data):
        return {
            "openapi": "3.0.0",
            "info": {"version": "", "title": data.title, "description": data.description},
...
class CoreAPIJSONOpenAPIRenderer(_BaseOpenAPIRenderer):
    ...
    def render(self, data, media_type=None, renderer_context=None):
        structure = self.get_structure(data)
        return json.dumps(structure, indent=4, ensure_ascii=self.ensure_ascii).encode("utf-8")
...
class JSONOpenAPIRenderer(BaseRenderer):
    ...
    def render(self, data, media_type=None, renderer_context=None):
        return json.dumps(data, cls=self.encoder_class, indent=2, ensure_ascii=self.ensure_ascii).encode("utf-8")
