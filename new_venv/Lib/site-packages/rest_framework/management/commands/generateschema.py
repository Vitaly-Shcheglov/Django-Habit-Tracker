...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        if self.get_mode() == COREAPI_MODE:
            parser.add_argument(
                "--format", dest="format", choices=["openapi", "openapi-json", "corejson"], default="openapi", type=str
            )
        else:
            parser.add_argument(
                "--format", dest="format", choices=["openapi", "openapi-json"], default="openapi", type=str
            )
