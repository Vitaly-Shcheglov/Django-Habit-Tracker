...
class SearchCommands:
    ...
    def add_document_hash(self, doc_id, score=1.0, language=None, replace=False):
        ...
        - **language**: Specify the language used for document tokenization.
        """  # noqa
        return self._add_document_hash(doc_id, conn=None, score=score, language=language, replace=replace)
    ...
    def search(
        ...
        return self._parse_results(SEARCH_CMD, res, query=query, duration=(time.monotonic() - st) * 1000.0)
    ...
    def profile(
        ...
        **query_params**: Define one or more value parameters.
        ...
        return self._parse_results(PROFILE_CMD, res, query=query, duration=(time.monotonic() - st) * 1000.0)
