...
class Sentinel(AsyncSentinelCommands):
    ...
    def __init__(
        ...
        **connection_kwargs,
        ...
        self.sentinels = [Redis(host=hostname, port=port, **self.sentinel_kwargs) for hostname, port in sentinels]
    ...
    def __repr__(self):
        ...
        return f"<{self.__class__}.{self.__class__.__name__}" f"(sentinels=[{','.join(sentinel_addresses)}])>"
