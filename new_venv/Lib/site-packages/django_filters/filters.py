...
from .fields import (BaseCSVField, BaseRangeField, ChoiceField, DateRangeField,
                     DateTimeRangeField, IsoDateTimeField,
                     IsoDateTimeRangeField, LookupChoiceField,
                     ModelChoiceField, ModelMultipleChoiceField,
                     MultipleChoiceField, RangeField, TimeRangeField)
...
class OrderingFilter(BaseCSVFilter, ChoiceFilter):
    ...
    * ``field_labels`` is an optional argument that allows you to customize
    ...
    def normalize_fields(cls, fields):
        ...
        assert isinstance(fields, Iterable), "'fields' must be an iterable (e.g., a list, tuple, or mapping)."
