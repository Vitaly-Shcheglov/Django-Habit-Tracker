...
class BaseInspector:
    ...
    def probe_inspectors(self, inspectors, method_name, obj, initkwargs=None, **kwargs):
        ...
        for inspector in inspectors:
            ...
            logger.warning(
                "%s ignored because no inspector in %s handled it (operation: %s)", obj, inspectors, method_name
            )
            result = None
    ...
    def get_pagination_parameters(self):
        ...
        return (
            self.probe_inspectors(
                self.paginator_inspectors, "get_paginator_parameters", getattr(self.view, "paginator")
            )
            or []
        )
