...
class Opts:
    ...
    concurrency = optparse.make_option(
        ...
        metavar="LIBS",
        help=(
            "Properly measure code using a concurrency library. " + "Valid values are: {}, or a comma-list of them."
    ...
    datafile = optparse.make_option(
        ...
        action="store",
        metavar="DATAFILE",
        help=("Base name of the data files to operate on. " + "Defaults to '.coverage'. [env: COVERAGE_FILE]"),
    )
    ...
    datafile_output = optparse.make_option(
        ...
        action="store",
        metavar="OUTFILE",
        help=("Write the recorded coverage data to this file. " + "Defaults to '.coverage'. [env: COVERAGE_FILE]"),
    )
    ...
    module = optparse.make_option(
        ...
        action="store_true",
        help=(
            "<pyfile> is an importable Python module, not a script path, " + "to be run as 'python -m' would run it."
        ),
    )
    ...
    precision = optparse.make_option(
        ...
        metavar="N",
        type=int,
        help=("Number of digits after the decimal point to display for " + "reported coverage percentages."),
    )
