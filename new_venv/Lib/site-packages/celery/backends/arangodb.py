    ...
    def __init__(self, url=None, *args, **kwargs):
        ...
        if py_arango_connection is None:
            raise ImproperlyConfigured(
                "You need to install the pyArango library to use the " "ArangoDb backend.",
            )
    ...
    def connection(self):
        ...
        if self._connection is None:
            self._connection = py_arango_connection.Connection(
                arangoURL=self.arangodb_url, username=self.username, password=self.password, verify=self.verify
            )
