...
from typing import (Any, AnyStr, Callable, Dict, Iterator, List,  # noqa
...
def reprstream(
    stack: deque, seen: Optional[Set] = None, maxlevels: int = 3, level: int = 0, isinstance: Callable = isinstance
) -> Iterator[Any]:
