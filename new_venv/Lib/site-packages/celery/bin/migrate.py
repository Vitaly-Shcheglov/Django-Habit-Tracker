...
@click.option(
    "-n", "--limit", cls=CeleryOption, type=int, help_group="Migration Options", help="Number of tasks to consume."
)
@click.option(
    "-t",
    "--timeout",
...
@click.option(
    "-T", "--tasks", cls=CeleryOption, help_group="Migration Options", help="List of task names to filter on."
)
@click.option("-Q", "--queues", cls=CeleryOption, help_group="Migration Options", help="List of queues to migrate.")
@click.option(
    "-F",
    "--forever",
    cls=CeleryOption,
...
def migrate(ctx, source, destination, **kwargs):
    ...
    migrate_tasks(Connection(source), Connection(destination), callback=on_migrate_task, **kwargs)
