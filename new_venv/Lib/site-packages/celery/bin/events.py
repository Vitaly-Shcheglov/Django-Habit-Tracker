...
def _run_evcam(
    camera, app, logfile=None, pidfile=None, uid=None, gid=None, umask=None, workdir=None, detach=False, **kwargs
):
...
@click.option("-F", "--frequency", "--freq", type=float, default=1.0, cls=CeleryOption, help_group="Snapshot")
...
def events(ctx, dump, camera, detach, frequency, maxrate, loglevel, **kwargs):
    ...
    if camera:
        return _run_evcam(camera, app=app, freq=frequency, maxrate=maxrate, loglevel=loglevel, detach=detach, **kwargs)
