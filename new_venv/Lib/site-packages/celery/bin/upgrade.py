...
@click.option(
    "--django", cls=CeleryOption, is_flag=True, help_group="Upgrading Options", help="Upgrade Django project."
)
@click.option(
    "--compat",
    cls=CeleryOption,
...
@click.option(
    "--no-backup", cls=CeleryOption, is_flag=True, help_group="Upgrading Options", help="Don't backup original files."
)
