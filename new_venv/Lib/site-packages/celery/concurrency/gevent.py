...
def apply_target(target, args=(), kwargs=None, callback=None, accept_callback=None, getpid=None, **_):
    ...
    return base.apply_target(target, args, kwargs, callback, accept_callback, pid=getpid(), **_)
    ...
    **rest
    ...
    try:
        with Timeout(timeout):
            return apply_target(
                target, args, kwargs, callback, accept_callback, getpid(), propagate=(Timeout,), **rest
            )
    except Timeout:
