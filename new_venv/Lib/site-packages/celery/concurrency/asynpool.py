...
class AsynPool(_pool.Pool):
    ...
    def register_with_event_loop(self, hub):
        ...
        iterate_file_descriptors_safely(
            self._fileno_to_outq, self._fileno_to_outq, hub.add_reader, self.handle_result_event, "*fd*"
        )
    ...
    def _create_write_handlers(self, hub, pack=pack, dumps=_pickle.dumps, protocol=HIGHEST_PROTOCOL):
        ...
        def on_poll_start():
            ...
            if add_cond:  # calling hub_add vs hub_remove
                ...
                iterate_file_descriptors_safely(inactive, all_inqueues, hub.remove_writer)
