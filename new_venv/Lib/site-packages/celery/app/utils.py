...
class Settings(ConfigurationView):
    ...
    def broker_write_url(self):
        return os.environ.get("CELERY_BROKER_WRITE_URL") or self.get("broker_write_url") or self.broker_url
    ...
    def result_backend(self):
        return os.environ.get("CELERY_RESULT_BACKEND") or self.first("result_backend", "CELERY_RESULT_BACKEND")
    ...
    def table(self, with_defaults=False, censored=True):
        ...
        return filt({k: v for k, v in settings.items() if not k.startswith("_") and k not in dict_members})
