...
from ..utils.annotations import (annotation_is_class, annotation_issubclass,
                                 get_optional_arg)
...
class Celery:
    ...
    def task(self, *args, **opts):
        ...
        if args:
            raise TypeError("@task() takes exactly 1 argument ({} given)".format(sum([len(args), len(opts)])))
    ...
    def _connection(
        ...
        **kwargs,
        ...
        return self.amqp.Connection(
            ...
            transport_options=dict(conf.broker_transport_options, **transport_options or {}),
    ...
    def add_periodic_task(self, schedule, sig, args=(), kwargs=(), name=None, **opts):
        ...
        """
        key, entry = self._sig_to_periodic_task_entry(schedule, sig, args, kwargs, name, **opts)
        if self.configured:
    ...
    def _sig_to_periodic_task_entry(self, schedule, sig, args=(), kwargs=None, name=None, **opts):
