...
from .exceptions import (ExpiredTokenError, TokenBackendError,
                         TokenBackendExpiredToken, TokenError)
...
class Token:
    ...
    def token_backend(self) -> "TokenBackend":
        if self._token_backend is None:
            self._token_backend = import_string("rest_framework_simplejwt.state.token_backend")
