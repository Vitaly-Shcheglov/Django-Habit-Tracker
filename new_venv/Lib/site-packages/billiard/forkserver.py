...
class ForkServer:
    ...
    def connect_to_new_process(self, fds):
        ...
        with socket.socket(socket.AF_UNIX) as client:
            ...
            allfds = [child_r, child_w, self._forkserver_alive_fd, semaphore_tracker.getfd()]
            allfds += fds
            try:
...
def _serve_one(s, listener, alive_r, handler):
    ...
    (child_r, child_w, _forkserver._forkserver_alive_fd, stfd, _forkserver._inherited_fds) = __unpack_fds(*fds)
